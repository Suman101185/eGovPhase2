...
void OpenPayCouponTemplate()
{
    ...
    using(StreamReader st = File.OpenText(sPath + @"\PDFCouponImageTemplate.htm"))
    {
    ...
    using(StreamReader st = File.OpenText(sPath + "\PDFCouponDisplay.htm"))
    {
...
<%
    ...
    msApp = "CC";
    msCouponPath = CopMvcUtil.Session("COUPON_PATH");

    strAcctID = CopMvcUtil.GetString(Request.QueryString["a"]).Replace( "~LBSIGN~", "#"); //Replace(Request.QueryString("a"), "~LBSIGN~", "#")
    strEntityName = ispProperCase(CopMvcUtil.GetString(Request.QueryString["b"]).Replace( "~LBSIGN~", "#")); //ispProperCase(Replace(Request.QueryString("b"), "~LBSIGN~", "#"))
    strEntityAddr = ispProperCase(CopMvcUtil.GetString(Request.QueryString["c"]).Replace( "~LBSIGN~", "#")); //ispProperCase(Replace(Request.QueryString("c"), "~LBSIGN~", "#"))
    strScanLine =  CopMvcUtil.GetString(Request.QueryString["d"]).Replace( "~LBSIGN~", "#"); // Replace(Request.QueryString("d"), "~LBSIGN~", "#")
    strPeriod = CopMvcUtil.GetString(Request.QueryString["e"]).Replace( "~LBSIGN~", "#"); // Replace(Request.QueryString("e"), "~LBSIGN~", "#")
    strAddressesStr =  CopMvcUtil.GetString(Request.QueryString["g"]).Replace( "~LBSIGN~", "#");//Replace(Request.QueryString("g"), "~LBSIGN~", "#")
    ...
    DirectoryInfo Folder = new DirectoryInfo(CopMvcUtil.Session("COUPON_PATH")); 
    ...
    foreach(FileInfo i in Folder.GetFiles())
    {
        ...
        {
		    File.Delete(CopMvcUtil.Session("COUPON_PATH") + i.Name);
	    }
	    if(iCounter == 21 )
        {
		    break;
