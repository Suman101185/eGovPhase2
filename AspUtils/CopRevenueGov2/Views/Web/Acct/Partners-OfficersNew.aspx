...
<script id="clientEventHandlersJS" type="text/javascript" language="javascript">
    ...
    function LoadPartnersError() {
        ...
        arrPart[i++] = [ddPartTaxIDType, 'parent.$("#ddPartTaxIDType option:selected").text()=="Select"', 'Select ID Type'];
        ...
        arrPart[i++] = [ddRelationship, 'parent.$("#ddRelationship option:selected").text()=="Select"', 'Select Relationship'];
    ...
    function popPartXml(sAction) {
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlAccount,
                parent.$("#ddPartBusState option:selected").attr('CODE'), 'NAME_ADDRESS STATE', '', iCurrPartRec);
...
<div class="tab-content customtabs">
    <div id="AcctPartners" style="display: none;" role="tabpanel" class="tab-pane active">
        <h2>Tax Payer Information  |   <span>Partners / Officers </span></h2>
                        ...
                        <div class="well custom_well" id="divOfficersInput">
                            <form class="form-horizontal addressee_form">
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-3 control-label text-left-custom">Name*  :  </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-3 control-label text-left-custom">SSN/EIN * : </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-3 control-label text-left-custom">Relationship * :</label>
