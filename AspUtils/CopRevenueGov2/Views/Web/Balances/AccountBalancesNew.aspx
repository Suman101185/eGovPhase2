...
<script src ="../Content/Scripts/ispCoupon.js" type="text/javascript" language="javascript"></script>
	...
	<script language="javascript" type="text/javascript">
	    ...
	    function SetInitFocus() {
	        ...
	        AppHeader.innerHTML = txtHeader + '<Font>|account balance</Font>';
	        //AppError.innerText = '';
	    ...
	    function ValidateBalDate(obj) {
	        ...
	        if (obj.value != "") {
	            ...
	            if (strBD == false) {
	                ...
	                $(parent.AppError).text('Invalid date');
	            } else {
	                obj.value = strBD
	            }
	        }
        ...
        <div class="block3">
            ...
            <div style="display: block;" id="tab2" class="blue_base_box">
               <h2><span id="AppHeader">&nbsp;</span>  </h2>
                ...
                <div class="contentsection" id="divPayments" style="DISPLAY: block; ">
                    ...
                    <div class="row">
                         ...
                         <%-- Address Start--%>
                             <div class="well">
                                <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <p><strong><font id="lblAccountType">Account ID.:</font></strong>
                                                <label id="lblEntityAccountID" class="lblTextBlack"></label>
                                            </p>
                                        </div>                                                   
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <p><strong>Address :</strong>
                                            <label id="lblEntityAddress" class="lblTextBlack"></label>
                                        </p>
                                    </div>
                                        <div class="col-lg-4">
                             ...
                             <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">          
                                            ...
                                            <label class="col-sm-5 control-label text-left-custom"><strong>Date From :</strong></label>
                                        <div class="col-lg-4">
                                                <input class="form-control input-sm" id=txtFromDate onchange="ValidateBalDate(txtFromDate)" maxlength=10 >
                                            </div>
                                        </div>
                                    <div class="form-group">          
                                        
                                            <label class="col-sm-5 control-label text-left-custom"><strong>Date To :</strong></label>
                                        <div class="col-lg-4">
                                                <input class="form-control input-sm"  id=txtToDate onchange="ValidateBalDate(txtToDate)" maxlength=10 >
                                            </div>
                                        </div>
		                ...
		                <div id="divNoBalances" style="display:none">
			                <br /><br />
			                <label style="margin-left:4%; font-weight:bold">This account currently has no outstanding balances</label>
		                </div>
                        <!--Finished Outstanding Balances Section-->
		                <div id="divFinishedBalances" style="display:none">
			                <br /><br />
			                <label style="margin-left:4%; font-weight:bold">Thank you for reconciling some or all of your outstanding balances.</label>
		                </div>	
                       <!--Outstanding Balances Section-->
		                <div id="divBalances" style="display:none">	
                        <div id="divAcctBalTemplate" style="display:none">
			            <label id="lblAcctBalTemplate" class="" style="margin-left:4%; font-weight:bold;"></label>
                        <!--Account Balance Table Template-->
                        <div class="row table-responsive">
                        <div class="col-lg-12" >
			            <table id="tblAcctBalTemplate" class="table table-condensed borderless custom_table03" summary="Employee Pay Sheet">
    	            ...
    	            <tr>
        	            <td colspan="2" align="center" ><strong>Payment Type</strong></td>
                        <td  width="14%" align="center"><strong>Period</strong></td>
            
                        <td  width="12%" align="center"><strong>Principal</strong></td>
                        <td  width="12%" align="center"><strong>Intesrest</strong></td>
                        <td  width="10%" align="center"><strong>Penalty</strong></td>
            
                        <td  width="10%" align="center"><strong>Other</strong></td>
                        <td  width="10%" align="center"><strong>Balance</strong></td>
                        <td  width="" align="center"><strong>Payment</strong></td>

                    </tr>
                    <tr>
        	            <td  width="10%" align="center">Full</td>
                        <td  width="10%" align="center">Partial</td>
    	            ...
    	            <tr class="odd" id="trABT_Default">
    	              ...
    	              <td  align="center" id="tdABT_Period"></td>
    	              <td  align="center" id="tdABT_Principal"></td>
    	              <td  align="center" id="tdABT_Interest"></td>
    	              <td  align="center" id="tdABT_Penalty"></td>
    	              <td  align="center" id="tdABT_Other"></td>
                      <td  align="center" id="tdABT_Balance"></td>
    	              <td  align="center" id="tdABT_Payment"></td>
  	              </tr>
                  ...
                  <tr class="" id="trABT_PartialPayment">
    	              ...
    	              <td  align="center">&nbsp;</td>
    	              <td  align="center">
                          <input id="tdABT_Principal" type="text" class="form-control input-sm" style="color:Red; width:80%" value="$0.00" onblur="Partial_Sum(this)" />
    	              </td>
    	              <td  align="center"> 
                          <input id="tdABT_Interest" type="text" class="form-control input-sm" style="color:Red; width:80%" value="$0.00" onblur="Partial_Sum(this)" />
    	              </td>
    	              <td  align="center">
                          <input id="tdABT_Penalty" type="text" class="form-control input-sm" style="color:Red; width:80%" value="$0.00" onblur="Partial_Sum(this)" />
    	              </td>
    	              <td  align="center">
                          <input id="tdABT_Other" type="text" class="form-control input-sm" style="color:Red; width:80%" value="$0.00" onblur="Partial_Sum(this)" />
    	              </td>          
                      <td id="tdABT_Balance"  align="center">&nbsp;</td>
		              <td id="tdABT_Payment"  align="center">&nbsp;</td>
  	              </tr>
                    ...
                    <div class="row table-responsive">
                    <div class="col-lg-12" >
		            <table id="tblBalanceTotals" class="table table-condensed borderless custom_table03" >
			            <tr>
				            <td width="6%"></td>
				            <td width="6%"></td>
				            <td width="10%"></td>
            ...
            <!--			<input type="button" value="Create a Payment Agreement" style="margin-right:15px" />-->
			            <input type="button" id='btnCreditCard' value="Pay by Credit Card or eCheck (ePay)" onclick='Pay_Click(this)' class="btn btn-default submit_button"/>
			            <input type="button" id='btnCoupon' value="Create a Payment Coupon" onclick='Pay_Click(this)' class="btn btn-default submit_button"/>
			            <input type="button" id="btnPrint" class="btn btn-default submit_button_light" value="Print" onclick="Print_Click()" />
		            </div>	
