...
<body onload="DisplayPrntCoupon()">
   <div class="tab_Tcontainer">
    ...
    <div class="tab_container">
        <div style="display: block;" Id="LogPrntCoupon" class="tab_content">
            <h2 id="AppHeader"></h2>
...
selected></OPTION></SELECT>
  ...
  selected></OPTION></SELECT>
        ...
        style="VISIBILITY: hidden"> <OPTION selected></OPTION></SELECT>
                            <div class="clear"></div>
                        </div>
                    ...
                    <div class="" id=trNtlMessage style="DISPLAY: none; visibility: visible">
		<p>If you have no tax liability for the selected period, click the NTL Coupon Button
				to Process a NTL payment.</p><p>&nbsp;</p></div>
 
              
        <table style="width:500px;">
             <tr>
					
					<td id=td1 style="DISPLAY: none; width:160px; margin:0 7px; visibility: visible" align="center">
					<INPUT class=btnNormal id=Button1 onclick=NTLPrntCoupon() type=button value="NTL Coupon" 
					name=btnPaNTL>
					</td>
					<td id=td2 style="width:160px; "  align="center">
					
					<INPUT class=btnNormal id=Button2 onclick=SubmitPrntCoupon() type=button value="Create Coupon" 
					name=btnPaPrint >
					
					</td> 
					<td style="width:160px;"  align="center">
					<INPUT class=btnNormal id=Button3 onclick=CnclPrntCoupon() type=button value="Cancel"
					name=btnPaCncl>
