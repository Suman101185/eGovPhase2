...
<body>
    ...
    <form class="form-horizontal school_form">
        ...
        <div class="form-group">
            <div class="col-sm-2">
            <label class="control-label text-custom-left2" for="inputEmail3">Filled by * : </label>
        ...
        <div class="form-group">
            <div class="col-sm-2">
            <label class="control-label  text-custom-left2" for="inputEmail3">Filler Name * </label>

            </div>
            <div class="col-sm-3 below_margin01">
                <input id="txtPreparerName" name="txtPreparerName" class="form-control input-sm">
            </div>
        ...
        <div class="form-group">
            <div class="col-sm-2">
            <label class="control-label  text-custom-left2" for="inputEmail3">Work Phone* :  </label></div>
            <div class="col-sm-2 below_margin01">
                <input id="txtPrepAreaCode" name="txtPrepAreaCode" class="form-control input-sm">
            </div>
            <div class="col-sm-2 below_margin01">
                <input id="txtPrepPhone1" name="txtPrepPhone1" class="form-control input-sm">
            </div>
            <div class="col-sm-2 below_margin01">
                <input id="txtPrepPhone2" name="txtPrepPhone2" class="form-control input-sm">
            </div>
            <div class="col-sm-3">
                <span class="small_span2">EXT - </span>
                <input id="txtPrepPhoneExt" name="txtPrepPhoneExt" class="form-control input-sm customwidth1">
            </div>
        </div>

        <div class="form-group">
            <div class="col-sm-2">
            <label class="control-label  text-custom-left2" for="inputEmail3">Filer E-Mail Address: *</label>
            </div>
            <div class="col-sm-3 below_margin01">
                <input id="txtPreparerEmail" class="form-control input-sm">
            </div>
