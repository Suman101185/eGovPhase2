...
<script runat="server">
    ...
    void CallRttie037()
    {
        xmlOut = RTTIE037_2014.CallService(xmlReqDoc);
...
<%
    ...
    rev_func_srv.CreateXmlBufferObj(xmlOut, util.GetXMLString(Server.MapPath(@"~/views/web/xml/BPTezReturn_2014.xml")), false);
