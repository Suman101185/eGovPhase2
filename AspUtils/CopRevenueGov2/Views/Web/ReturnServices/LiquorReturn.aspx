...
void CallRttie029()
    {
        xmlOut = RTTIE029.CallService(xmlReqDoc);
...
rev_func_srv.CreateXmlBufferObj(xmlOut, util.GetXMLString(Server.MapPath("~/Views/web/xml/LiquorReturn.xml")), false);

rev_func_srv.CreateXmlBufferObj(xmlReqDoc, util.GetXMLString(Request), false);

CallRttie029();

if (xmlProc.ispXmlGetFieldVal(xmlOut, "LIQUOR_INFO/ACCOUNT_ID", "", 0) == "")
{
    xmlProc.ispXmlSetFieldVal(xmlOut, inAcctNo, "LIQUOR_INFO/ACCOUNT_ID", "", 0);
}

xmlProc.ispXmlSetFieldVal(xmlOut, lsFunction, "LIQUOR_INFO/RETURN_STATUS", "", 0);
