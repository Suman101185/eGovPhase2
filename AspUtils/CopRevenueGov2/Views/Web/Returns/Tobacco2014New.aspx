...
<head>
   ...
   <script type="text/javascript" id="clientEventHandlersJS" language="javascript">
          ...
          // debugger;
           ...
           if (parent.GetNodeCount(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '27') == 1) {
               ...
               if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'ERROR_INFO ERROR', "", 0) != 0) {
                   ...
                   $('AppHeader').html(txtHeader + '<Font class=hdrMedium>|tobacco tax return for 2014</Font>');
               ...
               //parent.$g.xmlTobacco = parent.xmlTobaccoTemplate;  manoranjan
           ...
           $('#AppMessage').html(parent.gsInstructionText + '<BR>The Tobacco Tax for 2014 is due January 31, 2015.');
    ...
    <body>
<%--<body onload="ispDisplayProgress('DisplayTobaccoReturn()', 'Retrieving 2014 tobacco tax information')">--%>
    <div class="container-fluid no-padding" id="TobaccoReturn">
        <div class="block3">
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            <td style="width:75%;"> 3a.  Total number of packs sold January 1 through December 31, 2014.&nbsp;</td>
                                            <td style="width:25%;">                                                
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td style="width:75%;">4. Tax due by January 31, 2015[Calculated - add lines 1d, 2d and 3d]</td>
                                            <td style="width:25%;">                                               
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr class="odd">
                                            <td>5. Tax previously paid for tax year 2014 and other credits</td>
                                            <td style="width:25%;">                                               
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
			...
			<label class="" >Amount of overpayment to be applied to the 2015 Tobacco and Tobacco-Related Products Tax.</label></td>
                                            <td >                                            
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
