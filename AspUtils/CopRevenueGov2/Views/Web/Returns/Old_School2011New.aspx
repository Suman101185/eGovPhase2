...
<head>
   <script id="clientEventHandlersJS" language="javascript" type="text/javascript">
    ...
    function DisplaySchool08Return() {
        ...
        $('#AppMessage').html(parent.gsInstructionText + '<BR>The School Income Tax for 2011 is due April 15, 2012.');
...
<%--<body onload="ispDisplayProgress('DisplaySchool08Return()', 'Retrieving 2011 school tax information')">--%>
                            ...
                            <div class="form_segment">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabularform">
                                   ...
                                   <%-- <tr>
                                    ...
                                    <tr>
                                        <th width="53%" scope="col" align="right">If you were a  partial year resident in 2011, enter dates of residency :  </th>
      ...
      style="WIDTH: 68px; HEIGHT: 22px" size=9></th>
                                     ...
                                     <tr>
                                      <td width="50%" scope="col" align="left">
                                          If you were a  partial year resident in 2011, enter dates of residency :  </td>
    ...
    ispDisplayProgress('btnSchool08Submit_onclick()', 'Submitting 2011 school tax information')" />
                            </div>
