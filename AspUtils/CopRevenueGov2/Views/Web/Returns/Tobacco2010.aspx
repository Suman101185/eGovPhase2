...
<script id="clientEventHandlersJS" language="javascript">
    ...
    function DisplayTobaccoReturn() {
        ...
        $('#AppMessage').html(parent.MenuWin.gsInstructionText + '<BR>The Tobacco Tax for 2010 is due January 31, 2014.');
...
<!-- Section 1 -->
  ...
  <tr class=rowDataOdd>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Number of individual tobacco and tobacco-related items sold January 1 through December 31, 2010.</label></td>
		<td colspan=3>
...
<!-- Section 2 -->
  ...
  <tr class=rowDataEven>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Total number of ounces of all tobacco and tobacco-related items sold January 1 through December 31, 2010.</label>
		</td>
		<td colspan=3>
...
<!-- Section 3 -->
  ...
  <tr class=rowDataOdd>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Total number of packs sold January 1 through December 31, 2010.</label>
		</td>
		<td colspan=3>
  ...
  <tr class=rowDataEven>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Tax previously paid for tax year 2010 and other credits</label></td>
<!--		<td colspan=3>
 ...
 <tr class=rowDataOdd>
  ...
  <tr class=rowDataOdd>
		...
		<td colspan=16>
			...
			<label class="lblInstrNormal">Amount of overpayment to be applied to the 2011 Tobacco and Tobacco-Related Products Tax.</label></td>
		<td colspan=3>
