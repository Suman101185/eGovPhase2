...
<title></title>
    ...
    <body>
<%--<body onload="ispDisplayProgress('DisplayWage08Return()','Retrieving 2010 wage tax information')">--%>
    <div class="tab_Tcontainer" id="WageReturn_08">
        <div class="tab_container">
			...
			<label class="" style="color: Red;width:100%" >All decimals will be rounded to the nearest whole number</label></th>
				...
				wage tax was remitted for the pay period including March 12, 2010. </b></td>
      ...
      <U>non-residents</U>      of 
				Philadelphia (7/1/2010 to 12/31/2010)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%">
                                        ...
                                        <tr class="odd">
                                            <td>13. Tax previously paid for 2010 - <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
