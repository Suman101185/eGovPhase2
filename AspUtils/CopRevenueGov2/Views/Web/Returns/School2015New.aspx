    ...
    <script id="clientEventHandlersJS" language="javascript" type="text/javascript">
        ...
        function DisplaySchool08Return() {
            ...
            if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('29')")) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'ERROR_INFO ERROR', "", 0) != 0) {
                    ...
                    $('#AppHeader').html(txtHeader + '<Font class=hdrMedium>|school income tax return for 2015</Font>');
            ...
            $('#AppMessage').html(parent.gsInstructionText + '<BR>The School Income Tax for 2015 is due April 15, 2016.');
        ...
        function FieldLock_08(bDisabled) {
            if (bDisabled == true) {
                ...
                $('#txtTerminationDate').removeAttr('disable');
            }
        ...
        function ValidateSchool08Return() {
            ...
            if (source != null) {
                ...
                if (ObjSelected != null) {
                    if (sId == "txtToDate_08" || sId == "txtFromDate_08" || sId == "txtTerminationDate" || source.type == 'button') { } else {
        ...
        function txtTerminationDate_onblur() {
            ...
            //---------------------end-------------//
            if ($(parent.AppError).innerText == "" && txtTerminationDate.value != "") {
                var strBD = ispValidateDate(txtTerminationDate.value)

                if (strBD == false) {
                    $(parent.AppError).innerText = 'Invalid from date'
                    txtTerminationDate.className = 'inpError'
                    blnErr = true
                } else {
                    txtTerminationDate.className = 'inpNormal'
                    txtTerminationDate.value = strBD
                } //if
            } else {
                txtTerminationDate.className = 'inpNormal'
            } //if
...
<body>
    <%--<body onload="ispDisplayProgress('DisplaySchool08Return()', 'Retrieving 2015 school tax information')">--%>
        ...
        <div class="block3">
            ...
            <div class="container-fluid">
                                                ...
                                                <div class="col-lg-12 templateclass">
                                                    ...
                                                    <form class="form-horizontal school_form">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <div class="col-sm-3"> <input class="" id="txtTerminationDate" onchange="ValidateSchool08Return()" maxlength="10"
				...
				previously paid with an extension coupon</td>
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>15B.</strong></span> &nbsp; <strong><u>Applied</u></strong> to the 2016 School Income Tax &nbsp;</td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
