...
<body onload="DisplayLCF()">
   <div class="container-fluid no-padding">
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <p >Loss carry forward available for the  <label id="lblYearCurrent">2012 Business Income and Receipts Tax</label> return</p>
            ...
            <p>This figure is based on the program / loss reported on the following <label  id="lblIncomeLoss">BIRT</label> returns:</p>
