                ...
                <div class="thankyou">
                    ...
                    <div class="school_form">
                        ...
                        <div class="school_page_form">
                            ...
                            <div class="account_greybox"  id="Div1" style="DISPLAY: none;">
        ...
        To fill out your 2014 BIRT form, Please select BIRT from the side menu.
				...
				<script>document.write(sCurrYear - 1)</script>
					...
					enter the termination date here:   <input class="inpNormal"
                        ...
                        onblur="return txtTermDate_onblur()"> 
                                    ...
                                    <tr><th>   If applicable, enter percentage from
					Worksheet D, Line 3:<label id="lnkWrkD" class="lblLink label_NoLeft" onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkD')}">Click here for Worksheet D</label>
                ...
                onfocus="SetFocus()" maxlength="10" style="WIDTH: auto">
                        ...
                        onfocus="SetFocus()" maxlength="10" style="WIDTH: auto">
                                        ...
                                        <tr class="odd">
                                            <td width="70%" class="auto-style1">5.  Tax Due(Line 2 plus Line 4)</td>
                                            <td align="center" class="auto-style1">
                                               <label id="lblNPT5" style="WIDTH: 100%"></label></td>
                                        </tr>
                                        <tr>
                                            <td><b>6a.  60% Business Income & Receipts Tax credit</b></td>
                                            <td align="center" class="no_border_right">
                        ...
                        onfocus="SetFocus()" maxlength="10" style="WIDTH: auto"></td>
                                        ...
                                        <tr>
                                            <td>8.  Interest and Penalty(Cumulative % from Instruction Sheet multiplied by Line 7)</td>
                                            <td align="center" class="no_border_right">
                ...
                onfocus="SetFocus()" maxlength="10" style="WIDTH: auto"></td>
                                        ...
                                        <tr >
                                            <td width="70%">10.  Tax Overpaid (Line 6c is greater than Line 5)</td>
                                            <td align="center" class="no_border_right">
