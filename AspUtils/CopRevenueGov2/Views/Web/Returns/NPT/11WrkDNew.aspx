      ...
      <div class="col-lg-12" >
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
            ...
            <tbody>
                ...
                <tr>
                    <td>1.  Enter the portion of taxable income on which 2011 Business Income & Receipts Tax has been paid, AND which represents the distributive shares of ALL CORPORATE MEMBERS</td>
                    <td style="width:25%">                           
                ...
                <tr class="odd">
                    <td width="70%">2.  Enter the total taxable income of the taxpayer on which 2011 BIRT has been paid
