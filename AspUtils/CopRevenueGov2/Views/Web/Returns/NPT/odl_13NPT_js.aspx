...
<script language="javascript" type="text/javascript">
    ...
    function DisplayNPTReturn() {
        ...
        if ((parent.GetNodeCount(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '24') == 1) && parent.GetInnerNodeText(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', 'PRK_ID', '24') != undefined && parent.GetInnerNodeText(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', 'PRK_ID', '24').slice(-4) > 2010) {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez, 'BPT_INFO VERSION', '', 0) == '') {
                ...
                alert('Your 2013 BIRT return must be filed prior to filing your 2013 NPT Return.' + '\n To fill out your 2013 BIRT form, Please select BIRT from the side menu.');
                return;
            }
        }
        if (parent.GetNodeCount(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '3') == 1) {
           // parent.MenuWin.ispHighlightMenu(parent.MenuWin.mnuNPTYear13);
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, '12/31/2013', 'NPT_INFO PERIOD', '', 0);
    ...
    function PopulateNPTXML() {
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT1.value), 'NPT_PG1 RESIDENT_INCOME', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency($('#lblNPT2').text()), 'NPT_PG1 RESIDENT_INCOME_TAX', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT3.value), 'NPT_PG1 NON_RES_INCOME', '', 0);
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT6b.value), 'NPT_PG1 OTHER_TAX_CREDIT', '', 0);
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT8.value), 'NPT_PG1 INTEREST_PENALTY', '', 0);
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT11.value), 'NPT_PG1 LINE11', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT12a.value), 'NPT_PG1 REFUND', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT12b.value), 'NPT_PG1 BPT_OVERPAY', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT12c.value), 'NPT_PG1 NPT_OVERPAY', '', 0);
        PopulatePreparerXML(parent.$g.xmlNPT, 'NPT_INFO');
        //WrkA
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkA_1.value), 'NPT_WRKA RESIDENT_NET_INCOME', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkA_2.value), 'NPT_WRKA RESIDENT_FORM_1065', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkA_3.value), 'NPT_WRKA RESIDENT_OTHER_INCOME', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency($('#lblNPT_WrkA_4').text()), 'NPT_WRKA RESIDENT_TAXABLE_INCOME', '', 0);
        //WrkB
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkB_1.value), 'NPT_WRKB NON_RES__NET_INCOME', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkB_2.value), 'NPT_WRKB NON_RES_FORM_1065', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkB_3.value), 'NPT_WRKB NON_RES_OTHER_INCOME', '', 0);
        ...
        //WrkD
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkD_1.value), 'NPT_WRKD PORTION_TAXABLE_INCOME', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkD_2.value), 'NPT_WRKD TOTAL_TAXABLE_INCOME', '', 0);
        ...
        //WrkE
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkE_1.value), 'NPT_WRKE ESTIMATED_PROFIT_PAYMENT', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkE_2.value), 'NPT_WRKE PAYMENTS_WITH_EXTENSION', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkE_3.value), 'NPT_WRKE PRIOR_OVERPAYMENT_TBA', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency($('#lblNPT_WrkE_4').text()), 'NPT_WRKE TOTAL_PAYMENTS_CREDITS', '', 0);
        //WrkK
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_WrkK_1.value), 'NPT_WRKK BPT_PAGE1_LINE1', '', 0);
        ...
        //Page 4
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_1a.value), 'NPT_PG4 INVENTORY_RAW_A', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_1b.value), 'NPT_PG4 INVENTORY_RAW_B', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_2a.value), 'NPT_PG4 LAND_BUILDING_A', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_2b.value), 'NPT_PG4 LAND_BUILDING_B', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_3a.value), 'NPT_PG4 MACHINERY_EQUIP_A', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_3b.value), 'NPT_PG4 MACHINERY_EQUIP_B', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_4a.value), 'NPT_PG4 OTHER_ASSESTS_A', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_4b.value), 'NPT_PG4 OTHER_ASSESTS_B', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_5a.value), 'NPT_PG4 RENTED_PROPERTY_A', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_5b.value), 'NPT_PG4 RENTED_PROPERTY_B', '', 0);
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_9a.value), 'NPT_PG4 OUT_PHILLY_PAYROLL', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_9b.value), 'NPT_PG4 PAYROLL_EVERYWHERE', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency($('#lblNPT_Page4_9c').text()), 'NPT_PG4 OUTSIDE_PAYROLL_FACTOR', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_10a.value), 'NPT_PG4 OUT_PHILLY_RECEIPTS', '', 0);
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency(txtNPT_Page4_10b.value), 'NPT_PG4 GROSS_RECEIPTS_EVERYWHERE', '', 0);
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, stripCurrency($('#lblNPT_Page4_13').text()), 'NPT_PG4 WRKB_LINE4', '', 0);
    ...
    function CalcPage1Line12() {
        ...
        if (parseCurrency($('#lblNPT10').text()) > parseCurrency(txtNPT11.value)) {
            ...
            if (parseCurrency(txtNPT12a.value) + parseCurrency(txtNPT12b.value) + parseCurrency(txtNPT12c.value) != parseCurrency($('#lblNPT10').text())) {
    ...
    function CalcPage4Line6a() { //Total average value of Property used Outside Philadelphia, Lines 1a thru 5a and Enter on Line 8a
        if (txtNPT_Page4_1a.value != "" && txtNPT_Page4_2a.value != "" && txtNPT_Page4_3a.value != "" && txtNPT_Page4_4a.value != "" && txtNPT_Page4_5a.value != "") {

            $('#lblNPT_Page4_6a').text(ispFormatMoney((parseCurrency(txtNPT_Page4_1a.value) + parseCurrency(txtNPT_Page4_2a.value) + parseCurrency(txtNPT_Page4_3a.value) + parseCurrency(txtNPT_Page4_4a.value) + parseCurrency(txtNPT_Page4_5a.value)), 0));
    ...
    function CalcPage4Line7b() { //Total average value of Property used Everywhere, Lines 1b thru 5b and Enter on Line 8b
        if (txtNPT_Page4_1b.value != "" && txtNPT_Page4_2b.value != "" && txtNPT_Page4_3b.value != "" && txtNPT_Page4_4b.value != "" && txtNPT_Page4_5b.value != "") {

            $('#lblNPT_Page4_7b').text(ispFormatMoney((parseCurrency(txtNPT_Page4_1b.value) + parseCurrency(txtNPT_Page4_2b.value) + parseCurrency(txtNPT_Page4_3b.value) + parseCurrency(txtNPT_Page4_4b.value) + parseCurrency(txtNPT_Page4_5b.value)), 0));
