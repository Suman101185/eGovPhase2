...
Used in Business:</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <div class="form-group no-margin">
                                    <div class="">
                                    <input class="" id="txtNPT_Page4_10a"  onfocus="SetFocus()" maxlength="10" onchange="ValidateWorksheet("Page4")"/>
                            ...
                            <tr>
                                ...
                                <div class="form-group no-margin">
                                    <div class="">
                                    <LABEL id=lblBPT_SchC1_12 style="WIDTH: 100%" class=""></LABEL>  
                                    </div>
                                    </div>
                                ...
                                <div class="form-group no-margin">
                                    <div class="">
                                    <LABEL id="lblNPT_Page4_13" style="WIDTH: 100%" class=""></LABEL>  
                                    </div>
                                    </div>
                            ...
                            Multiply Line 13 times Line 12.
                                ...
                                <div class="form-group no-margin">
                                    <div class="">
                                    <LABEL id="lblNPT_Page4_14" style="WIDTH: 100%" class=""></LABEL>  
                                    </div>
                                    </div>
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9  text-right">                                     
                                <input  id="btnGoToPage1" onclick="ShowPage('WrkB','Page4')" class="btn btn-default submit_button" type="button" value="Return to Worksheet B">
                            </div>
                        </div>
