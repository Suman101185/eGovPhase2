   ...
   <div class="form_segment" id='NPT_WrkK' <%--style="DISPLAY: none;"--%>>
                                ...
                                <table summary="Employee Pay Sheet" class="hor-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>1.   Enter the amount from Page 1, Line 1 of the 2014 BIRT-EZ return or
    the Summary Page, Line 1 of the 2012 Business Income & Receipts Tax return</td>
                            ...
                            onfocus="SetFocus()" maxlength="10" onchange='ValidateWorksheet("WrkK")'>
            <%--    <label class="" id="lblNPT_WrkK_1" style="WIDTH: 100%"></label>--%>
                                            </td>
                                        </tr>
                                        <tr class="odd">
                                            <td width="70%">
                        ...
                        style="WIDTH: 100%">
                                         ...
                                         <tr class="odd">
                                            <td width="70%">3.  Enter the amount from Page 1, Line 5 of the 2014 Net Profits Tax Return
                                           ...
                                           <tr>
                                            ...
                                            <%--<label class="" id="lblNPT_WrkK_4" style="WIDTH: 100%"></label>--%>
                                                <input class="inpNormal" id="txtNPT_WrkK_4" style="WIDTH: 100%"
                            onfocus="SetFocus()" maxlength="10" onchange='ValidateWorksheet("WrkK")'>
                   </td>
                                        </tr>
                                 </tbody>
