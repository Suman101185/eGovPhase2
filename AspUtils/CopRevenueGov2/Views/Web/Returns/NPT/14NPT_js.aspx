...
<script language="javascript" type="text/javascript">
    ...
    function btnNPTPrint_onclick() {
        ...
        $('#btnWrkExtGoToPage1').css("visibility", "hidden");
        ...
        $('#btnWrkExtGoToPage1').css("visibility", "visible");
    ...
    function LoadError(formId) {
        ...
        switch (formId) {
            ...
            case "WrkK":
                ...
                break;
            case "WrkExtension":
                arrWrkKErr[i++] = [txtNPT_WrkExtension_1, 'ispValue($(\'#txtNPT_WrkExtension_1\').val()) == false', 'Value for Question 1 must be numeric'];
                arrWrkKErr[i++] = [txtNPT_WrkExtension_2, 'ispValue($(\'#txtNPT_WrkExtension_2\').val()) == false', 'Value for Question 2 must be numeric'];
            ...
            case "WrkD":
                ...
                if (PrepForMath($('#txtNPT_WrkD_8').val()) > PrepForMath($("#lblNPT_WrkD_6").text())) {
                    if (PrepForMath($('#txtNPT_WrkD_8').val()) > PrepForMath($("#lblNPT_WrkD_7").text())) {
                        $(parent.AppError).text('Line 8 value must be lower of of Line 6 or Line 7');
                    }
            ...
            case "WrkK":
                ...
                if (PrepForMath($('#txtNPT_WrkK_4').val()) > PrepForMath($("#lblNPT_WrkK_2").text())) {
                    if (PrepForMath($('#txtNPT_WrkK_4').val()) > PrepForMath($("#lblNPT_WrkK_3").text())) {
                        $(parent.AppError).text('Line 4 value must be lower of of Line 2 or Line 3');
                    }
    ...
    function CalcWrkExtensionLine3() { //(Line 1 minus Line 2). Enter on the Extension Coupon ; If Line 2 is greater than Line 1, no extension coupon is needed
        ...
        if (txtNPT_WrkExtension_1.value != '' && txtNPT_WrkExtension_2.value != '') {
            if (parseCurrency(txtNPT_WrkExtension_1.value) > parseCurrency(txtNPT_WrkExtension_2.value)) {
                calulationWrkExtension = parseCurrency(txtNPT_WrkExtension_1.value) - parseCurrency(txtNPT_WrkExtension_2.value);
            }
