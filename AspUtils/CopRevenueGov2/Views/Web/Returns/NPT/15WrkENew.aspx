       ...
       <div class="col-lg-12" >
        ...
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
            ...
            <tbody>
                ...
                <tr>
                    <td>1.  2015 Estimated Net Profits Tax Payments</td>
                    <td style="width:25%">                       
                ...
                <tr class="odd">
                    <td width="70%">2.  Payments of 2015 Net Profits Tax made with Application for Extension of Time to File
                ...
                <tr>
                    <td>3.   Overpayment of 2015 Business Income & Receipts Tax or 2014 Net Profits Tax to be applied to this tax return</td>
                    <td style="width:25%">                       
                         <div class="form-horizontal">
                      <div class="form-group no-margin">
                        <div class="">
                   <input class="form-control input-sm" id="txtNPT_WrkE_3" onfocus="SetFocus()" maxlength="10" onchange='ValidateWorksheet("WrkE")'>
                    ...
                    <tr class="odd">
                    <td width="70%">4.  Total of lines 1 through 3. Enter here and on Page 1, Line 12b [Calculated - Add lines 1 through 3]
                 ...
                 <tr >
                    ...
                    <div class="col-sm-offset-3 col-sm-9  text-right">           
                         ...
                         <INPUT  id=btnWrkEGoToPage1 class="btn btn-default submit_button" onclick="ShowPage('Page1', 'WrkE')" type="button"  value="Return to Page 1">
                        </div>
                        </div>
                        </td>
                   </tr>           
