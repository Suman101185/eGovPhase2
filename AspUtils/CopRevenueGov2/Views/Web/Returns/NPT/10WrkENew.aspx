       ...
       <div class="col-lg-12" >
        ...
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
            ...
            <tbody>
                ...
                <tr>
                    <td>1.  2010 Estimated Net Profits Tax Payments</td>
                    <td style="width:25%">                       
                ...
                <tr class="odd">
                    <td width="70%">2.  Payments of 2010 Net Profits Tax made with Application for Extension of Time to File
                ...
                <tr>
                    <td>3.   Overpayment of 2010 Business Income & Receipts Tax or 2009 Net Profits Tax to be applied to this tax return</td>
                    <td style="width:25%">                       
                         <div class="form-horizontal">
                      <div class="form-group no-margin">
                        <div class="">
