        ...
        To fill out your 2014 BIRT form, Please select BIRT from the side menu.
                    ...
                    <form class="form-horizontal school_form">                     
                        ...
                        <div class="col-lg-9">
                            <label class="control-label text-custom-left2" for="inputEmail3">
                                <span class="pull-left">If applicable, enter percentage from Worksheet D, Line 3:
                    ...
                    <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
                        ...
                        <tbody>
                            ...
                            <tr >
                                <td width="70%" class="text-left">10.  Tax Overpaid ( Line 6c is greater than Line 5)</td>
                                <td style="width:25%;" class="text-left">
