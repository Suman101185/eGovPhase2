      ...
      <div class="col-lg-12" >
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
            <tbody>
                ...
                <tr>
                    <td>1. Enter the amount from Page 1, Line 1 of the 2015 Business Income & Receipts Tax or
BIRT-EZ return</td>
                    <td style="width:25%">                        
                ...
                <tr>
                    <td>2.   Enter 60% of the amount on Line 1. If your entity has corporate members <b>Stop Here</b> and go to Page 3, Worksheet D ,Line 4- 
                    ...
                    <tr class="odd">
                    <td width="70%">3.  Enter the amount from Page 1, Line 11 of the 2015 Net Profits Tax Return
                    ...
                    <tr>
                    <td>4.   Business Income & Receipts Tax credit allowed. Enter the lesser of Line 2 or Line 3 here and on Page 1, Line 12a
                        </td>
                    <td style="width:25%">                    
                        <div class="form-horizontal">
                    <div class="form-group no-margin">
