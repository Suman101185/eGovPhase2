...
//refresh bptez form
    ...
    if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('24')")) {
        parent.MenuWin.ispHighlightMenu(parent.MenuWin.mnuBPTezYear10); 	//.mnuBPTezYear10Page2
		...
		$('#AppHeader').html(txtHeader + '<Font class=hdrMedium>|Business Income & Receipts Tax-EZ for 2010</Font>');
		parent.MenuWin.gsInstructionItem = '#BptEz';
		$('#AppMessage').html(parent.MenuWin.gsInstructionText 
                              + '<BR>The Business Income & Receipts Tax for 2010 is due April 15, 2011.');
...
//suman set last parameter true will cause xml copy to browser clipboard
	...
	if (parent.MenuWin.GetInnerNodeText(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', 'START_DATE', '24').slice(-4) == '2011') {
...
<%--<body onload="ispDisplayProgress('DisplayBPTezReturn()', 'Retrieving 2010 business privilege tax information')">--%>
...
<table class=tblShowBorder cellSpacing=0 cellPadding=0 border=0 style="MARGIN-LEFT: 4%" id=TABLE1  width="90%">
  ...
  <tr class=rowDataEven>
		...
		<td colspan=8>
			<label class="lblInstrNormal">Tax Due for the 2010 Business Privilege Tax</label></td>
  ...
  <tr class=rowDataOdd>
		...
		<td colspan=16>
			<label class="lblInstrNormal"><B><U>MANDATORY</U> 2011 BPT Estimated Payment <u>(repeat line 3)</u></label></B></td>
		<td colspan=3>
  ...
  <tr class=rowDataEven>
		...
		<td colspan=8>
			<label class="lblInstrNormal">Total Due by <B>4/15/2011</B></label></td>	
		<td colspan=8 align=right>
  ...
  <tr class=rowDataEven>
		...
		<td colspan=16>
				<label class="lblInstrNormal">Credit from overpayment of 2009 or 2010 Net Profit Tax</label></td>
		<td colspan=3>
  ...
  <tr class=rowDataOdd>
		...
		<td colspan=16>
				<label class="lblInstrNormal">Include any estimated and/or extension payments of 2010 BPT previously
			  made,<br>and any credit from overpayment of the 2009 BPT return</label>
		</td>
  ...
  <tr class=rowDataEven>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Applied, up to the tax due,	to the 2010 Net Profits Tax Return</label></td>
		<td colspan=3>
  ...
  <tr class=rowDataOdd>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Applied to the 2011	Business Privilege Tax</label></td>
		<td colspan=3>
