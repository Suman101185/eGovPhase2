...
//Check that user has a BPT account
	if (parent.$g.xmlAccount.documentElement.selectSingleNode("//*/TAX_ACCT[ACCOUNT = 24]")) {
...
var firstOfYear = '01/01/' + (sCurrYear-1)
	...
	if (bPeriodExist == false) {
		with (parent.MenuWin) {
//error_info
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldErrProgram, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldErrError, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldErrLine, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldErrMessage, '', 0)
//BPT_info	
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '12/31/' + (sCurrYear-1), xFldInfPeriod, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfVer, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfRetStat, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfLastUpdDate, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfRecDate, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfExtDate, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfSeq, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfAdjRef, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfUserId, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfABtaxRate, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfDtaxRate, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfEmanTaxRate, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfEwhoTaxRate, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfEretTaxRate, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, '', xFldInfLossCarry, '', 0)
//BPT_pg1
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li1, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li2, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li3, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li4, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li5, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li6, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li7, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li8, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li9, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li10, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li11, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li12, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li13, '', 0)
			parent.$x.ispXmlSetFieldVal(xmlBPTlf, 0, xFldPg1Li14, '', 0)
		}		//with
//BPT_schdA
		ClearBPTlfSchdA()
//BPT_schdB
...
var addrIdx
	if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ENTITY_INFO/ENTITY_ID', '', 0) != '') {
		lblAccountId.innerText = parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ENTITY_INFO/ACCOUNT_ID', '', 0)
		lblEntityId.innerText = parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ENTITY_INFO/ENTITY_ID', '', 0)
		...
		lblName.innerText = AdjustNameDisplay(parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'NAME_ADDRESS/NAME', '', addrIdx))
		addrIdx = LocatePrimaryAddr()	
		lblAddress.innerText = parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'NAME_ADDRESS/ADDRESS1', '', addrIdx) +
...
function PopulateBPTData() {
	with (parent.MenuWin) {
		dBPTNetRate = parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldInfABtaxRate, '', 0)
		dBPTGrossRate = parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldInfDtaxRate, '', 0)
		dBPTManufacturerRate = parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldInfEmanTaxRate, '', 0)
		dBPTWholesaleRate = parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldInfEwhoTaxRate, '', 0)
		dBPTRetailerRate = parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldInfEretTaxRate, '', 0)
//alert(dBPTNetRate)		
//BPT_Pg1
		lblBPT1_1.innerText = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li1, '', 0), 0)
		lblBPT1_2.innerText = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li2, '', 0), 0)
		lblBPT1_3.innerText = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li3, '', 0), 0)
		txtBPT1_4.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li4, '', 0), 0)
		lblBPT1_5.innerText = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li5, '', 0), 0)
		txtBPT1_6a.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li6, '', 0), 0)
		txtBPT1_6b.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li7, '', 0), 0)
		lblBPT1_6c.innerText = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li8, '', 0), 0)
//EGOVWEB-60 Changed xFldPg1Li8 to xFldPg1Li9
		lblBPT1_7.innerText = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li9, '', 0), 0)
		txtBPT1_8.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li10, '', 0), 0)
		lblBPT1_9.innerText = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li11, '', 0), 0)
		txtBPT1_10a.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li12, '', 0), 0)
		txtBPT1_10b.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li13, '', 0), 0)
		txtBPT1_10c.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(xmlBPTlf, xFldPg1Li14, '', 0), 0)
	}		//with
//BPT_SchdA
	PopulateBPTlfSchdA()
//BPT_SchdB
...
function btnBPTSubmit_onclick() {
	...
	if (AppError.innerText == ''){
		...
		PopulateXmlBPTlf()
		parent.DocWin.ispCallXMLForm(parent.$g.xmlBPTlf, tempXML, "BPTlfReturn", "")
...
//			BPT.style.display = 'none'
			...
			parent.$g.xmlBPTlf.loadXML(tempXML.xml)
			AppError.innerText = parent.$x.ispXmlGetFieldVal(tempXML, xFldErrMessage, '', 0)
		}		//if
	}		//if
...
//	BPT.style.display = "none"
	...
	lblAcctNo.innerText = parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ENTITY_INFO/ENTITY_ID', '', 0)
	if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldInfAdjRef, '', 0) != '') {
		lblConfirmNo.innerText = parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldInfAdjRef, '', 0)
	} else {
		lblConfirmNo.innerText = parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ENTITY_INFO/ACCOUNT_ID', '', 0)
...
function PopulateXmlBPTlf() {
	with (parent.MenuWin) {
		//Page 1
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, '12/31/' + (sCurrYear-1), xFldInfPeriod, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(lblBPT1_1.innerText), xFldPg1Li1, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(lblBPT1_2.innerText), xFldPg1Li2, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(lblBPT1_3.innerText), xFldPg1Li3, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(txtBPT1_4.value), xFldPg1Li4, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(lblBPT1_5.innerText), xFldPg1Li5, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(txtBPT1_6a.value), xFldPg1Li6, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(txtBPT1_6b.value), xFldPg1Li7, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(lblBPT1_6c.innerText), xFldPg1Li8, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(lblBPT1_7.innerText), xFldPg1Li9, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(txtBPT1_8.value), xFldPg1Li10, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(lblBPT1_9.innerText), xFldPg1Li11, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(txtBPT1_10a.value), xFldPg1Li12, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(txtBPT1_10b.value), xFldPg1Li13, '', 0)
		parent.$x.ispXmlSetFieldVal(xmlBPTlf, ispStripCurrency(txtBPT1_10c.value), xFldPg1Li14, '', 0)
	}		//with
	//BPT_SchdA
