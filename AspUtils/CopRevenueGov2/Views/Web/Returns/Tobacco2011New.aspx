...
<head >
    ...
    function DisplayTobaccoReturn() {
        ...
        $('#AppMessage').html(parent.gsInstructionText + '<BR>The Tobacco Tax for 2011 is due January 31, 2012.');
   ...
   <div class="container-fluid no-padding" id="TobaccoReturn">
        <div class="block3">
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td style="width:75%;">2a.  Total number of ounces of all tobacco and tobacco-related items sold January 1 through December 31, 2011. </td>
                                            <td style="width:25%;">                                             
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:25%;">                                               
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                    <input class="form-control input-sm table_custom_input" id=txtTobaccoNo2b onchange="ValidateTobaccoReturn()" onfocus="SetFocus()" maxlength=10 />
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                        ...
                                        <tr >
                                            <td style="width:75%;"> 3a. Total number of packs sold January 1 through December 31, 2011.&nbsp;</td>
                                            <td style="width:25%;">                                                
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td style="width:75%;">4. Tax due by January 31, 2012[Calculated - add lines 1d, 2d and 3d]</td>
                                            <td style="width:25%;">                                               
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr class="odd">
                                            <td>5.Tax previously paid for tax year 2011 and other credits</td>
                                            <td style="width:25%;">                                               
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
			...
			<label class="" >Amount of overpayment to be applied to the 2012 Tobacco and Tobacco-Related Products Tax.</label></td>
                           ...
                           <div> <%Html.RenderAction("PreparerSection", "INC"); %></div>
