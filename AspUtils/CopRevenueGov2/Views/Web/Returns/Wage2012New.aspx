...
<head>
    ...
    <script id="clientEventHandlersJS" language="javascript" type="text/javascript">
        ...
        function DisplayWage05Return() {
            ...
            $('#AppMessage').html(parent.gsInstructionText + '<BR>The Reconciliation of Wage Tax for 2012 is due February 28, 2012.');
...
<body>
    <div class="container-fluid no-padding" id="WageReturn">
        ...
        <div class="block3">
            ...
            <div class="container-fluid">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                        ...
                                                        Check if amended return.</label>
                                                            ...
                                                            <div class="col-sm-6"> <label class="" style="color: Red; width: 100%">All decimals will be rounded to the nearest whole number</label></div>
				...
				wage tax was remitted for the pay period including March 12, 2012. </td>
                                                                        <td width="25%">
				...
				which Philadelphia Wage Tax was withheld or due[Calculated - line 1 less line 2] </td>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td class="text-left"><span><strong>4.</strong></span> &nbsp; Total Taxable Compensation paid to residents of Philadelphia in 2012</td>
                                                                        <td width="25%">
                                                                            <form class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td class="text-left"><span><strong>6.</strong></span> &nbsp;  Total Taxable Compensation paid to non-residents of Philadelphia in 2012</td>
                                                                        <td width="25%">
                                                                            <form class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-left"><span><strong>9.</strong></span> &nbsp; Tax previously paid for 2012- <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
    ...
    ispDisplayProgress('btnSchool05Submit_onclick()', 'Submitting 2012 school tax information')" />
                                                        </div>
