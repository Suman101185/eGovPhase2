        ...
        <div class="tab_container" id="BPTez" style="DISPLAY: none;">
            <div style="display: block;" id="tab1" class="tab_content">
                            ...
                            <div class="form_segment">
                                ...
                                <table summary="Employee Pay Sheet" class="hor-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td width="70%">3.  Tax Due for the 2013 Business Income & Receipts Tax [Calculated - add lines 1 and 2] </td>
                                            <td align="center" class="no_border_right">
			 ...
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        ...
                                        <tr class="odd">
                                            <td width="70%">5.  Total Due by <B>4/15/2014</B>[Calculated - add lines 3 and 4] </td>
                                            <td align="center" class="no_border_right">
                                        ...
                                        <tr class="odd">
                                            <td width="70%">6a.  Credit from overpayment of 2012 or 2013 Net Profit Tax </td>
                                            <td align="center" class="no_border_right">
                                              <input class="" id=txtBPTez1_6a onchange="ValidateBPTezReturn()"
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        </tr>
                                        <tr>
                                            <td>6b.  Include any estimated and/or extension payments of 2013 BIRT previously
			 ...
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
					...
					onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
                                        ...
                                        <tr class="odd">
                                            <td>10b. Applied, up to the tax due,	to the 2013 Net Profits Tax Return<</td>
                                            <td align="center" class="no_border_right">
					...
					onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
                                        ...
                                        <tr>
                                            <td width="70%">10c. Applied to the 2014	Business Income & Receipts Tax </td>
                                            <td align="center" class="no_border_right">
