...
<head>
    ...
    <script language='javascript' type="text/javascript">
        ...
        function LoadErrorBPTlfSchdD() {
            ...
            var txtBPT_SchD_9 = document.getElementById('txtBPT_SchD_9');
        ...
        function PopulateXmlBPTlfSchdD() {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchD_1.value), xFldScDLi1, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchD_2.value), xFldScDLi2, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchD_3.value), xFldScDLi3, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchD_4').text()), xFldScDLi4, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchD_5A.value), xFldScDLi5a, '', 0);

            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchD_5B.value), xFldScDLi5b, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchD_5C.value), xFldScDLi5c, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchD_5D.value), xFldScDLi5d, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchD_6').text()), xFldScDLi6, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchD_7.value), xFldScDLi7, '', 0);

            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchD_8.value), xFldScDLi8, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchD_9').text()), xFldScDLi9, '', 0);
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchD_12').text()), xFldScDLi11, '', 0);
        ...
        function PopulateBPTlfSchdD() {
            ...
            txtBPT_SchD_1.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi1, '', 0), 0);
            txtBPT_SchD_2.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi2, '', 0), 0);
            txtBPT_SchD_3.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi3, '', 0), 0);
            lblBPT_SchD_4.innerText = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi4, '', 0), 0);
            txtBPT_SchD_5A.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi5a, '', 0), 0)
            txtBPT_SchD_5B.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi5b, '', 0), 0);
            txtBPT_SchD_5C.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi5c, '', 0), 0);
            txtBPT_SchD_5D.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi5d, '', 0), 0);
            $('#lblBPT_SchD_6').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi6, '', 0), 0));
            txtBPT_SchD_7.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi7, '', 0), 0);
            txtBPT_SchD_8.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi8, '', 0), 0);
            $('#lblBPT_SchD_9').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi9, '', 0), 0));
            ...
            $('#lblBPT_SchD_12').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScDLi11, '', 0), 0));
        ...
        function FieldLockBPTlfSchdD(bDisabled) {
            ...
            $('#txtBPT_SchD_9').attr('disabled', bDisabled);
        ...
        function NetTaxdue() {
            ...
            var value_9 = PrepForMath($('#lblBPT_SchD_6').text()) - PrepForMath(txtBPT_SchD_7.value);
            $("#txtBPT_SchD_9").val(value_9);
        ...
        function CalcSchdDLine12() {
            ...
            if ($('#lblBPT_SchD_10').text() != '' && $('#lblBPT_SchD_11').text() != '') {
                var val10 = $('#lblBPT_SchD_10').text();
                var val11 = $('#lblBPT_SchD_11').text();
               
               $('#lblBPT_SchD_12').text(ispFormatMoney(PrepForMath(val10) + PrepForMath(val11), 0));
...
<body>
                        ...
                        <div class="col-lg-12 templateclass">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-condensed table-striped custom_table03">
                                    ...
                                    <thead>
                                        <tr>
                                            <th colspan="3" width="100%"><b><u>2015 BIRT Schedule D: Computation Of Tax On Gross Receipts</u></b></th>
    ...
    business capital assests</td>
                                        ...
                                        <tr class="odd">
                                            <td width="5%">7.</td>
                                            <td width="70%" class="text-left">Statutory Exclusion (Lower of Line 6 or $75,000.00)
                                        </td>
                                            <td width="25%" class="text-left">
                                                <form class="form-horizontal">
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%" class="text-left">
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="form-group no-margin">
                                                        <div class="">
                                                            <input class="form-control input-sm" id="txtBPT_SchD_9" style="width: 100%" onfocus="SetFocus()" onchange='ValidateWorksheet("BPT_SchdD")'>
                                                        </div>
                                                    </div>
                                        ...
                                        <tr>
                                            <td width="5%">9.</td>
                                            <td width="70%" class="text-left">&nbsp;Receipts on which tax is to be computed by the Alternate Method.
                                        ...
                                        <tr class="odd">
                                            <td width="5%">10.</td>
                                            <td width="70%" class="text-left">Receipts subject to tax at the regular rate (Line 8 minus Line 9)</td>
                                            <td width="25%" class="text-left">
                                                <form class="form-horizontal">
