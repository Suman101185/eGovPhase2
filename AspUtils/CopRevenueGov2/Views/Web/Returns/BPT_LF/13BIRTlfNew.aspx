    ...
    <script id="bptIF" language="javascript" type="text/javascript">
        ...
        function DisplayBPTlfReturn() {
            ...
            if ($(parent.$g.xmlAccount.xml).find('TAX_ACCT[ACCOUNT = "24"]').eq(0)) {
                ...
                parent.$g.xmlBPTlf.loadXML(parent.$g.xmlBPTlfTemplate_2014.xml);
                ...
                ispCallXMLForm(parent.$g.xmlBPTlf, parent.$g.xmlBPTlf, "BPT_LF/BPTlfReturn_2014", "");
        ...
        function btnBPTSubmit_onclick() {
            ...
            if ($(parent.AppError).text() == '') {
                ...
                ispCallXMLForm(parent.$g.xmlBPTlf, tempXML, "BPT_LF/BPTlfReturn_2014", "");
...
<body>
    <div class="container-fluid no-padding">
     ...
     <div class="col-lg-12 col-md-12">   
     	...
     	<div class="blue_base_box" style="display: block;" id="tab1">
            ...
            <div class="contentsection">
			  ...
			  made,<br>and any credit from overpayment of the 2011 BPT return</td>
					...
					onfocus="SetFocus()"> </div>
                                            ...
                                            <tr> 
                                            	<td width="5%">10c.</td>
                                                <td width="70%" class="text-left">Applied to the 2014Business Income & Receipts Tax</td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
