...
<head >
    ...
    <script language='javascript' type="text/javascript">
        ...
        function PopulateBPTlfSchdA() {
            ...
            txtBPT_SchA_10.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldInfLossCarry, '', 0), 0);
        ...
        function FieldLockBPTlfSchdA(bDisabled) {
            ...
            $('#txtBPT_SchA_10').attr('disabled', 'disabled');
    ...
    <div class="form_segment" id="BPT_SchdA" style="DISPLAY: none;">
                                ...
                                <table summary="Employee Pay Sheet" class="hor-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td width="70%"><B><U>2013 BIRT Schedule A: Computation of Tax On Net Income(Method I)</U></B></td>
