...
<head>
    ...
    <script id="bptIF" language="javascript" type="text/javascript">
        ...
        function DisplayBPTlfReturn() {
            ...
            if ($(parent.$g.xmlAccount.xml).find('TAX_ACCT[ACCOUNT = "24"]').eq(0)) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldErrError, '', 0) != 0) {
                    ...
                    $(BPT_Pg1).css('display', 'block');
                    FieldLock(true);
                    $(parent.AppError).text(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldErrMessage, "", 0));
        ...
        function PopulateBPTData() {
            ...
            txtBPT1_6a.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldPg1Li6, '', 0), 0)
            txtBPT1_6b.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldPg1Li7, '', 0), 0);
            ...
            txtBPT1_8.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldPg1Li10, '', 0), 0);
            $('#lblBPT1_9').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldPg1Li11, '', 0), 0));
            txtBPT1_10a.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldPg1Li12, '', 0), 0);
            txtBPT1_10b.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldPg1Li13, '', 0), 0);
            txtBPT1_10c.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldPg1Li14, '', 0), 0);
        ...
        function btnBPTSubmit_onclick() {
            ...
            if ($(parent.AppError).text() == '') {
                ...
                ispCallXMLForm(parent.$g.xmlBPTlf_2015, tempXML, "BPT_LF/BPTlfReturn_2014", "");
        ...
        function chkAmended_08_onclick() {
            ...
            if ($('#chkAmended_08').is(':checked')) {
                ...
                //parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, "A1", "xFldInfRetStat", '', 0); //temporarily
        ...
        function PopulateXmlBPTlf() {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT1_4.value), xFldPg1Li4, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT1_5').text()), xFldPg1Li5, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT1_6a.value), xFldPg1Li6, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT1_6b.value), xFldPg1Li7, '', 0);
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT1_8.value), xFldPg1Li10, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT1_9').text()), xFldPg1Li11, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT1_10a.value), xFldPg1Li12, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT1_10b.value), xFldPg1Li13, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT1_10c.value), xFldPg1Li14, '', 0);
        ...
        function ValidateWorksheet(formId) {
            ...
            switch (formId) {
                ...
                case "BPT_SchdD":
                    ...
                    PerformCalcsBPTlfSchdD();
                    if (ObjSelected.id == txtBPT_SchD_7.value && PrepForMath(ObjSelected.value) > 0) {
                                	...
                                	<table class="table table-condensed table-striped custom_table03">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <label id="lblLnkSchdB" class="lblLink label_NoLeft" style="width:100%" onclick="ShowPage('SchdB')">Schedule B, Line 13</label>
                                                    or 
			                                    <label id="lblLnkSchdA" class="lblLink label_NoLeft" style="width:100%" onclick="ShowPage('SchdA')">Schedule A, Line 15</label>
                                            ...
                                            <tr>
                                     		...
                                     		<tr class="odd">
                                            	<td width="5%">4.</td>
                                                <td width="70%" class="text-left"> <B><U>MANDATORY</U> 2016 BIRT Estimated Payment <u>(See Instructions)</u> </B>)</td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                            ...
                                            <tr>
                                            	<td width="5%">5.</td>
                                                <td width="70%" class="text-left">Total Due by <B>4/18/2016</B>[Calculated - add lines 3 and 4]</td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">

                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                             <label id=lblBPT1_5 style="width: 100%" class="form-control input-sm"></label></div>
                                                          </div>
                                       ...
                                       <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                            	<td width="5%">6a.</td>
                                                <td width="70%" class="text-left">Include any estimated and/or extension payments of 2015 BIRT previously made,
and any credit from overpayment of the 2014 BIRT and/or 2015 NPT return.</label> </td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
					...
					onfocus="SetFocus()">  </div>
                                     		...
                                     		<tr class="odd">
                                            	<td width="5%">10b.</td>
                                                <td width="70%" class="text-left">Applied,to the 2015 Net Profits Tax Return</td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
    ...
    ispDisplayProgress('btnSchool08Submit_onclick()', 'Submitting 2015 school tax information')" />
                            </div>
                            </div>
     ...
     >Change Form</a> to cancel
              ...
              <% 
              Html.RenderAction("_15SchdE", "BPT_LF");
              Html.RenderAction("_15WorkSheet5", "BPT_LF");
              Html.RenderAction("_15SchdB", "BPT_LF");
              Html.RenderAction("_15SchdA", "BPT_LF");
              Html.RenderAction("_15SchdC1", "BPT_LF");
              Html.RenderAction("_15SchdD", "BPT_LF");
