  ...
  <script src="../../Content/Scripts/JqueryMin.js" type="text/javascript"></script>
    ...
    <script id="bptIF" language="javascript" type="text/javascript">
        ...
        function DisplayBPTlfReturn() {
            ...
            if ($(parent.$g.xmlAccount.xml).find('TAX_ACCT[ACCOUNT = "24"]').eq(0)) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldErrError, '', 0) != 0) {
                    ...
                    $(BPT_Pg1).css('display', 'block');
                    FieldLock(true);
                    $(parent.AppError).text(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldErrMessage, "", 0));
        ...
        function PopulateBPTData() {
            ...
            txtBPT1_8.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li10, '', 0), 0);
        ...
        function PopulateXmlBPTlf() {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT1_8.value), xFldPg1Li10, '', 0);
        ...
        function CalcBPTlfPg1Line5() {
            ...
            if (txtBPT1_4.value != '') {
                ...
                //alert(ispFormatMoney(PrepForMath(val3) + PrepForMath(txtBPT1_4.value), 0));
...
<body>
    <%--<div class="tab_Tcontainer" id="BPT">
		...
		<label class="" style="width:100%">If your business terminated in 
                            ...
                            <div class="form_segment">
                                ...
                                <table summary="Employee Pay Sheet" class="hor-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>3. Tax Due for the 2014 Business Income & Receipts Tax[Calculated - add lines 1 and 2]</td>
                                            <td align="center" class="no_border_right">
                                              <label id=lblBPT1_3 style="WIDTH: 100%"></label></td>
                                        </tr>
                                        <tr class="odd">
                                            <td width="70%">4. <B><U>MANDATORY</U> 2015 BIRT Estimated Payment <u>(repeat line 3)</u> </B></td>
                                            <td align="center" class="no_border_right">
			 ...
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        ...
                                        <tr>
                                            <td>5. Total Due by <B>4/15/2015</B>[Calculated - add lines 3 and 4]</td>
                                            <td align="center" class="no_border_right">
                                        ...
                                        <tr>
                                            <td>6a.  Credit from overpayment of 2013 or 2014 Net Profit Tax</td>
                                            <td align="center" class="no_border_right">
			 ...
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
					...
					onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"> </td>
                                        ...
                                        <tr>
                                            <td width="70%">10b.  Applied, up to the tax due,	to the 2014 Net Profits Tax Return</td>
                                            <td align="center" class="no_border_right">
                                              <input class="" id=txtBPT1_10b onchange="ValidateWorksheet('BPT_Pg1')"
					onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        </tr>
                                        <tr class="odd">
                                            <td>10c. Applied to the 2015	Business Income & Receipts Tax</td>
                                            <td align="center" class="no_border_right">
     ...
     >Change Form</a> to cancel
                ...
                <%
                    Html.RenderAction("_14SchdA", "BPT_LF");
                    ...
                    Html.RenderAction("_14BIRTlf_js", "BPT_LF");
                     %>
                              ...
                              <div class="row form-group topsmallform">
				                    ...
				                    <script>document.write(sCurrYear - 1)</script>,
					                    enter the termination date here <u>AND</u> file a <a href="http://www.phila.gov/revenue/pdfs/chgform.html" >CHANGE FORM</a>.</span>
                                                            ...
                                                            <div class="col-sm-3">  <input class="" id=txtTermDate onfocus="SetFocus()" onblur="return txtTermDate_onblur()"></div>
                                                        </div>
                            </form>
                                                        ...
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                               <input  id=txtBPT1_8 onchange="ValidateWorksheet('BPT_Pg1')"
			                                                    onfocus="SetFocus()" class="form-control input-sm"> </div>
                                                          </div>
