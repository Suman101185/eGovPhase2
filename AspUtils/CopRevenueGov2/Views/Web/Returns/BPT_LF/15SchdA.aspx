...
<head>
    ...
    <script language='javascript' type="text/javascript">
        ...
        function ClearBPTlfSchdA() {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, 0, xFldScALi13, '', 0);
        ...
        function PopulateXmlBPTlfSchdA() {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchA_1.value), xFldScALi1, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchA_2.value), xFldScALi2, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchA_3.value), xFldScALi3, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchA_4.value), xFldScALi4, '', 0);
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchA_8.value), xFldScALi8, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchA_9').text()), xFldScALi9, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchA_10').text()), xFldScALi10, '', 0);

            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#txtBPT_SchA_11').value), xFldScALi11, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchA_12').text()), xFldScALi12, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchA_13').text()), xFldScALi13, '', 0);
            //Carry to Page 1
            //parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchA_12').text()), 'BPT_PG1 NET_INCOME', '', 0);
        ...
        function PopulateBPTlfSchdA() {
            ...
            txtBPT_SchA_1.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi1, '', 0), 0);
            txtBPT_SchA_2.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi2, '', 0), 0);
            txtBPT_SchA_3.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi3, '', 0), 0);
            txtBPT_SchA_4.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi4, '', 0), 0);

            //alert('before change : ' + ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi5, '', 0), 0));
            ...
            $('#lblBPT_SchA_6').text(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi6, '', 0) * 100);
            $('#lblBPT_SchA_7').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi7, '', 0), 0));
            txtBPT_SchA_8.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi8, '', 0), 0);
            ...
            $('#lblBPT_SchA_10').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi10, '', 0), 0));
            txtBPT_SchA_11.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldInfLossCarry, '', 0), 0);
            $('#lblBPT_SchA_12').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi12, '', 0), 0));
            $('#lblBPT_SchA_13').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScALi13, '', 0), 0));
        ...
        <div class="row">
            ...
            <div class="col-lg-12 templateclass">
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            ...
                            <table class="table table-condensed table-striped custom_table03">
                                ...
                                <thead>
                                    <tr>
                                        <th colspan="3" width="100%"><b><u>2015 BIRT Schedule A: Computation of Tax On Net Income(Method I)</u></b></th>
				...
				deducted in arriving at Net Income, less total nonbusiness income</td>
                                    ...
                                    <tr class="odd">
                                        <td width="5%">12.</td>
                                        <td width="70%" class="text-left">Taxable Income (Loss)[Calculated -Line 9 minus Line 10 minus Line 11].</td>
                                        <td width="25%" class="text-left">
                                            <form class="form-horizontal">
                                    ...
                                    <tr>
                                        ...
                                        <td width="70%" class="text-left">
                                            <label id="msgBPT_SchA_13" class="form-control input-sm"><b>TAX DUE</b> (Multiply Line 12 by ###)</label></td>
                                        <td width="25%" class="text-left">
                                            <form class="form-horizontal">
