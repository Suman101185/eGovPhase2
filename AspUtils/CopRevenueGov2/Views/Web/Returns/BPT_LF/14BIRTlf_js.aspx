    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowPage1(iPage, iWrk) {
            ...
            switch (iPage) {
                ...
                case "WrkD":
                    ///parent.MenuWin.ispHighlightMenu(parent.MenuWin.mnuBPTezYear05Page1)
                    //parent.MenuWin.ispHighlightMenu(parent.MenuWin.mnuReNPT)
                    //NPT_WrkD.style.visibility = "visible"
                    //NPT_WrkD.style.display = "block"
        ...
        function chkCorpMembers_onclick() { //Determine if questions 3 & 4 of Worksheet K are needed or if Worksheet D will be used instead
            if (chkCorpMembers.checked) { //Companay has Corporate Members
                ...
                $('#CorpMembers_1').css('display', 'none'); //.style.display = "none"
                $('#CorpMembers_2').css('visibility', 'hidden'); //.style.visibility = "hidden"
                $('#CorpMembers_2').css('display', 'none'); //.style.display = "none"
                hasCorpMembers = true;
            } else { //Company does not have Corporate Members
                $('#CorpMembers_1').css('visibility', 'visible');
                $('#CorpMembers_1').css('display', 'block'); //.style.display = "none"
                $('#CorpMembers_2').css('visibility', 'visible'); //.style.visibility = "hidden"
                $('#CorpMembers_2').css('display', 'block'); //.style.display = "none"
