    ...
    <div class="tab_Tcontainer" >
		...
		<label class="" style="width:100%">If your business terminated in 
                            ...
                            <div class="form_segment">
                                ...
                                <table summary="Employee Pay Sheet" class="hor-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>3. Tax Due for the 2010 Business Income & Receipts Tax[Calculated - add lines 1 and 2]</td>
                                            <td align="center" class="no_border_right">
                                              <label id=lblBPT1_3 style="WIDTH: 100%"></label></td>
                                        </tr>
                                        <tr class="odd">
                                            <td width="70%">4. <B><U>MANDATORY</U> 2011 BIRT Estimated Payment <u>(repeat line 3)</u> </B></td>
                                            <td align="center" class="no_border_right">
			 ...
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        ...
                                        <tr>
                                            <td>5. Total Due by <B>4/15/2012</B>[Calculated - add lines 3 and 4]</td>
                                            <td align="center" class="no_border_right">
                                        ...
                                        <tr>
                                            <td>6a.  Credit from overpayment of 2009 or 2010 Net Profit Tax</td>
                                            <td align="center" class="no_border_right">
			 ...
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
					...
					onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"> </td>
                                        ...
                                        <tr>
                                            <td width="70%">10b.  Applied, up to the tax due,	to the 2010 Net Profits Tax Return</td>
                                            <td align="center" class="no_border_right">
                                              <input class="" id=txtBPT1_10b onchange="ValidateWorksheet('BPT_Pg1')"
					onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        </tr>
                                        <tr class="odd">
                                            <td>10c. Applied to the 2011	Business Income & Receipts Tax</td>
                                            <td align="center" class="no_border_right">
