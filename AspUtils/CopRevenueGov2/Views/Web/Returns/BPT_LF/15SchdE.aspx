    ...
    <title></title>
     <script language='javascript' type="text/javascript">
         ...
         function PopulateBPTlfSchdE() {
             ...
             //clipboardData.setData ('Text', parent.$g.xmlBPTlf_2015.xml.xml);
             $('#lblBPT_SchE_1').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScELi1, '', 0), 0)); //binoy
             txtBPT_SchE_2.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScELi2, '', 0), 0);
             ...
             $('#lblBPT_SchE_5').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScELi5, '', 0), 0));
             txtBPT_SchE_6A.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScELi6a, '', 0), 0);
             txtBPT_SchE_6B.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScELi6b, '', 0), 0);
             ...
             $('#lblBPT_SchE_10').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScELi10, '', 0), 0));
             txtBPT_SchE_11A.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScELi11a, '', 0), 0);
             txtBPT_SchE_11B.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScELi11b, '', 0), 0);
         ...
         function PopulateXmlBPTlfSchdE() {
             ...
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(lblBPT_SchE_1.value), xFldScELi1, '', 0) //binoy
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchE_2.value), xFldScELi2, '', 0)
             ...
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchE_5').text()), xFldScELi5, '', 0)
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchE_6A.value), xFldScELi6a, '', 0)
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchE_6B.value), xFldScELi6b, '', 0)
             ...
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#lblBPT_SchE_10').text()), xFldScELi10, '', 0)
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchE_11A.value), xFldScELi11a, '', 0)
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency(txtBPT_SchE_11B.value), xFldScELi11b, '', 0)
 ...
 <%--     <div class="container-fluid no-padding">
                        ...
                        <div class="well">                        
                                <div class="table-responsive">
                                	...
                                	<table class="table table-condensed table-striped custom_table03">
                                    	...
                                    	<thead>
                                        	<tr>
                                            	<th colspan="3" width="100%"><u><B>2015 BIRT Schedule E: Computation Of Tax On 
    Gross Receipts</U></B><br>Alternate Method of Computing Tax on Gross Receipts<br>(To be used by 
    ...
    Method (from <label class="lblLink label_NoLeft" style="width:100%" onclick="ShowPage('SchdD')">Schedule D, Line 8</label>
      ...
      onfocus=SetFocus() onchange='ValidateWorksheet("BPT_SchdE")'
                                            ...
                                            <tr>
                                            	<td width="5%">5.</td>
                                                <td width="70%" class="text-left">Receipts on which tax is to be computed by the Alternate Method (from Schedule D, Line 9)</td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
      ...
      onfocus=SetFocus() onchange='ValidateWorksheet("BPT_SchdE")'>
                                ...
                                <tr class="odd">
                                            ...
                                            <tr class="odd">
                                            	<td width="5%">10.</td>
                                                <td width="70%" class="text-left"> Receipts on which tax is to be computed by the Alternate 
    Method (from <label class="lblLink label_NoLeft" style="width:100%" onclick="ShowPage('SchdD')">Schedule D, Line 9</label><label id="Label2">).</label></td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                                        ...
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                                  <INPUT id=txtBPT_SchE_11A style="WIDTH: 100%" 
