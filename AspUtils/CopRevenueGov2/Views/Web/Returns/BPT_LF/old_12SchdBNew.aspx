...
<head>
    ...
    <script language='javascript' type="text/javascript">
        ...
        function PopulateBPTlfSchdB() {
            ...
            txtBPT_SchB_10.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldInfLossCarry, '', 0), 0);
        ...
        function FieldLockBPTlfSchdB(bDisabled) {
            ...
            $('#txtBPT_SchB_10').attr('disabled', 'disabled');
   ...
   <div class="form_segment" id="BPT_SchdB" style="DISPLAY: none;">
                                ...
                                <table summary="Employee Pay Sheet" class="hor-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td width="70%"><B><U>2013 BIRT Schedule B: Computation of Tax On Net Income(Method II)</U></B></td>
    		...
    		affiliated group. (Reg. 302(14)).</td>
				...
				onfocus=SetFocus() maxLength=10 onchange=ValidateWorksheet("BPT_SchdB")></td>
                                       ...
                                       <tr >
                                          ...
                                          <tr class="odd">
                                            <td width="70%">10.  Loss carry foward, if any. (<u><font style="cursor:pointer;" onclick="parent.InstructionLinks()">See Instruction Sheet IV</font></u>)</td>
                                            <td align="center" class="no_border_right">
