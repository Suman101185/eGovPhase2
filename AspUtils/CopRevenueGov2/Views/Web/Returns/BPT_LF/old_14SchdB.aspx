...
<head>   
    ...
    <script language='javascript' type="text/javascript">
        ...
        function LoadErrorBPTlfSchdB() {
            ...
            arrSchdBErr[i++] = [txtBPT_SchA_11, 'txtBPT_SchB_11.value == ""', 'Answer Question 11'];  //binoy
            arrSchdBErr[i++] = [txtBPT_SchA_11, 'ispValue(txtBPT_SchB_11.value) == false', 'Value for Question 11 must be numeric'];
            arrSchdBErr[i++] = [txtBPT_SchA_11, 'ispNegativeNumber(txtBPT_SchB_11.value) == false', 'Value for Question 11 must NOT be negative'];
        }		//LoadErrorBPTlfSchdB

        function ClearBPTlfSchdB() {

            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi1, '', 0);		//line 1
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi2a, '', 0);		//line 2a
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi2b, '', 0);		//line 2b
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi2c, '', 0);		//line 2c
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi2d, '', 0);		//line 2d
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi2e, '', 0);		//line 2e
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi2f, '', 0);		//line 2f
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi2g, '', 0);		//line 2g
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi2h, '', 0);		//line 2h
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi2i, '', 0);		//line 2i
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi2j, '', 0);		//line 2j
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi3, '', 0);		//line 3
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi4, '', 0);		//line 4
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi5, '', 0);		//line 5
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi6, '', 0);		//line 6
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi7, '', 0);		//line 7
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi8, '', 0);		//line 8
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi9, '', 0);		//line 9
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi10, '', 0)		//line 10
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi11, '', 0);		//line 11
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi12, '', 0);		//line 12
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldScBLi13, '', 0);		//line 13
        }		//ClearBPTlfSchdB

        function PopulateXmlBPTlfSchdB() {
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_1.value), xFldScBLi1, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_2A.value), xFldScBLi2a, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_2B.value), xFldScBLi2b, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_2C.value), xFldScBLi2c, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_2D.value), xFldScBLi2d, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_2E.value), xFldScBLi2e, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchB_2F').text()), xFldScBLi2f, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_2G.value), xFldScBLi2g, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_2H.value), xFldScBLi2h, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, $('#lblBPT_SchB_2I').text(), xFldScBLi2i, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchB_2J').text()), xFldScBLi2j, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchB_3').text()), xFldScBLi3, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_4.value), xFldScBLi4, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchB_5').text()), xFldScBLi5, '', 0);
            //EGOVWEB-63
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, parseFloat($('#lblBPT_SchB_6').text()).toFixed(6), xFldScBLi6, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchB_7').text()), xFldScBLi7, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_8.value), xFldScBLi8, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchB_9').text()), xFldScBLi9, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchB_10').text()), xFldScBLi10, '', 0);  //binoy
            
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT_SchB_11.value), xFldScBLi11, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchB_12').text()), xFldScBLi12, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchB_13').text()), xFldScBLi13, '', 0);
        }		//PopulateBPTlfXMLSchdB

        function PopulateBPTlfSchdB() {
            txtBPT_SchB_1.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi1, '', 0), 0);
            txtBPT_SchB_2A.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2a, '', 0), 0);
            txtBPT_SchB_2B.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2b, '', 0), 0);
            txtBPT_SchB_2C.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2c, '', 0), 0);
            txtBPT_SchB_2D.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2d, '', 0), 0);
            txtBPT_SchB_2E.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2e, '', 0), 0);
            $('#lblBPT_SchB_2F').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2f, '', 0), 0));
            txtBPT_SchB_2G.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2g, '', 0), 0);
            txtBPT_SchB_2H.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2h, '', 0), 0);
            //alert(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2i, '', 0));
            //alert(PrepForMath(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2i, '', 0)) * 100);
           
            $('#lblBPT_SchB_2I').text('$'+(PrepForMath(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2i, '', 0)) * 100).toString());
            $('#lblBPT_SchB_2J').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi2j, '', 0), 0));

            $('#lblBPT_SchB_3').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi3, '', 0), 0));
            txtBPT_SchB_4.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi4, '', 0), 0);
            $('#lblBPT_SchB_5').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi5, '', 0), 0));
            $('#lblBPT_SchB_6').text(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi6, '', 0) * 100);
            $('#lblBPT_SchB_7').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi7, '', 0), 0));
            txtBPT_SchB_8.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi8, '', 0), 0);
            $('#lblBPT_SchB_9').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi9, '', 0), 0));
            //EGOVWEB-131 EHD 03/25/2013 Always populate from BPT_INFO(xFldInfLossCarry) not BPT_SCH_A(xFldScBLi10)
          //  $('#lblBPT_SchB_10').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfLossCarry, '', 0), 0));
            $('#lblBPT_SchB_10').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi10, '', 0), 0)); //binoy
            txtBPT_SchB_11.value=ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi11, '', 0), 0);
            $('#lblBPT_SchB_12').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi12, '', 0), 0));
            $('#lblBPT_SchB_13').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi13, '', 0), 0));
