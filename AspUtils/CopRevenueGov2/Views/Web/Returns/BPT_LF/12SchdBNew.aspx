  ...
  <script src="../../Content/Scripts/JqueryMin.js" type="text/javascript"></script>
    ...
    <script language='javascript' type="text/javascript">
        ...
        function PopulateXmlBPTlfSchdB() {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf, stripCurrency($('#lblBPT_SchB_10').text()), xFldScBLi10, '', 0);  //binoy

            //parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf, stripCurrency(txtBPT_SchB_11.value), xFldScBLi11, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf, stripCurrency($('#lblBPT_SchB_12').text()), xFldScBLi12, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf, stripCurrency($('#lblBPT_SchB_13').text()), xFldScBLi13, '', 0);
        ...
        function PopulateBPTlfSchdB() {
            ...
            //alert(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldScBLi2i, '', 0));
            //alert(PrepForMath(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldScBLi2i, '', 0)) * 100);
            ...
            //  $('#lblBPT_SchB_10').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldInfLossCarry, '', 0), 0));
            $('#lblBPT_SchB_10').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldScBLi10, '', 0), 0)); //binoy
            //txtBPT_SchB_11.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldScBLi11, '', 0), 0);
            $('#lblBPT_SchB_12').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldScBLi12, '', 0), 0));
            $('#lblBPT_SchB_13').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf, xFldScBLi13, '', 0), 0));
   ...
   <div class="col-lg-12 col-md-12" id="BPT_SchdB" style="DISPLAY: none;">   
     <div class="row">
				...
				onfocus=SetFocus() maxLength=10 onchange=ValidateWorksheet("BPT_SchdB")>
                                            ...
                                            <tr>
                                            	<td widh="5%">10.</td>
                                                <td widh="70%" class="text-left">Loss Carry Forward, if any. (<u><font style="cursor:pointer;" onclick="parent.InstructionLinks()">See Instruction Sheet IV</font></u>)</td>
                                                <td widh="25%" class="text-left">
                                               		<form class="form-horizontal">

                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                                 <INPUT class="form-control input-sm" id=txtBPT_SchB_10 style="WIDTH: 100%" 
				onfocus=SetFocus() maxLength=10 onchange=ValidateWorksheet("BPT_SchdB")>
                                                           </div>
                                                          </div>
				...
				onfocus=SetFocus() maxLength=10 onchange=ValidateWorksheet("BPT_SchdB")></label>
                                            ...
                                            <tr class="odd">
                                            	<td widh="5%">12.</td>
                                                <td widh="70%" class="text-left">TAX DUE (Multiply Line 11 by 0.0645) If Line 11 is a loss, enter zero</td>
                                                <td widh="25%" class="text-left">
                                               		<form class="form-horizontal">
