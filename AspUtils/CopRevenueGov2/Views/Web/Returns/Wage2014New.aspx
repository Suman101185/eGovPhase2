...
<head>
    ...
    function DisplayWage08Return() {
        ...
        $('#AppHeader').html(txtHeader + '<Font class=hdrMedium>|wage tax reconciliation return for 2014</Font>');
        parent.gsInstructionItem = '#WageReturn';
        $('#AppMessage').html(parent.gsInstructionText + '<BR>The Reconciliation of Wage Tax for 2014 is due February 28, 2011.');
    ...
    <div class="container-fluid no-padding" id="WageReturn_08">
        ...
        <div class="block3">
            ...
            <div class="container-fluid">
				...
				wage tax was remitted for the pay period including March 12, 2014. </td>
                                                                            <td width="25%">
                                                                                <form class="form-horizontal">
                                                                                    <div class="form-group no-margin">
                                                                                        <div class="">
                                                                                            <input type="text" id="txtWageNoA_08" class="form-control input-sm" onchange="ValidateWage08Number()" onfocus="ReadOnlySetFocus()" maxlength="10" style="width: 100%" />
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                            </td>
      ...
      <u>non-residents</u>      of 
				Philadelphia (7/1/2014 to 12/31/2014)</td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="text-left"><span><strong>13.</strong></span>&nbsp;Tax previously paid for 2014 -
