                    ...
                    <div class="school_form">
                        ...
                        <div class="school_page_form">
                            ...
                            <div class="form_segment">
                                ...
                                <table summary="Employee Pay Sheet" class="hor-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td width="70%"><b>1. Maximum Tax for Period</td>
                                            <td align="center" class="no_border_right">
                                                <label  id="lblUO1_1" style="width: 100%">
                        </label>
                                               </td>
                                        </tr>
                                        <tr>
                            ...
                            maxlength="10" style="width: 100%" /></td>
                                        ...
                                        <tr class="odd">
                                            <td width="70%">5.  Keystone Opportunity Zone (KOZ) Amount</td>
                                            <td align="center" class="no_border_right">
                                              <input class="inpNormal" id="txtUO1_5" onchange="ValidateUOReturn()" onfocus="SetFocus()"
                            maxlength="10" style="width: 100%" /></td>
                                        </tr>
                                        <tr>
                                            <td>6.   <b>Total of Lines 2, 3, 4, 5 </b></td>
                                            <td align="center" class="no_border_right">
                                                <label class="label_NoLeft" id="lblUO1_6" style="width: 100%">
                        </label>
                                               </td>
                                        </tr>
                                        <tr class="odd">
                                            <td width="70%">7.  Tax Due [Calculated - Line 1 minus Line 6]</td>
                                            <td align="center" class="no_border_right">
                                                <label class="label_NoLeft" id="lblUO1_7" style="width: 100%">
                        </label></td>
                                        </tr>
                                        <tr>
                                            <td>8.  $2,000.00 Annual Exemption ($167 per month or $500 per quarter)</td>
                                            <td align="center" class="no_border_right">
                                                <label class="label_NoLeft" id="lblUO1_8" style="width: 100%">
                        </label></td>
                                        </tr>
                                        <tr class="odd">
                                            <td width="70%">9.  Delinquent Tenant Amount <label class="lblLink label_NoLeft"  onclick="ShowPage(2)">
                            (Click here to complete UO3)</label></td>
                                            <td align="center" class="no_border_right">
                                                <input class="label_NoLeft" id="txtUO1_9" onchange="ValidateUOReturn()" onfocus="SetFocus()"
                            maxlength="10" style="width: 100%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>10.   Amount due prior to discount.  [Calculated - Add Lines 8 and 9 then subtract the sum from Line 7]</td>
                                            <td align="center" class="no_border_right">
                                               <label class="label_NoLeft" id="lblUO1_10" style="width: 100%">
                        </label></td>
                                        </tr>
                                        <tr class="odd">
                                            <td width="70%">11.  Discount for Landlords <u>ONLY</u>[Calculated - Line 10 multiply by 1%]</td>
                                            <td align="center" class="no_border_right">
                                                <input class=inpNormal id="txtUO1_11" onchange="ValidateUOReturn()" onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%" />
                                            </td>
                                        </tr>
                                        <tr >
                                            <td width="70%"> 12.  <b>Net tax Due</b>  [Calculated - line 10 minus 11]</td>
                                            <td align="center" class="no_border_right">
                                              <label class="label_NoLeft" id="lblUO1_12" style="width: 100%">
                        </label>
                                            </td>
                                        </tr>
                                        <tr class="odd">
                                            <td>13.  Interest & Penalty(See Instructions)</td>
                                            <td align="center" class="no_border_right">
                                               <input class="inpNormal" id="txtUO1_13" onchange="ValidateUOReturn()" onfocus="SetFocus()"
                            maxlength="10" style="width: 100%"></td>
                                        </tr>
                                        <tr >
                                            <td width="70%">14.  <b>Total Due</b>  [Calculated - line 12 plus 13]</td>
                                            <td align="center" class="no_border_right">
                                               <label class="label_NoLeft" id="lblUO1_14" style="width: 100%">
                        </label>
                                            </td>
                                        </tr>
            ...
            <div id="divUO3Grid" style="display: block; margin-left: 4%">
                ...
                <input type="button" id="btnSelectPg" value="Return to Selection Page" onclick="parent.DocWin.location.href = 'UOList'" />
                    ...
                    <div <%--style="display: none"--%> id="divUO3_pg2">
                        ...
                        <div class="taxpyer_address" id="tblUO3">
              ...
              <div class="form_segment">
                        ...
                        <div class="here_input">
                             ...
                             <input class="bottom_margin" id="txtUO3_TenantName" maxlength="60" size="70" onchange="ValidateUO3Return()" />
                            <div class="clear"></div>
                        </div>
			  ...
			  <div class="form_segment">
                        ...
                        <label>EIN/Social Security Number:* </label>
                        
                        <div class="here_input">
                         
                            <input class='bottom_margin' id="txtUO3_EinSsn" size="20" onchange="ValidateUO3Return()"
                                        maxlength="9" />
                            <div class="clear"></div>
                        </div>
              ...
              <div class="form_segment">
                        ...
                        <label>Amount of Unpaid Tax:* </label>
                     ...
                     <div class="form_segment here_input_table divspaced_holder" align="right">
                	<input type="button" value="Add" id="btnUO3_Add" onclick="UO3UpdateTenantList()" class="submit_button_light" /> <input type="button" value="Cancel" class="submit_button" id="btnUO3_Cancel" onclick="UO3ClearTenantFrame()" />
                    <div class="clear"></div>
                    </div>   
             <label id="lblMoreThen10" class="" style="display: block; color: Red">
                            NOTE: If you are reporting more then 10 delinquent tenants you must file a paper
                            return.</label>
<table summary="Employee Pay Sheet hor-zebra" id="tblUO3TenantGrid">
    <tbody class="additonal_padding border_top  ">
    	<tr>
        <td width="20%" align="center" scope="col"><b>Tenant Name </b></td>
            ...
            <td width="20%" align="center" class="no_border_right" scope="col">&nbsp;</td>
        </tr>
    </tbody>
                         ...
                         <div class="form_segment here_input_table divspaced_holder" align="right">
                	<input type="button" id="btnUO1Pg1" value="Return to page 1" class="submit_button_light" onclick="ShowPage(1)" /> 
                    <input type="button" id="btnSelectPg" value="Return to Selection Page" class="submit_button" onclick="parent.DocWin.location.href = 'UOList.asp'" />
                    <div class="clear"></div>
                </div>    
