...
void CallRttie035New()
{
    xmlOut = RTTIE035New.CallService(xmlReqDoc);
...
rev_func_srv.CreateXmlBufferObj(xmlOut, util.GetXMLString(Server.MapPath(@"~/views/web/xml/UOFormNew.xml")), false);
