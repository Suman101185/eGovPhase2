...
<script id="clientEventHandlersJS" language="javascript">
    ...
    function DisplayWage08Return() {
        ...
        $('#AppMessage').html(parent.gsInstructionText + '<BR>The Reconciliation of Wage Tax for 2013 is due February 28, 2011.');
    ...
    <div class="container-fluid no-padding" id="WageReturn_08">
        ...
        <div class="block3">
            ...
            <div class="container-fluid">
                                                    ...
                                                    <form>
                                                        <div class="col-lg-4">
                                                            <p>
                                                                ...
                                                                <label id="lblAcctId_08" class="lblTextBlack"></label>
                                                            </p>
                                                        </div>

                                                        <div class="col-lg-4">
                                                            <p>
                                                                <strong><font id=lblEntityType_08>EIN :</font></strong>
				...
				wage tax was remitted for the pay period including March 12, 2013. </td>
                                                                    <td width="25%">
      ...
      <U>non-residents</U>      of 
				Philadelphia (7/1/2013 to 12/31/2013)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%">
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>13.</strong></span>&nbsp;Tax previously paid for 2013 - <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
