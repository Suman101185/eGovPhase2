   ...
   <script id="clientEventHandlersJS" language="javascript" type="text/javascript">
    ...
    function DisplaySchool08Return() {
        ...
        if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('29')")) {
            ...
            // parent.MenuWin.ispHighlightMenu(parent.MenuWin.mnuSchoolYear10)
    ...
    <body>
<%--<body onload="ispDisplayProgress('DisplaySchool08Return()', 'Retrieving 2010 school tax information')">--%>
                        ...
                        <div class="clear"></div>
                            ...
                            <div class="form_segment">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabularform">
                                  ...
                                  <%--  <tr>
                                        <th width="53%" scope="col" align="right">If you were a  partial year resident in 2010, enter dates of residency :  </th>
                                        <th width="13%" scope="col" align="right" class="here_input_table"><span style="position: relative; top: 8px !important;">From:</span> &nbsp;
                                          <input class=input_size1 id=txtFromDate_08 onchange="ValidateSchool08Return()" maxlength=10 
			 onfocus="SetFocus()" onblur="return txtFromDate_08_onblur()" style  ="WIDTH: 68px; HEIGHT: 22px" size=9></th>
                                        <th width="9%" scope="col" align="left" class="here_input_table"><span style="position: relative; top: 8px !important;">To:</span>
                                          <input class=input_size1 width="50%" id=txtToDate_08 onchange="ValidateSchool08Return()" 
			onfocus="SetFocus()" maxlength=10 onblur="return txtToDate_08_onblur()" 
      style="WIDTH: 68px; HEIGHT: 22px" size=9></th>
                                    </tr>--%>

                                     <tr>
                                      <td width="50%" scope="col" align="left">
                                          If you were a  partial year resident in 2010, enter dates of residency :  </td>
