    ...
    function CalcPage1Line9_10() {
        ...
        if (cCur($('#lblBPTez1_9').text()) < 0) {
            ...
            if (totalBPTez1_10Amount != Math.abs(cCur($('#lblBPTez1_7').text()))) {
                $(parent.AppError).text("Lines 10a, 10b && 10c must equal Line 7.");
            }
    ...
    <div class="tab_Tcontainer" id="">
        <div class="tab_container" id="BPTez" style="DISPLAY: none;">
            <div style="display: block;" id="tab1" class="tab_content">
                            ...
                            <div class="form_segment">
                                ...
                                <table summary="Employee Pay Sheet" class="hor-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td width="70%">3.  Tax Due for the 2010 Business Income & Receipts Tax [Calculated - add lines 1 and 2] </td>
                                            <td align="center" class="no_border_right">
                                              <label id=lblBPTez1_3 style="WIDTH: 100%"></label></td>
                                        </tr>
                                        <tr>
                                            <td>4.  <B><U>MANDATORY</U> 2011 BIRT Estimated Payment <u>(repeat line 3)</u></B></td>
                                            <td align="center" class="no_border_right">
                                               	<input class="" id=txtBPTez1_4 onchange="ValidateBPTezReturn()"
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        </tr>
                                        <tr class="odd">
                                            <td width="70%">5.  Total Due by <B>4/15/2011</B>[Calculated - add lines 3 and 4] </td>
                                            <td align="center" class="no_border_right">
                                        ...
                                        <tr class="odd">
                                            <td width="70%">6a.  Credit from overpayment of 2009 or 2010 Net Profit Tax </td>
                                            <td align="center" class="no_border_right">
                                              <input class="" id=txtBPTez1_6a onchange="ValidateBPTezReturn()"
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        </tr>
                                        <tr>
                                            <td>6b.  Include any estimated and/or extension payments of 2010 BIRT previously
			 ...
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
					...
					onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
                                        ...
                                        <tr class="odd">
                                            <td>10b. Applied, up to the tax due,	to the 2010 Net Profits Tax Return<</td>
                                            <td align="center" class="no_border_right">
					...
					onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
                                        ...
                                        <tr>
                                            <td width="70%">10c. Applied to the 2011	Business Income & Receipts Tax </td>
                                            <td align="center" class="no_border_right">
			...
			onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        ...
                                        <tr class="odd">
                                            <td width="70%"><INPUT type="radio" id=radBPTez2_1_2_m1 name=radBPTez2_1_2 onclick="ValidateBPTezMethod()">
			2.  METHOD I. Net Income (or loss) in accordance with Accounting
					System</td>
                                            <td align="center" class="no_border_right">
