    ...
    <script id="clientEventHandlersJS" language="javascript" type="text/javascript">
        ...
        function DisplaySchool08Return() {
            ...
            if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('29')")) {
                ...
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlSchool, '12/31/2010', 'SCHOOL_INFO PERIOD', '', 0)
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'ERROR_INFO ERROR', "", 0) != 0) {
                    ...
                    $('#AppHeader').html(txtHeader + '<Font class=hdrMedium>|school income tax return for 2010</Font>');
            ...
            $('#AppMessage').html(parent.gsInstructionText + '<BR>The School Income Tax for 2010 is due April 15, 2011.');
        ...
        function CheckSchool08XML() {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'SCHOOL_INFO PERIOD', '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'SCHOOL_INFO PERIOD', '', 0)) < new Date('01/01/2010')) {
                bPeriodExist = false
            } //if
        ...
        function txtFromDate_08_onblur() {
            ...
            if ($(parent.AppError).innerText == "" && txtFromDate_08.value != "") {
                ...
                if (strBD == false) {
                    ...
                    txtFromDate_08.className = 'inpError inpNormal_custom'
                    blnErr = true
                } else {
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo1_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo2_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo3_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo4_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo5_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo6_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo7_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo8_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <label id="lblSchoolNo9_08" style="width: 100%" class="form-control input-sm"label>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo10_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
				...
				previously paid with an extension coupon</td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo13_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo15a_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>15B.</strong></span> &nbsp; <strong><u>Applied</u></strong> to the 2010 School Income Tax &nbsp;</td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" id="txtSchoolNo15b_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" class="form-control input-sm" maxlength="10" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
