...
<script id="clientEventHandlersJS" language="javascript">
    ...
    function DisplayWage08Return() {
        if (parent.$x.ispXmlSetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT[ACCOUNT = "1"]', '', 0)) {
            parent.MenuWin.ispHighlightMenu(parent.MenuWin.mnuWageYear10);
        ...
        $('#AppMessage').html(parent.MenuWin.gsInstructionText + '<BR>The Reconciliation of Wage Tax for 2010 is due February 28, 2011.');
...
<table class=tblShowBorder cellSpacing=0 cellPadding=0 border=0 style="MARGIN-LEFT: 4%" id=TABLE2 width="90%">
  ...
  <tr class=rowDataEven>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Enter the number of Philadelphia Residents for whom 
				wage tax was remitted for the pay period including March 12, 2010.</label></td>
		<td colspan=3>
  ...
  <tr class=rowDataEven>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Total number of employees <strong>for all company locations</strong> 
				...
				quarter of 2012 (for the pay period including March 12, 2010).</label></td>
		<td colspan=3>
  ...
  <tr class=rowDataOdd>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Number of employees working <strong>at company locations within
				Philadelphia city limits</strong>, for the pay period including March 12, 2010.</label></td>
		<td colspan=3>
  ...
  <tr class=rowDataOdd>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (1/1/2010 to 06/30/2010)</label></td>
		<td colspan=3>
  ...
  <tr class=rowDataOdd>
		...
		<td colspan=16>
			<label class="lblInstrNormal">Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (7/1/2010 to 12/31/2010)</label></td>
		<td colspan=3>
  ...
  <tr class=rowDataEven>
		...
		<td colspan=16>
			<label class="lblInstrNormal" onclick=PreviousPaid() style="CURSOR: hand">
				Tax 
      previously paid for 2010 - <label style="FONT-WEIGHT: normal; COLOR: red">
