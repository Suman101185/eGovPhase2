...
<script id="clientEventHandlersJS" language="javascript" type="text/javascript">
    ...
    function DisplayWage05Return() {
        if (parent.$x.ispXmlSetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT[ACCOUNT = "1"]', '', 0)) {
            ...
            //the value of the  WAGE_INFO ACCOUNT_ID of the wageXml was set to the value of the ENTITY_INFO ACCOUNT_ID of the xmlAccount, which returned incorrect response from the service as the Account ID was different from the  
            //Entity ID. To get correct response the value of the  WAGE_INFO ACCOUNT_ID of the wageXml was set to the ENTITY_INFO ENTITY_ID of the xmlAccount 
            //parent.$x.ispXmlSetFieldVal(parent.$g.xmlWage, parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ENTITY_INFO ACCOUNT_ID', "", 0), 'WAGE_INFO ACCOUNT_ID', '', 0);
        ...
        $('#AppHeader').html(txtHeader + '<Font class=hdrMedium>|wage tax reconciliation return for 2012</Font>');
        parent.gsInstructionItem = '#WageReturn';
        $('#AppMessage').html(parent.gsInstructionText + '<BR>The Reconciliation of Wage Tax for 2012 is due February 28, 2013.');
    ...
    function ValidateWage05Number() {
        ...
        if ($(parent.AppError).text() != '') {
           // $(parent.AppError).scrollIntoView(true);//sangha
        } else {
...
<%--<body onload="ispDisplayProgress('DisplayWage05Return()','Retrieving 2012 wage tax information')">--%>
    <div class="tab_Tcontainer" id="WageReturn">
        <div class="tab_container">
			...
			<label class="" style="color: Red;width:100%" >All decimals will be rounded to the nearest whole number</label></th>
				...
				wage tax was remitted for the pay period including March 12, 2012. </b></td>
				...
				Philadelphia in 2012</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%"></td>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td align="center" class="no_border_right" style="text-align:right;">
				...
				Philadelphia in 2012</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%"></td>
                                        ...
                                        <tr class="odd">
                                            <td>9.  Tax previously paid for 2012 - <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
    ...
    ispDisplayProgress('btnWage05Submit_onclick()', 'Submitting 2012 wage tax information')" />
                            </div>
