...
<body onload="ispDisplayProgress('DisplaySchool08Return()', 'Retrieving 2012 school tax information')">
    <div style="DISPLAY: none; VISIBILTY: visible" id="SchoolReturn_08" name="SchoolReturn_08">
        ...
        <table class="tblShowBorder" width="90%" bgcolor="whitesmoke" style="MARGIN-LEFT: 4%" border="0"
            ...
            <tr>
                ...
                <td colspan="5">
                    <label id="lblName_08" class="lblTextBlack" nowrap></label>
                </td>
	...
	<td align="right" colspan="7" nowrap>
        ...
        <input class="inpNormal" id="txtFromDate_08" onchange="ValidateSchool08Return()" maxlength="10"
            onfocus="SetFocus()" onblur="return txtFromDate_08_onblur()"
        ...
        <table class="tblShowBorder" cellspacing="0" cellpadding="0" border="0" style="MARGIN-LEFT: 4%" id="TABLE2" width="90%">
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">Net Short Term Capital Gains (<strong><u>Held 6 months or less</u></strong>) (if loss, enter "0")</label>
                </td>
                <td colspan="3">
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">Net Rental Income (If loss, enter "0")</label>
                </td>
                <td colspan="3">
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">Other Taxable Income</label>
                </td>
                <td colspan="3">
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblSchoolNo9_08" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataOdd">
                <td>
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblSchoolNo11_08" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataOdd">
                <td>
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblSchoolNo12_08" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataEven">
                <td>
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">
                        Credit from overpayment of prior year or tax 
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblSchoolNo14_08" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataEven">
                <td>
     ...
     > -->
      ...
      Petition</strong>. <strong>OR</strong>
                    </label>
                </td>
                <td colspan="3">
