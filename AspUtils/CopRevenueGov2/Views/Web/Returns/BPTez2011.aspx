...
//suman set last parameter true will cause xml copy to browser clipboard
	...
	if (parent.MenuWin.GetInnerNodeText(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', 'START_DATE', '24').slice(-4) == '2012') {
...
<body onload="ispDisplayProgress('DisplayBPTezReturn()', 'Retrieving 2011 business privilege tax information')">
