...
<script id="clientEventHandlersJS" language="javascript" type="text/javascript">
    ...
    function PopulateBPTezData() {
        ...
        $('#txtBPTez2_9').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez, 'BPT_PG2 STAT_EXCLUSION_EZ_X', '', 0), 0));
    ...
    function PopulateBPTezXML() {
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTez, stripCurrency($('#txtBPTez2_9').val()), 'BPT_PG2 STAT_EXCLUSION_EZ_X', '', 0);
        ...
        <div class="col-lg-12 col-md-12" id="BPTez" style="DISPLAY: none;">
            <div style="display: block;" id="tab1" class="blue_base_box">
                        ...
                        <div class="col-lg-12">
                         <%-- Address Start--%>
                          ...
                          <%--  checkbox--%>                  
                           ...
                           <%-- checkbox end--%>
                            <div  Id="BPTez_pg1" Name="BPTez_pg1">
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-left"><span><strong>3.</strong></span> &nbsp; Tax Due for the 2014 Business Income & Receipts Tax [Calculated - add lines 1 and 2] </td>
                                            <td  width="25%">
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="text-left"><span><strong>4.</strong></span> &nbsp; <B><U>MANDATORY</U> 2015 BIRT Estimated Payment <u>(repeat line 3)</u></B></td>
                                            <td width="25%">                                               
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="text-left"><span><strong>5.</strong></span> &nbsp; Total Due by <B>4/15/2015</B>[Calculated - add lines 3 and 4] </td>
                                            <td width="25%">                                             
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="text-left"><span><strong>6a.</strong></span> &nbsp; Credit from overpayment of 2013 or 2014 Net Profit Tax </td>
                                            <td width="25%">                                             
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="text-left"><span><strong>6b.</strong></span> &nbsp; Include any estimated and/or extension payments of 2014 BIRT previously
			  made,<br>and any credit from overpayment of the 2013 BPT return</td>
                                        ...
                                        <tr>
                                            <td class="text-left"><span><strong>6c.</strong></span> &nbsp; Total Payments and Credits [Calculated - add lines 6a and 6b] </td>
                                            <td width="25%">                                            
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="text-left"><span><strong>8.</strong></span> &nbsp; Interest and Penalty (see instruction Sheet II)</td>
                                            <td width="25%">                                            
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr >
                                            <td class="text-left"><span><strong>9.</strong></span> &nbsp;<u><b>TOTAL DUE</b></u> including Interest and Penalty<br>
					<b>Use payment coupon. Make check payable to: "City of Philadelphia"[Calculated - add line 7 and 8]</td>
                                        ...
                                        <tr >
                                            <td class="text-left"><span><strong>10a.</strong></span> &nbsp; Refunded. <b>Do not file separate Refund Petition</b></td>
                                            <td width="25%">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="text-left"><span><strong>10b.</strong></span> &nbsp; Applied, up to the tax due,	to the 2014 Net Profits Tax Return<</td>
                                            <td width="25%">                                               
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                            <td class="text-left"><span><strong>10c.</strong></span> &nbsp; Applied to the 2015	Business Income & Receipts Tax </td>
                                            <td width="25%">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            <td class="text-left"><span><strong>6.</strong></span> &nbsp; TAX DUE <label class="" id=msgBPTez2_5 style="width:100%">[Calculated - line 5 * ###]&nbsp;</label></td>
                                            <td width="25%">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr >
                                            ...
                                            <td width="25%">                                            
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                      <input class="form-control input-sm" id=txtBPTez2_7a onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength=10 >
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%">                                               
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                      <input class="form-control input-sm" id=txtBPTez2_7b onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength=10 >
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                        ...
                                        <tr >
                                            ...
                                            <td width="25%">                                            
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                      <input class="form-control input-sm" id=txtBPTez2_7c onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength=10 >
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                         ...
                                         <tr >
                                            ...
                                            <td width="25%">                                              	
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                      <input class="form-control input-sm" id=txtBPTez2_7d onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength=10 >
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                        ...
                                        <tr >
                                            ...
                                            <td width="25%">                                           
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                      <input class="form-control input-sm" id=txtBPTez2_7e onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength=10 >
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                        ...
                                        <tr >
                                            ...
                                            <td width="25%">                                          	
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                      <input class="form-control input-sm" id=txtBPTez2_7f onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength=10 >
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                           ...
                                           <tr >
                                            ...
                                            <td width="25%">                                           
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                      <input class="form-control input-sm" id=txtBPTez2_7g onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength=10 >
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%">                                            	
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                     <input class="form-control input-sm" id=txtBPTez2_7h onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength=10 >
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                        ...
                                        <tr >
                                            ...
                                            <td width="25%">                                            
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                     <input class="form-control input-sm" id=txtBPTez2_7i onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength=10 >
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                         ...
                                         <tr>
                                            <td class="text-left"><span><strong>8.</strong></span> &nbsp; TOTAL TAXABLE GROSS RECEIPTS[Calculated - add lines 7a through 7i]</td>
                                            <td width="25%">                                             
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                         ...
                                         <tr >
                                            <td class="text-left"><span><strong>9.</strong></span> &nbsp; Statutory Exclusion (Lower of Line 8 or $50,000.00)</td>
                                            <td width="25%">                                
                                                
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                      <input class="form-control input-sm" id=txtBPTez2_9 onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength=10 >
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                        ...
                                        <tr >
                                            <td class="text-left"><span><strong>11.</strong></span> &nbsp; TAX DUE<label class="" style="width:100%" id=msgBPTez2_8>[Calculated - line 10 * ###]&nbsp;</label></td>
                                            <td width="25%">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
