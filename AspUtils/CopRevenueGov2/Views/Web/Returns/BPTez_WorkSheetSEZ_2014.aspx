    ...
    <script>
        ...
        function CalcWorkSheetSLine5() {
            if ($('#txt_BPT_WSEZ1').val() != '' && $('#txt_BPT_WSEZ4').val() != '') {
                ...
                var totamount = cCur($('#lbl_BPT_WSEZ4').text()) + '.' + $('#txt_BPT_WSEZ4').val();
   ...
   <div class="form-group" id="BPTez_WrkShtNE" style="DISPLAY: none;">
    ...
    <tbody>
        ...
        <tr>            
            ...
            <tr>               
            <td width="70%" class="text-left"><span><strong>S1.</strong></span> &nbsp;Enter the lower of <label id="Label2" class="lblLink label_NoLeft"  onclick=ShowPage(2) > Line 8 of Page 2 </label> or $50,000 </td>
        ...
        <tr  class="odd">
            <td width="70%" class="text-left"><span><strong>S2.</strong></span> &nbsp; Net Taxable Receipts (from Line 1 or Line 2 of <label id="Label1" class="lblLink label_NoLeft"  onclick=ShowPage(2)> Page 2 </label>)</td>
            <td colspan="2" align="center" width="25%">               
                <div class="form-horizontal">
                    <div class="form-group no-margin">
                        <div class="">
        ...
        <tr >
            <td class="text-left"><span><strong>S3.</strong></span> &nbsp; Taxable Gross Receipts (from Line 8 of <label id="lblLnksD" class="lblLink label_NoLeft"  onclick=ShowPage(2)>  Page 2 </label>)</td>
            <td colspan="2" align="center" width="25%">               
                <div class="form-horizontal">
                    <div class="form-group no-margin">
                        <div class="">
        ...
        <tr class="odd">
            <td class="text-left"><span><strong>S4.</strong></span> &nbsp; Divide Line S2 by Line S3 and enter percentage as a decimal (two places)</td>
            <td style="width:80%"  align="right" >                  
                 <div class="form-horizontal">
                    <div class="form-group no-margin">
                        <div class="">
                             <label class="" id="lbl_BPT_WSEZ4" /> .
                        </div>
                   </div>
                </div>
            </td>
        ...
        <tr >
            <td class="text-left"><span><strong>S5.</strong></span> &nbsp; Statutory Net Income Deduction (Line S1 times Line S4)</td>
