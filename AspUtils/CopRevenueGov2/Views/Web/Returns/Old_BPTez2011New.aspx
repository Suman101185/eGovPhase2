            ...
            <div style="display: block;" id="tab1" class="tab_content">
                            ...
                            <div class="form_segment">
                                ...
                                <table summary="Employee Pay Sheet" class="hor-zebra">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td width="70%">3.  Tax Due for the 2011 Business Income & Receipts Tax [Calculated - add lines 1 and 2] </td>
                                            <td align="center" class="no_border_right">
                                              <label id=lblBPTez1_3 style="WIDTH: 100%"></label></td>
                                        </tr>
                                        <tr>
                                            <td>4.  <B><U>MANDATORY</U> 2012 BIRT Estimated Payment <u>(repeat line 3)</u></B></td>
                                            <td align="center" class="no_border_right">
                                               	<input class="" id=txtBPTez1_4 onchange="ValidateBPTezReturn()"
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        </tr>
                                        <tr class="odd">
                                            <td width="70%">5.  Total Due by <B>4/17/2012</B>[Calculated - add lines 3 and 4] </td>
                                            <td align="center" class="no_border_right">
                                        ...
                                        <tr class="odd">
                                            <td width="70%">6a.  Credit from overpayment of 2010 or 2011 Net Profit Tax </td>
                                            <td align="center" class="no_border_right">
			 ...
			 onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
					...
					onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
                                        ...
                                        <tr class="odd">
                                            <td>10b. Applied, up to the tax due,	to the 2011 Net Profits Tax Return<</td>
                                            <td align="center" class="no_border_right">
					...
					onfocus="SetFocus()" maxlength=10 style="WIDTH: 100%">
                                        ...
                                        <tr>
                                            <td width="70%">10c. Applied to the 2012	Business Income & Receipts Tax </td>
                                            <td align="center" class="no_border_right">
