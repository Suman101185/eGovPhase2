       ...
       var gUserAddr = '<%Response.Write(Request.ServerVariables["REMOTE_ADDR"]);%>'
        ...
        function DisplaySchool08Return() {
            ...
            if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('29')")) {
                ...
                // parent.MenuWin.ispHighlightMenu(parent.MenuWin.mnuSchoolYear12)//Sangha
                        ...
                        <div class="clear"></div>
                            ...
                            <div class="form_segment">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabularform">
                                   ...
                                   <%-- <tr>
                                        <th width="53%" scope="col" align="right">If you were a  partial year resident in 2012, enter dates of residency :  </th>
      ...
      style="WIDTH: 68px; HEIGHT: 22px" size=9></th>
                                     ...
                                     <tr>
                                      <td width="50%" scope="col" align="left">
                                          If you were a  partial year resident in 2012, enter dates of residency :  </td>
