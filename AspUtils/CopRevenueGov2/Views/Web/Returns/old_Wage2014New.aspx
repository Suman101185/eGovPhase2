...
<script id="clientEventHandlersJS" language="javascript">
    ...
    function DisplayWage08Return() {
        ...
        if (parent.$x.ispXmlSetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT[ACCOUNT = "1"]', '', 0)) {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlWage, '12/31/2014', 'WAGE_INFO PERIOD', '', 0); //binoy
        ...
        $('#AppHeader').html(txtHeader + '<Font class=hdrMedium>|wage tax reconciliation return for 2014</Font>');  //binoy
        parent.gsInstructionItem = '#WageReturn';
        $('#AppMessage').html(parent.gsInstructionText + '<BR>The Reconciliation of Wage Tax for 2014 is due February 28, 2015.'); //binoy
    ...
    function CheckWage08XML() {
        ...
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'WAGE_INFO PERIOD', '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'WAGE_INFO PERIOD', '', 0)) < new Date('01/01/2014')) { //binoy
            bPeriodExist = false
        }
...
<body>
    <div class="tab_Tcontainer" id="WageReturn_08">
        <div class="tab_container">
                    ...
                    <div class="school_form">
                        ...
                        <div class="school_page_form">
                            ...
                            <div class="account_greybox">
                                 <p><strong>Account Id:</strong> <label id=lblAcctId_08 class="lblTextBlack" ></label> </p>

                                <p><strong><font id=lblEntityType_08>EIN :</font></strong> <label id=lblEntityId_08 class="lblTextBlack"></label> </p>
                                 <div class="clear"></div>
			...
			<label class="" style="color: Red;width:100%" >All decimals will be rounded to the nearest whole number</label></th>
				...
				wage tax was remitted for the pay period including March 12, 2014. </b></td>  <%--binoy--%>
                                            <td align="center" class="no_border_right">
                                                 <input type="text" id="txtWageNoA_08" onchange="ValidateWage08Number()" onfocus="ReadOnlySetFocus()" maxlength="10" style="WIDTH: 100%"  />
                                               </td>
                                        </tr>
                                        <tr>
				...
				including March 12, 2014.</td>  <%--binoy--%>
                                            <td align="center" class="no_border_right">
                                                <input class="" id=txtWageNoB_08 onchange="ValidateWage08Number()"
				...
				quarter of 2013 (for the pay period including March 12, 2014). </td> <%--binoy--%>
                                            <td align="center" class="no_border_right">
                                               <input class="" id=txtWageNoC_08 onchange="ValidateWage08Number()" 
				onfocus="ReadOnlySetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        </tr>
                                        <tr>
                                            <td>D. Number of employees working <strong>at company locations within
				Philadelphia city limits</strong>, for the pay period including March 12, 2014.</td>  <%--binoy--%>
                                            <td align="center" class="no_border_right">
                                               <input class="" id=txtWageNoD_08 onchange="ValidateWage08Number()"
				 onfocus="ReadOnlySetFocus()" maxlength=10 style="WIDTH: 100%"></td>
                                        </tr>
                                        <tr class="odd">
                                            <td width="70%"><label class="" style="width:100%">1.  Gross Compensation per W-2 forms for all employees</label></td>
                                            <td align="center" class="no_border_right">
                                               <input class="" id=txtWageNo1_08 onchange="ValidateWage08Prelim()" 
				...
				(Paid to non-residents working outside of Philadelphia)</td>
                                            <td align="center" class="no_border_right">
                                                <input class="" id=txtWageNo2_08 onchange="ValidateWage08Prelim()"
				...
				which Philadelphia Wage Tax was withheld or due[Calculated - line 1 less line 2] </td>
                                            <td align="center" class="no_border_right">
                                               <label id=lblWageNo3_08 style="WIDTH: 100%"></label></td>
                                        </tr>
                                        <tr>
                                            <td>4.  Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (1/1/2014 to 06/30/2014)</td>  <%--binoy--%>
                                            <td align="center" class="no_border_right">
                                                <input class="" id=txtWageNo4_08 onchange="ValidateWage08Prelim()"
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%"></td>
                                        </tr>
                                        <tr class="odd">
                                            <td >5.  Tax Due [Calculated - line 4 X .039280]</td>
                                            <td align="center" class="no_border_right">
                                              <label id=lblWageNo5_08 style="WIDTH: 100%"></label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>6.  Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (7/1/2014 to 12/31/2014)</td> <%--binoy--%>
                                            <td align="center" class="no_border_right">
                                                <input class="" id=txtWageNo6_08 onchange="ValidateWage08Prelim()"
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%"></td>
                                        </tr>
                                        <tr class="odd">
                                            <td width="70%">7. Tax Due[Calculated - line 6 X .039240]</td>
                                            <td align="center" class="no_border_right">
                                               
                                            </td>
                                        </tr>
                                        <tr >
                                            <td width="70%">8.  Taxable Gross Compensation paid to 
      <U>non-residents</U>      of 
				Philadelphia (1/1/2014 to 06/30/2014)</td> <%--binoy--%>
                                            <td align="center" class="no_border_right">
                                               <input class="" id=txtWageNo8_08 onchange="ValidateWage08Prelim()"
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%">
                                            </td>
                                        </tr>
                                        <tr class="odd">
                                            <td>9.  Tax Due[Calculated - line&nbsp;8 X .034985]</td>
                                            <td align="center" class="no_border_right">
                                               <label id=lblWageNo9_08 style="WIDTH: 100%"></label></td>
                                        </tr>
                                        <tr >
                                            <td width="70%">10.  Taxable Gross Compensation paid to 
      <U>non-residents</U>      of 
				Philadelphia (7/1/2014 to 12/31/2014)</td> <%--binoy--%>
                                            <td align="center" class="no_border_right">
                                               	<input class="" id=txtWageNo10_08 onchange="ValidateWage08Prelim()"
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%">
                                            </td>
                                        </tr>
                                        <tr class="odd">
                                            <td><label class="" id=msgTobaccoNo3d style="WIDTH: 100%">11. Tax Due[Calculated - line 10 X .034950]</label></td>
                                            <td align="center" class="no_border_right">
                                               <label  id=lblWageNo11_08 style="WIDTH: 100%"></label> </td>
                                        </tr>
                                        <tr>
                                            <td width="70%">12. Total Tax Due[Calculated - lines 5, 7, 9 and 11]</td>
                                            <td align="center" class="no_border_right">
                                               <label id=lblWageNo12_08 style="WIDTH: 100%"></label></td>
                                        </tr>
                                        <tr class="odd">
                                            <td>13. Tax previously paid for 2014 - <font  style="width:100%;color:red">
						This amount may not yet include	your most recent payment.
						Click on link for more information.</font></td>
                                            <td align="center" class="no_border_right">
                                               <label id=lblWageNo13_08 style="WIDTH: 100%"></label></td>
                                        </tr>

                                         <tr >
                                            <td>14. ADDITIONAL TAX DUE If line 12 is greater than line 13,
				enter the amount here.</td>
                                            <td align="center" class="no_border_right">
                                            <label id=lblWageNo14_08 style="WIDTH: 100%"></label></td>
                                        </tr>

                                         <tr class="odd">
                                            <td>15. TAX OVERPAID If line 12 is less than line 13,
				enter the amount here. See instructions for filing a Refund Petition.</td>
                                            <td align="center" class="no_border_right">
                                                <label id=lblWageNo15_08 style="WIDTH: 100%"></label></td>
                                        </tr>
            ...
            %></div>
                             <div class="form_segment here_input_table" align="right">
                                <input id="btnWage08Print" type="button" value="Print" class="submit_button_light" onclick="btnWage08Print_onclick()" />
                                <input type="button" value="Submit" class="submit_button" id="btnWage08Submit" onclick="btnWageValidate(); ispDisplayProgress('btnWage08Submit_onclick()',
					'Submitting 2013 wage tax information')" />
                            </div>
