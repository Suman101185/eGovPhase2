...
<head>
   ...
   <script type="text/javascript" id="clientEventHandlersJS" language="javascript">
       ...
       function DisplayTobaccoReturn() {   
           ...
           if (parent.GetNodeCount(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '27') == 1) {        
               ...
               if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'ERROR_INFO ERROR', "", 0) != 0) {
                   ...
                   $('AppHeader').html(txtHeader + '<Font class=hdrMedium>|tobacco tax return for 2015</Font>');
              ...
              // parent.ispMenu_onclick(parent.mnuAcctInfo); // Manoranjan
               //alert(parent.mnuAcctInfo);
           } //if
           $(parent.RightFrame).attr("rows", "*,0");
           $('#TobaccoReturn').css("display", "block");
           $('#AppHeader').html(txtHeader + '<Font class=hdrMedium>|tobacco tax return for 2015</Font>');
           parent.gsInstructionItem = '#TobaccoReturn';
           $('#AppMessage').html(parent.gsInstructionText + '<BR>The Tobacco Tax for 2015 is due January 31, 2016.');
    ...
    <body>
<%--<body onload="ispDisplayProgress('DisplayTobaccoReturn()', 'Retrieving 2015 tobacco tax information')">--%>
    <div class="container-fluid no-padding" id="TobaccoReturn">
        <div class="block3">
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:25%;" >                                                
                                                ...
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                      <input type="text" class="form-control input-sm table_custom_input"  id="txtTobaccoNo1a" onchange="ValidateTobaccoReturn()" onfocus="SetFocus()" maxlength="10"  />
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                        ...
                                        <tr class="odd">
                                            <td style="width:75%;">2a.  Total number of ounces of all tobacco and tobacco-related items sold January 1 through December 31, 2015. </td>
                                            <td style="width:25%;">                                             
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr >
                                            <td style="width:75%;"> 3a.  Total number of packs sold January 1 through December 31, 2015.&nbsp;</td>
                                            <td style="width:25%;">                                                
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td style="width:25%;">                                                
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
                                                 <input class="form-control input-sm" id=txtTobaccoNo3b onchange="ValidateTobaccoReturn()" onfocus="SetFocus()" maxlength=10 />
                                                    </div>
                                                </div>
                                            </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="width:75%;">4. Tax due by January 31, 2016[Calculated - add lines 1d, 2d and 3d]</td>
                                            <td style="width:25%;">                                               
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr class="odd">
                                            <td>5. Tax previously paid for tax year 2015 and other credits</td>
                                            <td style="width:25%;">                                               
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
			...
			<label class="" >Amount of overpayment to be applied to the 2016 Tobacco and Tobacco-Related Products Tax.</label></td>
                                            <td >                                            
                                                <div class="form-horizontal">
                                                  <div class="form-group no-margin">
                                                    <div class="">
