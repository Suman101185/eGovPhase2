...
<script id="clientEventHandlersJS" language="javascript">
    ...
    function DisplayWage08Return() {
        ...
        $('#AppHeader').html(txtHeader + '<Font class=hdrMedium>|wage tax reconciliation return for 2015</Font>');
        parent.gsInstructionItem = '#WageReturn';
        $('#AppMessage').html(parent.gsInstructionText + '<BR>The Reconciliation of Wage Tax for 2015 is due February 28, 2011.');
    ...
    function Calc1Minus2() {
        ...
        if (txtWageNo1_08.value != "" && txtWageNo2_08.value != "") {
            //var val1 =
            $('#lblWageNo3_08').text(ispFormatMoney(parseCurrency(txtWageNo1_08.value) - parseCurrency(txtWageNo2_08.value), 0));
    ...
    <div class="container-fluid no-padding" id="WageReturn_08">
        ...
        <div class="block3">
            ...
            <div class="container-fluid">
                                                        ...
                                                        <div class="form-group topsmallform">
                                                            ...
                                                            <div>
                                                                <label class="col-sm-8 control-label text-custom-left2" for="inputEmail3">
                                                                    <span class="custom_padding_span">If you were a partial year resident in 2015, enter dates of residency : From: 
				...
				wage tax was remitted for the pay period including March 12, 2015. </td>
                                                                    <td width="25%">
				...
				(Paid to non-residents working outside of Philadelphia)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%">
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>3.</strong></span> &nbsp;Taxable income paid to employees earning tips on which City Wage Tax
was not withheld</td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input class="form-control input-sm" id=txtWageNo3_08 onchange="ValidateWage08Prelim()" style="WIDTH: 100%"
				 onfocus="ReadOnlySetFocus()" maxlength=20>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                  ...
                                                                  <tr>
                                                                    <td class="text-left"><span><strong>4.</strong></span> &nbsp; Gross Compensation per W-2 forms on 
				which Philadelphia Wage Tax was withheld or due[Calculated - line 1 less line 2] </td>
                                                                ...
                                                                <tr class="odd">
                                                                    <td class="text-left"><span><strong>5.</strong></span> &nbsp; Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (1/1/2015 to 06/30/2015)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%">
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>6.</strong></span> &nbsp; Tax Due [Calculated - line 4 X .039280] </td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr class="odd">
                                                                    <td class="text-left"><span><strong>7.</strong></span> &nbsp;  Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (7/1/2015 to 12/31/2015)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%">
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>8.</strong></span> &nbsp; Tax Due[Calculated - line 6 X .039240]&nbsp;</td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                 <input id="lblWageNo7_08" onchange="ValidateWage08Prelim()"
                                                                                        onfocus="ReadOnlySetFocus()" maxlength="20" class="form-control input-sm">
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    <td class="text-left"><span><strong>9.</strong></span> &nbsp; Taxable Gross Compensation paid to 
      <U>non-residents</U>      of 
				Philadelphia (1/1/2015 to 06/30/2015)&nbsp;</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%">
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>10.</strong></span> &nbsp; Tax Due[Calculated - line&nbsp;8 X .034985]</td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr class="odd">
                                                                    <td class="text-left"><span><strong>11.</strong></span> Taxable Gross Compensation paid to 
      <U>non-residents</U>      of 
				Philadelphia (7/1/2015 to 12/31/2015)</td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%">
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>12.</strong></span> &nbsp;Tax Due[Calculated - line 10 X .034950]&nbsp;</td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr class="odd">
                                                                    <td class="text-left"><span><strong>13.</strong></span>&nbsp;Total Tax Due[Calculated - lines 5, 7, 9 and 11]</td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>14.</strong></span>&nbsp;Tax previously paid for 2015 - <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
						...
						<br>Click on link for more information.</label></td>
                                                                ...
                                                                <tr class="odd">
                                                                    <td class="text-left"><span><strong>15.</strong></span>&nbsp;ADDITIONAL TAX DUE If line 12 is greater than line 13,
				enter the amount here.</td>
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>16.</strong></span> &nbsp;TAX OVERPAID If line 12 is less than line 13,
