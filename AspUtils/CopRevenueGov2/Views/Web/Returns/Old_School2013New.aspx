    ...
    function DisplaySchool08Return() {
        ...
        if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('29')")) {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'ERROR_INFO ERROR', "", 0) != 0) {
                ...
                $('#AppHeader').html(txtHeader + '<Font class=hdrMedium>|school income tax return for 2013</Font>');
        ...
        $('#AppMessage').html(parent.gsInstructionText + '<BR>The School Income Tax for 2013 is due April 15, 2014.');
...
<title></title>
    ...
    <body>
<%--<body onload="ispDisplayProgress('DisplaySchool08Return()', 'Retrieving 2013 school tax information')">--%>
                        ...
                        <div class="clear"></div>
                            ...
                            <div class="form_segment">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabularform">
                                    ...
                                    <%--<tr>
                                        <th width="53%" scope="col" align="right">If you were a  partial year resident in 2013, enter dates of residency :  </th>
      ...
      style="WIDTH: 68px; HEIGHT: 22px" size=9></th>
                                     ...
                                     <tr>
                                      <td width="50%" scope="col" align="left">
                                          If you were a  partial year resident in 2013, enter dates of residency :  </td>
