        ...
        <div class="block3">
            ...
            <div class="container-fluid">
                                                        ...
                                                        <div class="form-group topsmallform">
                                                            ...
                                                            <div>
                                                                <label class="col-sm-8 control-label text-custom-left2" for="inputEmail3">
                                                                    <span class="custom_padding_span">If you were a partial year resident in 2013, enter dates of residency : From: 
				...
				previously paid with an extension coupon</td>
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>15B.</strong></span> &nbsp; <strong><u>Applied</u></strong> to the 2014 School Income Tax &nbsp;</td>
                                                                    <td width="25%">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
