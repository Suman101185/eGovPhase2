    ...
    <div class="tab_Tcontainer" id="WageReturn_08">
        <div class="tab_container">
			...
			<label class="" style="color: Red;width:100%" >All decimals will be rounded to the nearest whole number</label></th>
				...
				wage tax was remitted for the pay period including March 12, 2013. </b></td>
				...
				quarter of 2012 (for the pay period including March 12, 2013). </td>
                                            <td align="center" class="no_border_right">
				...
				Philadelphia city limits</strong>, for the pay period including March 12, 2013.</td>
                                            <td align="center" class="no_border_right">
				...
				Philadelphia (1/1/2013 to 06/30/2013)</td>
                                            <td align="center" class="no_border_right">
				...
				Philadelphia (7/1/2013 to 12/31/2013)</td>
                                            <td align="center" class="no_border_right">
      ...
      <U>non-residents</U>      of 
				Philadelphia (7/1/2013 to 12/31/2013)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength=20 style="WIDTH: 100%">
                                        ...
                                        <tr class="odd">
                                            <td>13. Tax previously paid for 2013 - <font  style="width:100%;color:red">
            ...
            %></div>
					...
					'Submitting 2012 wage tax information')" />
                            </div>
