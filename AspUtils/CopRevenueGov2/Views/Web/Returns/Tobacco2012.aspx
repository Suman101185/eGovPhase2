...
function DisplayTobaccoReturn() {
    ...
    if (parent.MenuWin.GetNodeCount(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '27') == 1) { //Chayan
        parent.MenuWin.ispHighlightMenu(parent.MenuWin.mnuTOBYear12);
        ...
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'ERROR_INFO ERROR', "", 0) != 0) {
            ...
            $('AppHeader').html(txtHeader + '<Font class=hdrMedium>|tobacco tax return for 2012</Font>');
    ...
    $('#AppMessage').html(parent.MenuWin.gsInstructionText + '<BR>The Tobacco Tax for 2012 is due January 31, 2014.');
...
<body onload="ispDisplayProgress('DisplayTobaccoReturn()', 'Retrieving 2012 tobacco tax information')">
    <div style="DISPLAY: block; VISIBILTY: visible" id="TobaccoReturn" name="TobaccoReturn">
        ...
        <table class="tblShowBorder" cellspacing="0" cellpadding="0" border="0" style="MARGIN-LEFT: 4%" id="TABLE2" width="90%">
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">Number of individual tobacco and tobacco-related items sold January 1 through December 31, 2012.</label></td>
                <td colspan="3">
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo1c" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataEven">
                <td>
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo1d" style="WIDTH: 100%"></label>
                </td>
            </tr>
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">Total number of ounces of all tobacco and tobacco-related items sold January 1 through December 31, 2012.</label>
                </td>
                <td colspan="3">
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">Total ounces delivered to bona fida customer locations outside Philadelphia.</label>
                </td>
                <td colspan="3">
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo2c" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataOdd">
                <td>
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo2d" style="WIDTH: 100%"></label>
                </td>
            </tr>
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">Total number of packs sold January 1 through December 31, 2012.</label>
                </td>
                <td colspan="3">
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">Total number of packs delivered to bona fida customer locations outside Philadelphia.</label>
                </td>
                <td colspan="3">
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo3c" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataEven">
                <td>
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo3d" style="WIDTH: 100%"></label>
                </td>
            </tr>
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="7">
                    <label class="lblInstrNormal">Tax due by January 31, 2013</label>
                </td>
                <td colspan="9" align="right">
                    <label class="lblInstrNormal">[Calculated - add lines 1d, 2d and 3d]&nbsp;</label>
                </td>
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo4" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataEven">
                <td>
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">Tax previously paid for tax year 2012 and other credits</label></td>
                <!--		<td colspan=3>
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo6" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataEven">
                <td>
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo8" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataEven">
                <td>
                ...
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo9a" style="WIDTH: 100%"></label>
                </td>
            </tr>
            <tr class="rowDataOdd">
                <td>
                ...
                <td colspan="16">
                    ...
                    <label class="lblInstrNormal">Amount of overpayment to be applied to the 2014 Tobacco and Tobacco-Related Products Tax.</label></td>
                <td colspan="3">
                    <label class="inpReadOnlyRt" id="lblTobaccoNo9b" style="WIDTH: 100%"></label>
                </td>
                </td>
            </tr>
        </table>
        ...
        <table style="MARGIN-LEFT: 4%" border="0" width="90%">
			...
			<input id="btnTobaccoSubmit" type="button" value="Submit" onclick="btnTobaccoValidate(); ispDisplayProgress('btnTobaccoSubmit_onclick()', 'Submitting 2011 tobacco tax information')" />&nbsp;&nbsp;
                    </p>
                </td>
            </tr>
