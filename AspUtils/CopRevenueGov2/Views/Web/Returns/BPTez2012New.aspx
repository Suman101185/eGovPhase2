            ...
            <div style="display: block;" id="tab1" class="blue_base_box">
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td width="70%" class="text-left"><span><strong>3.</strong></span> &nbsp; Tax Due for the 2012 Business Income & Receipts Tax [Calculated - add lines 1 and 2]</td>
                                            <td  width="25%" class="text-left">                                             
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                        ...
                                        <tr class="odd">
                                            <td width="70%" class="text-left"><span><strong>5.</strong></span> &nbsp; Total Due by <B>4/15/2013</B>[Calculated - add lines 3 and 4] </td>
                                            <td width="25%" class="text-left">                                             
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                        ...
                                        <tr class="odd">
                                            <td width="70%" class="text-left"><span><strong>6a.</strong></span> &nbsp; Credit from overpayment of 2011 or 2012 Net Profit Tax </td>
                                            <td width="25%" class="text-left">                                             
                                                <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                        ...
                                        <tr>
                                            <td class="text-left"><span><strong>6b.</strong></span> &nbsp; Include any estimated and/or extension payments of 2012 BIRT previously
			  made,<br>and any credit from overpayment of the 2011 BPT return</td>
					...
					<b>Use payment coupon. Make check payable to: "City of Philadelphia"[Calculated - add line 7 and 8]</td>
                                        ...
                                        <tr class="odd">
                                            <td class="text-left"><span><strong>10b.</strong></span> &nbsp; Applied, up to the tax due,	to the 2012 Net Profits Tax Return<</td>
                                            <td width="25%" class="text-left">                                                
                                                <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                        ...
                                        <tr>
                                            <td width="70%" class="text-left"><span><strong>10c.</strong></span> &nbsp; Applied to the 2013	Business Income & Receipts Tax</td>
                                            <td width="25%" class="text-left">
