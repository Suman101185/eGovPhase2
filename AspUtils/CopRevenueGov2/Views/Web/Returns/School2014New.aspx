        ...
        function DisplaySchool08Return() {
            ...
            if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('29')")) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'ERROR_INFO ERROR', "", 0) != 0) {
                    ...
                    $('#AppHeader').html(txtHeader + '<Font class=hdrMedium>|school income tax return for 2014</Font>');
            ...
            $('#AppMessage').html(parent.gsInstructionText + '<BR>The School Income Tax for 2014 is due April 15, 2015.');
                                                        ...
                                                        <div class="form-group topsmallform">
                                                            ...
                                                            <div>
                                                                <label class="col-sm-8 control-label text-custom-left2" for="inputEmail3">
                                                                    <span class="custom_padding_span">If you were a partial year resident in 2014, enter dates of residency : From: 
                                                                    ...
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo1_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo2_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo3_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo4_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo5_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo6_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo7_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo8_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo10_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
				...
				previously paid with an extension coupon</td>
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo13_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo15a_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="text-left"><span><strong>15B.</strong></span> &nbsp; <strong><u>Applied</u></strong> to the 2015 School Income Tax &nbsp;</td>
                                                                    <td>
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input type="text" class="form-control input-sm" id="txtSchoolNo15b_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
