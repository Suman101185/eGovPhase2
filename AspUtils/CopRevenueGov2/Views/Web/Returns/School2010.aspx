...
<script id="clientEventHandlersJS" language="javascript" type="text/javascript">
    ...
    function DisplaySchool08Return() {
        ...
        $('#AppMessage').html(parent.MenuWin.gsInstructionText + '<BR>The School Income Tax for 2010 is due April 15, 2011.');
...
<table style="LEFT: 43px; MARGIN-LEFT:  4%; TOP: 205px" border=0 width="90%">
  ...
  <tr>
	...
	<td align=left colspan=10 nowrap>
		<label class="lblTextBlacksmall">If you were a partial year resident in 2010, enter dates of residency:</label>&nbsp; 
...
<table style="MARGIN-LEFT: 4%" border=0  width="90%">
    ...
    ispDisplayProgress('btnSchool08Submit_onclick()', 'Submitting 2010 school tax information')">&nbsp;&nbsp;</p></td></tr>
