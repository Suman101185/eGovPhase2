...
namespace CopRevenueGov2.Helpers
{
    public class RTTIE035New : CopRestServiceBase, ICopSoapService
    {
            ...
            private static COPXmlFactory.RTTIE035new.UOFORM __Fill(RTTIE035_SrvRef.RTTIE235Response e)
            {
                ...
                fobj.UO_AMTS.ADJUSTED_TAX = CopMvcUtil.ConvDigitToCurrency(e._EAMTS.ADJUSTEDTAXX);
                fobj.UO_AMTS.FIXED_EXEMPTN = CopMvcUtil.ConvDigitToCurrency(e._EAMTS.FIXEDEXEMPTNX);
