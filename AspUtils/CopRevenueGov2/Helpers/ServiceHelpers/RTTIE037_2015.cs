...
namespace CopRevenueGov2.Helpers
{
    public class RTTIE037_2015 : CopRestServiceBase, ICopSoapService
    {
        ...
        private static COPXmlFactory.RTTIE037_2015.BPTezReturn __RTTIE037_F_I(string ReplyXMLPath)
        {
            ...
            COPXmlFactory.RTTIE037_2015.BPTezReturn sch;

            sch = RevenueGovXMLFactory.GetObject<COPXmlFactory.RTTIE037_2015.BPTezReturn>(
                xmlstring);
        ...
        private static COPXmlFactory.RTTIE037_2015.BPTezReturn __Fill(RTTIE237_SrvRef.RTTIE237Response e)
        {
            ...
            fobj.BPT_INFO.TERMINATION_DATE = CopMvcUtil.ConvDate(CopMvcUtil.GetDecimal(e._EBPT.EXTENSIONDATEX));
            ...
            fobj.BPT_PG2.STAT_EXCLUSION_EZ_X = CopMvcUtil.ConvDigitToCurrency(e._NEW2014FIELDS.STATEXCLUSIONEZX);
            fobj.BPT_PG2.STAT_NET_DEDUCTION_1_X = CopMvcUtil.ConvDigitToCurrency(e._NEW2014FIELDS.STATNETDEDUCTION1X);
            fobj.BPT_PG2.TAXABLE_SUBTOTAL_EZ_X = CopMvcUtil.ConvDigitToCurrency(e._NEW2014FIELDS.TAXABLESUBTOTALEZX);
            return fobj;
