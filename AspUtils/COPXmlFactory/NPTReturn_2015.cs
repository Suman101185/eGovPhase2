...
namespace COPXmlFactory
{
    namespace RTTIE039_2015
    {
        ...
        {
            [XmlElement]
            public XmlNodeEntity RESIDENT_INCOME_NOT_ELIGIBLE { set; get; }
            [XmlElement]
            public XmlNodeEntity RESIDENT_INCOME_TAX_NOT_ELIGIBLE { set; get; }
            [XmlElement]
            public XmlNodeEntity RESIDENT_INCOME_ELIGIBLE { set; get; }
            [XmlElement]
            public XmlNodeEntity RES_INCOME_TAX_ELIGIBLE { set; get; }
            [XmlElement]
            public XmlNodeEntity RESIDENT_TOTAL_TAX { set; get; }
            [XmlElement]
            public XmlNodeEntity NON_RES_INCOME_NOT_ELIGIBLE { set; get; }
            [XmlElement]
            public XmlNodeEntity NON_RES_INCOME_TAX_NOT_ELIGIBLE { set; get; }
            [XmlElement]
            public XmlNodeEntity NON_RES_INCOME_ELIGIBLE { set; get; }
            [XmlElement]
            public XmlNodeEntity NON_RES_INCOME_TAX_ELIGIBLE { set; get; }
            [XmlElement]
          ...
          //  --------------------------------------------------------
            ...
            [XmlElement]
            public XmlNodeEntity LINE17 { set; get; }
            [XmlElement]
            public XmlNodeEntity BALANCE { set; get; }
            [XmlElement]
        ...
        public class NPT_WRKA : XmlNodeEntityBase
        {
            ...
            [XmlElement]
            public XmlNodeEntity RESIDENT_TAXABLE_INCOME_NOT_ELIGIBLE { set; get; }
            [XmlElement]
            public XmlNodeEntity RESIDENT_TAXABLE_INCOME_ELIGIBLE { set; get; }
        ...
        public class NPT_WRKB : XmlNodeEntityBase
        {
            ...
            [XmlElement]
            public XmlNodeEntity NON_RES_TAXABLE_INCOME_NOT_ELIGIBLE { set; get; }
            [XmlElement]
            public XmlNodeEntity NON_RES_TAXABLE_INCOME_ELIGIBLE { set; get; }
        }
