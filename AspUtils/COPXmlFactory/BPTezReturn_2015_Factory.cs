...
namespace COPXmlFactory
{
    public partial class RevenueGovXMLFactory : XMLFactory
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static RTTIE037_2015.BPTezReturn GetBPTez_2015Return()
        {
            RTTIE037_2015.BPTezReturn bpt = new RTTIE037_2015.BPTezReturn();
            ...
            //UO_ACCT
            bpt.BPT_INFO = new RTTIE037_2015.BPT_INFO();
            ...
            //BPT_PG1
            bpt.BPT_PG1 = new RTTIE037_2015.BPT_PG1();
            ...
            //BPT_PG2
            bpt.BPT_PG2 = new RTTIE037_2015.BPT_PG2();
