...
<script runat="server">
    ...
    void CallRttie030()
    {
        xmlOut = RTTIE030_2014.CallService(xmlReqDoc);
...
<%
    ...
    rev_func_srv.CreateXmlBufferObj(xmlOut, util.GetXMLString(Server.MapPath("~/Views/Web/XML/BPTlfReturn_2014.xml")), false);
