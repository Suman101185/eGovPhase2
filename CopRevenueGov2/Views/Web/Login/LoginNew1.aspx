...
<body>
    ...
    <div class="container-fluid no-padding" id="tab">
                                    ...
                                    <form class="form-horizontal login_form">
                                        <div class="form-group text-left-custom">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" name="txtAccountNumber" class="form-control input-sm" id="txtAccountNumber" maxlength="9" size="14" value="" />
                                        ...
                                        <div class="form-group text-left-custom">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="password" id="txtPIN" class="form-control input-sm" maxlength="13" size="15" value="" style="border: Red;" />
