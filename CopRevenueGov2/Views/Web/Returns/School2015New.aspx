    ...
    <script id="clientEventHandlersJS" language="javascript" type="text/javascript">
        ...
        function DisplaySchool08Return() {
            ...
            if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('29')")) {               
                ...
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlSchool, '12/31/2015', 'SCHOOL_INFO PERIOD', '', 0)

                var ReqXML = parent.$g.xmlSchool;
                $.ajax({
                    type: 'POST',
                    url: '../Returns/Log',
                    data: '{ "OriginationFom" : "SIT-2015","ServiceName" : "RTTIE036","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
                ...
                $.ajax({
                    type: 'POST',
                    url: '../Returns/Log',
                    data: '{ "OriginationFom" : "SIT-2015","ServiceName" : "RTTIE036","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'ERROR_INFO ERROR', "", 0) != 0) {
                    ...
                    $('#AppHeader').html('school income tax return for 2015');
            ...
            $('#AppMessage').html('The School Income Tax for 2015 is due April 17, 2016.');           
        ...
        function CheckSchool08XML() {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'SCHOOL_INFO PERIOD', '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'SCHOOL_INFO PERIOD', '', 0)) < new Date('01/01/2015')) {
                bPeriodExist = false
            } //if
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">                                           
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 templateclass">
                                                    ...
                                                    <form class="form-horizontal school_form">
                                                           ...
                                                           <div class="clearfix"></div>
                                                            <div class="col-sm-12 col-xs-12 newtop_padding after-amended-sit"style="padding-left:0;">
                                                                ...
                                                                <label  class="text-custom-left2" for="inputEmail3">
                                                                    <span class="custom_padding_span">If you were a partial year resident in 2015, enter dates of residency :</span></label>

                                                                </div>
                                                                
                                                                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 new-margin-top-form wage-form-date" style="padding-left:0; margin-left:0;"><label><span class="wage-from-date"> From: 
                                                                    <input class="inpNormal_custom date-input date-field-design" style="width:32%;" id="txtFromDate_08" onchange="ValidateSchool08Date()" placeholder="MM/DD/YYYY"
                                                                         onblur="return txtFromDate_08_onblur();"></span>
                                                                   <%-- <span>--%> &nbsp<span class="wage-to-date"> To:
                                                                       <input class="inpNormal_custom date-input  date-field-design" style="width:32%;" id="txtToDate_08" onchange="ValidateSchool08Date()" placeholder="MM/DD/YYYY"
                                                                         onblur="return txtToDate_08_onblur();"></span></label> <%--</span>--%>
                                                        ...
                                                        <div class="col-sm-8 newtop_padding">
                                                            ...
                                                            <div class="col-sm-2 newtop_padding margin-below"> <input class="inpNormal_custom date-input date-field-design" id="txtTerminationDate" placeholder="MM/DD/YYYY" onchange="ValidateSchool08Date()" maxlength="10" style="WIDTH: 70%;"
                                                                        onfocus="SetFocus()" onblur="return txtTerminationDate_onblur()"></div>                                                             
                                                        </div>
                                                    </form>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <table class="table table-condensed table-striped custom_table03 sit-print-table wage-table-print">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                      <td width="5%">15B.</td>
                                                                    <td width="70%" class="text-left"><strong><u>Applied</u></strong> to the 2016 School Income Tax &nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                               ...
                                               <input type="button" value="Submit" class="btn btn-default submit_button" id="btnSchool08Submit"  onclick="btnSchoolValidate(); ispDisplayProgress('btnSchool08Submit_onclick()', 'Submitting 2015 school tax information')" />               
