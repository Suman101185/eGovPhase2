        ...
        function DisplaySchool08Return() {
            ...
            if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('29')")) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../Returns/Log',
                    data: '{ "OriginationFom" : "SIT-2012","ServiceName" : "RTTIE036","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
                ...
                $.ajax({
                    type: 'POST',
                    url: '../Returns/Log',
                    data: '{ "OriginationFom" : "SIT-2012","ServiceName" : "RTTIE036","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'ERROR_INFO ERROR', "", 0) != 0) {
                    ...
                    $('#AppHeader').html('school income tax return for 2012');
            ...
            $('#AppMessage').html('The School Income Tax for 2012 is due April 17, 2013.');
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 col-xs-12 newtop_padding after-amended-sit"style="padding-left:0;">
                              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <label  class="text-custom-left2" for="inputEmail3"> <span class="custom_padding_span">If you were a partial year resident in 2012, enter dates of residency :</span></label>
                              </div>
                              ...
                              <div class="col-lg-12" >
                                <table class="table table-condensed table-striped custom_table03 sit-print-table wage-table-print">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td width="5%">15B.</td>
                                      <td width="70%" class="text-left"><strong><u>Applied</u></strong> to the 2013 School Income Tax &nbsp;</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                            ...
                            <form class="form-horizontal form-year-background school-filler-email-break" style="padding:5px !important;">
                              ...
                              <div class="form-group submit-button-for-print">
                                <div class="col-sm-offset-3 col-sm-9  text-right">
                                  ...
                                  <input type="button" value="Submit" class="btn btn-default submit_button" id="btnSchool08Submit"  onclick="btnSchoolValidate(); ispDisplayProgress('btnSchool08Submit_onclick()', 'Submitting 2012 school tax information')" />
                                </div>
                              </div>
                              <div class="clearfix"></div>
                              <div class="col-md-12">
