...
<!-- Bootstrap Core CSS -->
    ...
    function DisplayBPTezReturn() {
        ...
        if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('24')")) {          
            ...
            $('#AppHeader').html('Business Income & Receipts Tax-EZ for 2011');
            
            parent.gsInstructionItem = '#BIR';
            $('#AppMessage').html('<BR>The Business Income & Receipts Tax for 2011 is due April 17, 2012.');
    ...
    function ShowPage(iPage) {
        ...
        if (iPage == 2) {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez, 'BPT_INFO RETURN_STATUS', '', 0) == 'A1' || parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez, 'BPT_INFO RETURN_STATUS', '', 0) == 'A2') {
                //SUMAN : AS PER REQUIREMENT DICUSSED ON 29TH JAN 2012, CLIENT DONT WANT SCHEDULE N LINK IF USER CHOSE YES OPTION
            ...
            // Added to solve Schedule N issue by chayan on 19/03/2011		
            CalcPage1Line3();
            CalcPage1Line5();
            CalcPage1Line6c();
            CalcPage1Line7();
