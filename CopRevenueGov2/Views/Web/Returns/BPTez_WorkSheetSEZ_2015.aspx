    ...
    <script>
        ...
        function GetPage2Line8() {
            if (cCur($('#lblBPTez2_8').text()) != 0) {
                if (cCur($('#lblBPTez2_8').text(), 0) > 75000) {
                    $('#txt_BPT_WSEZ1').val(ispFormatMoney(75000, 0));
                }
                else
        ...
        function GetS2byS3() {
            ...
            if ($('#lbl_BPT_WSEZ3').text() != '' && $('#lbl_BPT_WSEZ2').text() != '') {
                ...
                if (isNaN((cCur($('#lbl_BPT_WSEZ2').text()) / cCur($('#lbl_BPT_WSEZ3').text())) ) || calculationvar1 == 'Infinity' || calculationvar1 == 'NAN') {
                    ...
                    calculationvar1 = calculationvar1.toFixed(4);
...
<body>
   <div class="form-group" id="BPTez_WrkShtNE" style="DISPLAY: none;">
    ...
    <tbody>
        ...
        <tr>  
             <td width="5%"></td>          
            <td width="70%"><B><U>Worksheet S-EZ - Use to calculate Statutory Net Income Deduction</U></b></td>
            ...
            <tr>   
                 <td width="5%">S1.</td>            
            <td width="70%" class="text-left"> Enter the lower of <label id="Label2" class="lblLink label_NoLeft"  onclick=ShowPage(2) > Line 8 of Page 2 </label> or $75,000 </td>
            <td colspan="2" align="center" width="25%">                
                <div class="form-horizontal">
                    <div class="form-group no-margin">
                        <div class="">
                            <INPUT type="text" class="form-control input-sm pull-right" id="txt_BPT_WSEZ1"  onfocus=SetFocus() maxLength="10" onchange="ValidateBPTezReturn()" style="WIDTH: 100%;">
                        </div>
                   </div>
                </div>
                </td>
        ...
        <tr  class="odd">
             <td width="5%">S2.</td>
            <td width="70%" class="text-left"> Enter Net Income (from Line 1 or Line 2 of <label id="Label1" class="lblLink label_NoLeft"  onclick=ShowPage(2)> Page 2 </label>)</td>
            <td colspan="2" align="center" width="25%">               
                <div class="form-horizontal">
                    <div class="form-group no-margin">
                        <div class="">
        ...
        <tr >
             <td width="5%">S3.</td>
            <td width="70%" class="text-left"> Enter Taxable Gross Receipts (from Line 8 of <label id="lblLnksD" class="lblLink label_NoLeft"  onclick=ShowPage(2)>  Page 2 </label>)</td>
            <td colspan="2" align="center" width="25%">               
                <div class="form-horizontal">
                    <div class="form-group no-margin">
                        <div class="">
        ...
        <tr class="odd">
             <td width="5%">S4.</td>
            <td style="width:70%" class="text-left"> Divide Line S2 by Line S3 (Cannot be greater than 1.0000)</td>
        ...
        <tr >
             <td width="5%">S5.</td>
            <td style="width:70%" class="text-left"> Statutory Net Income Deduction (Line S1 times Line S4, Cannot exceed $75,000)</td>
