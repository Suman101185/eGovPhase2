...
<head>    
    ...
    <script ID="clientEventHandlersJS" LANGUAGE="javascript">
        ...
        function DisplayLCF() {
           ...
           // setTimeout('isLoaded()', 100)          
           $('#AppHeader1').html(txtHeader + '<Font class=hdrMedium>|Loss Carry Forward Form</Font>');
...
<body onload="DisplayLCF()">
   <div class="container-fluid no-padding" id="losscarryforward" >
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <h6><strong>TAX Filing Information</strong></h6>
...
<br />
             ...
             <div class="form_segment here_input_table" align="right">
                 <input type="button" value="Back" class="submit_button_light" onclick="BackLFToHome()" id="Button1" />
