...
<script id="clientEventHandlersJS" language="javascript" type="text/javascript">
    ...
    function DisplayBPTezReturn() {
        ...
        if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('24')")) {        
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTez_2015, '12/31/2016', 'BPT_INFO PERIOD', '', 0);

            $('#AppHeader').html('Business Income & Receipts Tax-EZ for 2016');
           
            parent.gsInstructionItem = '#BIR';
            $('#AppMessage').html('The Business Income & Receipts Tax for 2016 is due April 18, 2017.');          
            //suman set last parameter true will cause xml copy to browser clipboard

            var ReqXML = parent.$g.xmlBPTez_2015;
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "EZ-2016","ServiceName" : "RTTIE037","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            var ResXML = parent.$g.xmlBPTez_2015;
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "EZ-2016","ServiceName" : "RTTIE037","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'ERROR_INFO ERROR', "", 0) != 0) {
                ...
                PopulateBPTezHeader();
                FieldLock(true);
                $("#AppError").text(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'ERROR_INFO MESSAGE', "", 0));
    ...
    function SetBPTezFields() {
        ...
        else if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_INFO VERSION', '', 0) != '' && parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_INFO PREPARER_NAME', '', 0) == '' && parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_INFO PREPARER_PHONE', '', 0) == '')
            {
            FieldLock(false);
        }
        else {
    ...
    function FieldLock(bDisabled) {
        if (bDisabled == true) {
            ...
            debugger;
            DisablePreparer(bDisabled);
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_PG2 NET_INCOME_LOSS_1', '', 0) != '$00.00') {
                $('#radBPTez2_1_2_m2').attr("disabled", "disabled");                
                $('#txtBPTez2_1').attr("disabled", "disabled");
            }
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_PG2 NET_INCOME_LOSS_2', '', 0) != '$00.00') {
                $('#radBPTez2_1_2_m1').attr("disabled", "disabled");
                $('#txtBPTez2_2').attr("disabled", "disabled");                
    ...
    function PopulateBPTezData() {
        ...
        $('#lblBPTez2_9').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_PG2 STAT_EXCLUSION_EZ_X', '', 0), 0));
        ...
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_PG2 NET_INCOME_LOSS_1', '', 0) == '$00.00' && parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_PG2 NET_INCOME_LOSS_2', '', 0) == '$00.00') {
            document.getElementById('radBPTez2_1_2_m2').checked = true;
    ...
    function PopulateBPTezXML() {
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTez_2015, stripCurrency($('#lblBPTez2_9').text()), 'BPT_PG2 STAT_EXCLUSION_EZ_X', '', 0);
    ...
    function btnBPTezSubmit_onclick() {
        ...
        if (cCur($('#txt_BPT_WSEZ1').val()) > cCur($("#lblBPTez2_8").text())) {
            if (cCur($('#txt_BPT_WSEZ1').val()) != 100000) {
                $("#AppError").text('S1 value must be lower of Line 8 of Page 2 or $1,00000');
                resolvedIframeheight();
                parent.ScrollTop(1);
            }
        ...
        if ($("#AppError").text() == "") {
            ...
            setTimeout(function () { }, 3000);
            ispCallXMLForm(parent.$g.xmlBPTez_2015, tempXML, "BPTezReturn_2015", "");


            parent.$g.xmlBPTez_2015 = tempXML;
            var ResXML = parent.$g.xmlBPTez_2015;
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
        ...
        if ($('#txtBPTez2_4').val() != ispFormatMoney(0, 0).toString()) {
            for (i = 0; i < iCount; i++) {
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '', i) == '24') {
                    ...
                    if (new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT START_DATE', '', i)) >= new Date("01/01/2016")) {
                        $('#txtBPTez2_4').val(ispFormatMoney(0, 0));//'$0';
                        alert('This return is not eligible for Loss Carry Forward, because your BPT Start Date '
                             + BPTStartDate
                             + ' is on or after 01/01/2016. Loss Carry Forward (Page 2, question #4) has been set to zero.');
                    }
                }
            }
        }
    ...
    function CalcPage2Line8() {
        ...
        if ($('#txtBPTez2_7a').val() != "" && $('#txtBPTez2_7b').val() != "" && $('#txtBPTez2_7c').val() != "" &&
            ...
            if (cCur($('#lblBPTez2_9').text()) > 100000) {
                $('#lblBPTez2_9').text(ispFormatMoney(100000,0));
    ...
    function CalcPage2Line9() {
        ...
        if (cCur($('#lblBPTez2_9').text()) > cCur($("#lblBPTez2_8").text())) {
            if (cCur($('#lblBPTez2_9').text()) != 100000) {
                $("#AppError").text('Line 9 value must be lower of Line 8 or $100,000');
                resolvedIframeheight();
                parent.ScrollTop(1);
            }
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-sm-12" style="display:none">
                            <label class="control-label text-custom-left2 no-padding" for="inputEmail3">
                                <span class="custom_padding_span"> If your business terminated in 2016, enter the termination date AND file a CHANGE FORM. 
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                             <td width="5%">3.</td>
                                            <td width="70%" class="text-left"> Tax Due for the 2016 Business Income & Receipts Tax [Calculated -  add lines 1 and 2] </td>
                                            <td  width="25%" class="text-left">
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                             <td width="5%">4.</td>
                                            <td width="70%" class="text-left"> <B><U>MANDATORY</U> 2017 BIRT Estimated Payment (repeat line 3)</B></td>
                                            <td width="25%" class="text-left">                                               
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                             <td width="5%">5.</td>
                                            <td width="70%" class="text-left"> Total Due by 4/18/2017 [Calculated - add lines 3 and 4]  </td>
                                            <td width="25%" class="text-left">                                             
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                       ...
                                       <thead>
                                        ...
                                        <tr>
                                             <td width="5%">6a.</td>
                                            <td width="70%" class="text-left"> <B>Include any estimated and/or extension payments of 2016 BIRT previously made, and any credit from overpayment of the 2015 BIRT and/or 2016 NPT return</B>  </td>
                                            <td width="25%" class="text-left">                                             
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                             <td width="5%">6b.</td>
                                            <td width="70%" class="text-left"> Credit from Special Credit Schedule (SC). </td>
                                            <td width="25%" class="text-left">                                               	
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr >
                                            <td width="5%">9.</td>
                                            <td width="70%" class="text-left"> <B><u>TOTAL DUE</u></B> including Interest and Penalty . <br/><B>Use payment coupon. Make check payable to: "City of Philadelphia"</B></td>
                                            <td width="25%" class="text-left">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr >
                                             <td width="5%">10a.</td>
                                            <td width="70%" class="text-left"> Refunded.<B> Do not file a separate Refund Petition</B></td>
                                            <td width="25%" class="text-left">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                             <td width="5%">10b.</td>
                                            <td width="70%" class="text-left"> Applied, up to the tax due, to the 2016 Net Profits Tax Return</td>
                                            <td width="25%" class="text-left">                                               
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                             <td width="5%">10c.</td>
                                            <td width="70%" class="text-left"> Applied to the 2017 Business Income & Receipts Tax</td>
                                            <td width="25%" class="text-left">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                         ...
                         <div style="DISPLAY:none" Id="BPTez_pg2" Name="BPTez_pg2">
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print wage-table-print-for-ez">
                                    <thead>
                                        	<tr>
                                            	<th colspan="3" width="100%" style="font-size:14px;">NET INCOME PORTION</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                             <td width="5%">6.</td>
                                            <td width="70%" class="text-left">TAX DUE [Calculated - line 5 * 0.0639]. </td>
                                            <td width="25%" class="text-left">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                       ...
                                       <thead>
                                        ...
                                        <tr >
                                         ...
                                         <tr>
                                              <td width="5%">8.</td>
                                            <td width="70%" class="text-left"> TAXABLE GROSS RECEIPTS before Statutory Exclusion.[Calculated - add lines 7a through 7i]</td>
                                            <td width="25%" class="text-left">                                             
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                         ...
                                         <tr >
                                              <td width="5%">9.</td>
                                            <td width="70%" class="text-left"> <b>Statutory Exclusion [Lower of Line 8 or $100,000.00]</b></td>
                                            <td width="25%" class="text-left">                                
                                        ...
                                        <tr >
                                             <td width="5%">10.</td>
                                            <td width="70%" class="text-left"> Net taxable Gross Receipts [Calculated - line 8 minus line  9]</td>
                                            <td width="25%" class="text-left">                                             
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr >
                                             <td width="5%">11.</td>
                                            <td width="70%" class="text-left"> TAX DUE. [Calculated - line 10 * 0.001415] .</td>
                                            <td width="25%" class="text-left">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                            ...
                            <div>
                            <% Html.RenderAction("BPTez_WorkSheetSEZ_2016", "Returns"); %>
                            </div>
