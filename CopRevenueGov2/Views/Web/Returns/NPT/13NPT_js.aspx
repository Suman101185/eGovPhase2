...
<script language="javascript" type="text/javascript">
    ...
    function DisplayNPTReturn() {
        ...
        if (parent.GetNodeCount(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '3') == 1) {
            ...
            $.ajax({
                type: 'POST',
                url: '../../Returns/Log',
                data: '{ "OriginationFom" : "NPT-2013","ServiceName" : "RTTIE039","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../../Returns/Log',
                data: '{ "OriginationFom" : "NPT-2013","ServiceName" : "RTTIE039","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
    ...
    function DisplayNPTThankYou() {
        ...
        $('#NPT_Page4').css("display", "none");
        $('#NPT_2013').css("display", "none");
        $('#NPT_2013').css("visibility", "hidden");
        ...
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT, 'NPT_INFO ADJUSTMENT_REF_NO', '', 0) != '') {
            ...
            $.ajax({
                type: 'POST',
                url: '../../Returns/Log',
                data: '{ "OriginationFom" : "NPT-2013","ServiceName" : "RTTIE039"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
