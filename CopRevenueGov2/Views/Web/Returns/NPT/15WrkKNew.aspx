      ...
      <div class="col-lg-12" >
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
            <tbody>
                ...
                <tr>
                      <td width="5%">1.</td>
                    <td> Enter the amount from Page 1, Line 1 of the 2015 Business Income & Receipts Tax or
BIRT-EZ return</td>
                    <td style="width:25%">                        
                ...
                <tr>
                      <td width="5%">2.</td>
                    <td> Enter 60% of the amount on Line 1. If your entity has corporate members <b>Stop Here</b> and go to Page 3, Worksheet D -  <br />
                    ...
                    <tr class="odd">
                          <td width="5%">3.</td>
                    <td width="70%"> Enter the amount from Page 1, Line 11 of the 2015 Net Profits Tax Return
