        ...
        <h4 id="AppMessage">&nbsp;</h4>
         ...
         <div class="row">
           ...
           <div class="col-lg-12">
            ...
            <%-- Address Start--%>
                <div class="well"  id="NPT" style="DISPLAY: none; padding:0px 5px !important; margin-bottom:0px !important;">
                     <div class="row">
                        <form>
            ...
            <%--  Adress End--%>     
               ...
               <div class="col-lg-12 templateclass">     
                    <div id="NPT_BPT_msg" style="DISPLAY: none;" VISIBILTY: visible" name="NPT_BPT_msg" align="center">
                                ...
                                Your 2016 BIRT return must be filed prior to filing your 2016 NPT Return.<br>
                    ...
                    <form class="form-horizontal">   
                        ...
                        <div class="col-sm-7 col-md-7 col-xs-7 newtop_padding">
                                <label class="control-label text-custom-left2" for="inputEmail3">
                                    <span class="pull-left" style="font-weight: normal;">If your business terminated in 2016, enter the termination date AND file a CHANGE FORM.</span>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7" style="padding-right:0 !important;">
                            <label class="control-label text-custom-left2 no-padding pull-left" for="inputEmail3">
                                <span class="custom_padding_span" style="font-weight: normal;">If applicable,enter percentage from Worksheet D, Line 3: 
                                    <label id="lnkWrkD" class="lblLink label_NoLeft" style="font-weight: normal;" onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkD')}">Click here for Worksheet D</label>
                                 </span>
                                </label>
                        </div>
                    ...
                    <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print npt-table-print-font no-mb">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td width="5%">2.</td>
                                <td width="70%" class="text-left"> <label class="" id="msgNPT1_2" style="float:none;"></label>Line 1 X 0.039004</td>
                                <td style="width:25%;" class="text-left">
                            ...
                            <tr>
                                <td width="5%">4.</td>
                                <td width="70%" class="text-left">  <label class="" id="msgNPT1_4" style="float:none;"></label>Line 3 X 0.034004</td>
                                <td style="width:25%;" class="text-left">
                            ...
                            <tr class="odd">
                                <td width="5%">7.</td>
                                <td width="70%" class="text-left"> Line 6 X 0.034741</td>
                                <td style="width:25%;" class="text-left">
                            ...
                            <tr class="odd">
                                <td width="5%">9.</td>
                                <td width="70%" class="text-left"> Line 8 X 0.029741</td>
                                <td style="width:25%;" class="text-left">
              ...
              <label id="lnkWrkC" style="font-size:11px;" class="lblLink label_NoLeft"
               ...
               <td style="width:25%;" class="text-left">
                             ...
                             <tr class="odd">
                                ...
                                <td style="width:25%; padding-bottom:0 !important;" class="text-left" style="padding-bottom:0 !important;">
                            ...
                            <tr >
                                <td style="padding-top:0 !important;" width="5%"></td>
                                <td width="70%" class="text-left" style="padding-top:0 !important;"><b><u>OVERPAYMENT OPTIONS</u> </b>Only available if Line 18 is greater than 0. Enter the amount to be:</td>
               ...
               <div class="col-lg-12 templateclass">
                ...
                <% Html.RenderAction("_16WrkA", "NPT"); %>
                <%Html.RenderAction("_16WrkB", "NPT"); %>
                <%Html.RenderAction("_16WrkC", "NPT"); %> 
                <% Html.RenderAction("_16WrkD", "NPT");%>
                <%Html.RenderAction("_16WrkE", "NPT"); %>
                <%  Html.RenderAction("_16WrkK", "NPT");%>
                <% Html.RenderAction("_16Page4", "NPT");%>
                <%Html.RenderAction("_16WrkExtension", "NPT");%>
