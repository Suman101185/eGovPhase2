      ...
      <div class="col-lg-12" >
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
            <tbody>
                ...
                <tr>
                      <td width="5%">1.</td>
                    <td> Enter the amount from Page 1, Line 1 of the 2016 Business Income & Receipts Tax or
BIRT-EZ return</td>
                    <td style="width:25%">                        
                ...
                <tr>
                    ...
                    <tr class="odd">
                          <td width="5%">3.</td>
                    <td width="70%"> Enter the amount from Page 1, Line 11 of the 2016 Net Profits Tax Return
