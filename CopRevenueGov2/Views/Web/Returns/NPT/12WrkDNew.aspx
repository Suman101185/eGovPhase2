      ...
      <div class="col-lg-12" >
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
            ...
            <tbody>
                ...
                <tr>
                     <td width="5%">1.</td>
                    <td width="70%">Enter the portion of taxable income on which 2012 Business Income & Receipts Tax has been paid, AND which represents the distributive shares of ALL CORPORATE MEMBERS</td>
                    <td style="width:25%">                           
                ...
                <tr class="odd">
                     <td width="5%">2.</td>
                    <td width="70%">Enter the total taxable income of the taxpayer on which 2012 BIRT has been paid
