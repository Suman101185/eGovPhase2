   ...
   <div class="row">
    ...
    <div  class="blue_base_box">
     ...
     <div class="inner_white-panel">
          <div class="col-lg-12 col-lg-offset-0 no-padding-left" style="height:1px !important;">
        ...
        <h4 id="AppMessage">&nbsp;</h4>
         ...
         <div class="row">
           ...
           <div class="col-lg-12">
            ...
            <%-- Address Start--%>
                <div class="well"  id="NPT" style="DISPLAY: none; padding:0 5px; margin-bottom:0px !important;">
                     <div class="row">
                        <form>
            ...
            <%--  Adress End--%>
               ...
               <div class="col-lg-12 templateclass">     
                    ...
                    <form class="form-horizontal">   
                        ...
                        <div class="col-sm-7 col-md-7 col-xs-7 newtop_padding wage-table-print">
                                <label class="control-label text-custom-left2" for="inputEmail3">
                                    <span class="pull-right" style=" font-weight:normal;">If your business terminated in 2015, enter the termination date here:</span>
                                                                   
                                </label>
                            </div>
                            <div class="col-sm-2 col-md-2 col-xs-2 newtop_padding custom-margin-npt" style="padding-left:0;">
                                 <input  class="inpNormal_custom date-input  date-field-design pull-right" id="txtTermDate" placeholder="MM/DD/YYYY" maxlength="10" style="WIDTH: 100%; height:22px !important;"
                                        onfocus="SetFocus()" onblur="return txtTermDate_onblur()"></div>                                                             
                     
                              
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"></div>
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 wage-table-print" style="padding-right:0 !important; font-weight:normal;">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                           <label id="lblPercentage" class="form-control input-sm pull-right"  style="WIDTH: 70%; padding: 1px !important; height: 22px;"></label>
                        </div>
                                </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                ...
                                <td width="70%" class="text-left"> Pro Rata Resident taxable income/loss NOT eligible for Income Based Rate from Page 2, Worksheet A, Line 5.
                                        <label id="lnkWrkA" style="font-size:11px;" class="lblLink label_NoLeft" onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkA')}">Click here for Worksheet A</label>
                                </td>
                            ...
                            <tr>
                                <td width="5%">2.</td>
                                <td width="70%" class="text-left"> <label class="" id="msgNPT1_2" style="float:none;"></label>Line 1 X 0.039102</td>
                                <td style="width:25%;" class="text-left">
                            ...
                            <tr>
                                <td width="5%">4.</td>
                                <td width="70%" class="text-left">  <label class="" id="msgNPT1_4" style="float:none;"></label>Line 3 X 0.034102</td>
                                <td style="width:25%;" class="text-left">
                            ...
                            <tr class="odd">
                                <td width="5%">7.</td>
                                <td width="70%" class="text-left"> Line 6 X 0.034828</td>
                                <td style="width:25%;" class="text-left">
                            ...
                            <tr>
                                ...
                                <td width="70%" class="text-left"> Pro Rata Non-Resident Taxable income/loss eligible for Income Based Rate from Page 2, Worksheet B, Line 6.
                                    <label id="lnkWrkB1" style="font-size:11px;" class="lblLink label_NoLeft"  onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkB')}">Click here for Worksheet B</label>
                                </td>
                                <td style="width:25%;" class="text-left">
                            ...
                            <tr class="odd">
                                <td width="5%">9.</td>
                                <td width="70%" class="text-left"> Line 8 X 0.029828</td>
                                <td style="width:25%;" class="text-left">
                            ...
                            <tr class="odd">
                             ...
                             <tr class="odd">
                                ...
                                <td  width="70%" class="text-left"> 60% Business Income & Receipts Tax credit from Worksheet K, Line 4
                                    <label id="lnkWrkk" style="font-size:11px;" class="lblLink label_NoLeft"  onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkK')}">Click here for Worksheet K</label>
                                </td>
                                <td style="width:25%;" class="text-left">
                             ...
                             <tr class="odd">
                                ...
                                <td  width="70%" class="text-left">Estimated payments and other credits from Worksheet E, Line 4
                                    <label id="lnkWrkE" style="font-size:11px;" class="lblLink label_NoLeft"  onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkE')}">Click here for Worksheet E</label>
                                </td>
                                <td style="width:25%;" class="text-left">
                             ...
                             <tr class="odd">
                                  <td width="5%">17.</td>
                                <td  class="text-left" width="70%"> Enter 50% of Page 2, Worksheet C, Line 3.
                                    <b>Do not use this line to remit estimated payments </b>
              <label id="lnkWrkC" class="lblLink label_NoLeft" style="font-size:11px;" onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkC')}">Click here for Worksheet C</label>
              </td>
                                 <td style="width:25%;" class="text-left">
                                    ...
                                    <tr class="odd">
                                 <td width="5%">18.</td>
                                <td  width="70%" class="text-left"> Balance Available. Line 16 minus Line 17. If greater than 0 proceed to Overpayment Options</td>
                                <td style="width:25%;" class="text-left">
                            ...
                            <tr >
                                <td width="5%"></td>
                                <td width="70%" class="text-left"><b><u>OVERPAYMENT OPTIONS</u> </b>Only available if Line 18 is greater than 0. Enter the amount to be:</td>
                                <td style="width:25%;">
                  ...
                  <div style="margin-left: 5px; font-size:12px; margin-top:-8px;" class="here_input_table">
    ...
    <div class="lets-split"></div>
               ...
               <div class="col-lg-12 templateclass">
                ...
                <%Html.RenderAction("_15WrkExtension", "NPT");%>
