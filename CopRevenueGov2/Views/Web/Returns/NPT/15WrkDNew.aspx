      ...
      <div class="col-lg-12" >
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
            ...
            <tbody>
                ...
                <tr>
                    <td width="5%">1.</td>
                    <td> Enter the portion of taxable income on which 2015 Business Income & Receipts Tax has been paid, AND which represents the distributive shares of ALL CORPORATE MEMBERS</td>
                    <td style="width:25%">                           
                ...
                <tr class="odd">
                    <td width="5%">2.</td>
                    <td width="70%"> Enter the total taxable income of the taxpayer on which 2015 BIRT has been paid
                ...
                <tr>
                    <td width="5%">3.</td>
                    <td> Divide Line 1 by Line 2 and enter the percentage here and on Page 1</td>
                    <td style="width:25%">                        
                     <div class="form-horizontal">
                      <div class="form-group no-margin">
                        <div class="">
                ...
                <tr >
                    <td width="5%">5.</td>
                    <td> Multiply the amount on Line 4 by the percentage on Line 3</td>
                    <td style="width:25%">                       
                      <div class="form-horizontal">
                      <div class="form-group no-margin">
                        <div class="">
                ...
                <tr >
                    <td width="5%">7.</td>
                    <td> Enter the amount from Page 1, Line 11</td>
                    <td style="width:25%">                       
                     <div class="form-horizontal">
                      <div class="form-group no-margin">
                        <div class="">
