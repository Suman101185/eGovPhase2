...
<div class="container-fluid no-padding" id="NPT_2011" style="DISPLAY: none;">
<div class="block3">
           ...
           <div class="col-lg-12">
            ...
            <%--  Adress End--%>   
               ...
               <div class="col-lg-12 templateclass">     
                       ...
                       <div class="row" style="display:none">
                        ...
                        <div class="col-sm-7 col-md-7 col-xs-7 newtop_padding">
                                <label class="control-label text-custom-left2" for="inputEmail3">
                                    <span class="pull-right">If your business terminated in 2011, enter the termination date here:</span>
                ...
                <%Html.RenderAction("_11WrkExtension", "NPT");%>
