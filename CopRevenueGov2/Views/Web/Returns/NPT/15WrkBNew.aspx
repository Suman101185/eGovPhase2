...
<body>
   <div class="form-group" id="NPT_WrkB" style="DISPLAY: none;">
    ...
    file electronically</b>
                ...
                <tr style="width:25%">
                     <td width="5%">5.</td>
                    <td> Net Income apportioned outside Philadelphia from Page 4, Line 12,
    Worksheet NR-3
                 ...
                 <tr class="odd">
                      <td width="5%">7.</td>
                    <td width="70%"> Taxable Pro Rata Nonresident portion of Net Income/Loss NOT eligible for Income-based rate.<br />
                    </td>
                    <td style="width:25%">                       
                           <div class="form-horizontal">
                     <div class="form-group no-margin">
                        <div class="">
                           <INPUT type="text" id="txtNPT_WrkB_7" class="form-control input-sm pull-right" style="WIDTH: 70%;"  onfocus=SetFocus() maxLength=10 onchange="ValidateWorksheet('WrkB')">
                        </div>
                   </div>
                </div>
                     </td>
                 ...
                 <tr class="odd">
                      <td width="5%">8.</td>
                    <td width="70%"> Taxable Pro Rata Nonresident portion of Net Income/Loss eligible for Income-based rate.<br />
                    </td>
                    <td style="width:25%">                       
                           <div class="form-horizontal">
                     <div class="form-group no-margin">
                        <div class="">
                            ...
                            <INPUT type="text" id="txtNPT_WrkB_8" class="form-control input-sm pull-right" style="WIDTH: 70%;"  onfocus=SetFocus() maxLength=10 onchange="ValidateWorksheet('WrkB')">
                        </div>
                   </div>
                </div>
                     </td>
