...
<script id="clientEventHandlersJS" language="javascript">
    ...
    function DisplayWage08Return() {
        ...
        if (parent.$x.ispXmlSetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT[ACCOUNT = "1"]', '', 0)) {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlWage, '12/31/2015', 'WAGE_INFO PERIOD', '', 0);
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "Wage-2015","ServiceName" : "RTTIE027","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "Wage-2015","ServiceName" : "RTTIE027","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
        ...
        $('#WageReturn_08').css('display', 'block');
        resolvedIframeheight();
        $('#AppHeader').html('wage tax reconciliation return for 2015');
        parent.gsInstructionItem = '#WageReturn';
      

        $('#AppMessage').html('The Reconciliation of Wage Tax for 2015 is due February 28, 2016.');
    ...
    function CheckWage08XML() {
        ...
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'WAGE_INFO PERIOD', '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'WAGE_INFO PERIOD', '', 0)) < new Date('01/01/2015')) {
            bPeriodExist = false
        }
    ...
    <div class="container-fluid no-padding" id="WageReturn_08">
        ...
        <div class="block3">
            ...
            <div class="container-fluid">
                                           ...
                                           <div class="row">
                                               <!--Gereral Form Section  -->
                                                <div class="col-lg-12 templateclass">
                                                        ...
                                                        <div class="form-group topsmallform" style="margin-bottom:0px;">
                                                            ...
                                                            <div class="col-sm-9 newtop_padding" style="display:none">
                                                                ...
                                                                <label  class="text-custom-left2" for="inputEmail3">
                                                                    <span class="custom_padding_span">If you were a partial year resident in 2015, enter dates of residency :</span></label></div><div class="col-sm-5 new-margin-top-form wage-form-date"><label><span class="wage-from-date"> From: 
                                                                    <input class="inpNormal_custom date-input date-field-design" id="txtFromDate_08" placeholder="MM/DD/YYYY"
                                                                         ></span>
                                                                   <%-- <span>--%> &nbsp<span class="wage-to-date"> To:
                                                                       <input class="inpNormal_custom date-input  date-field-design" id="txtToDate_08"  placeholder="MM/DD/YYYY"
                                                                        ></span></label> <%--</span>--%></div>
                                                   ...
                                                   <div class="row">
                                                        <div class="col-lg-12">
                                                        <table class="table table-condensed table-striped custom_table03 wage-table-print" style="margin-bottom:15px;">
                                                            
                                                            <tbody>
                                                                <tr>
                                                                    <td width="5%">A.</td>
                                                                    <td width="70%" class="text-left">Enter the number of Philadelphia Residents for whom wage tax was remitted for the pay period including March 12, 2015. </td>
				...
				quarter of 2015 (for the pay period including March 12, 2015). </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
				...
				Philadelphia city limits</strong>, for the pay period including March 12, 2015.</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
...
was not withheld</td>
				...
				Philadelphia (1/1/2015 to 06/30/2015)</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                  ...
                                                                  <tr class="">
                                                                    <td width="5%">6.</td>
                                                                    <td width="70%" class="text-left">Tax Due [Calculated - line 5 X .03920] </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr class="odd">
                                                                    <td width="5%">7.</td>
                                                                    <td width="70%" class="text-left">Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (7/1/2015 to 12/31/2015)</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr>
                                                                    <td width="5%">8.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line 7 X .039102]&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
      ...
      <U>non-residents</U>      of 
				Philadelphia (1/1/2015 to 06/30/2015)&nbsp;</td>
                                                                ...
                                                                <tr>
                                                                    <td width="5%">10.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line&nbsp;9 X .034915]</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
      ...
      <U>non-residents</U>      of 
				Philadelphia (7/1/2015 to 12/31/2015)</td>
                                                                ...
                                                                <tr>
                                                                    <td width="5%">12.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line 11 X .034828]&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr>
                                                                    <td width="5%">14.</td>
                                                                    <td width="70%" class="text-left">Tax previously paid for 2015  <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
                                               ...
                                               <!-- Preperar Section Form -->
                                                ...
                                                <div class="form-group page-print-wage-section">
                                                  <div class="col-sm-offset-3 col-sm-9 text-right">
                                                      <input id="btnWage08Print" type="button" value="Print" class="btn btn-default submit_button_light" style="margin-top:3px !important;" onclick="btnWage08Print_onclick()" />
    ...
    ispDisplayProgress('btnWage08Submit_onclick()', 'Submitting 2015 wage tax information')" />                  
