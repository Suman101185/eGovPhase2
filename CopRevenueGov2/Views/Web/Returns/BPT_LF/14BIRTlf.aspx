    ...
    <script id="bptIF" language="javascript" type="text/javascript">
        ...
        function DisplayBPTlfReturn() {
            ...
            if ($(parent.$g.xmlAccount.xml).find('TAX_ACCT[ACCOUNT = "24"]').eq(0)) {
                ...
                parent.$g.xmlBPTlf_2014.loadXML(parent.$g.xmlBPTlfTemplate_2014.xml);
                ...
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 'INQ', xFldInfRetStat, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ENTITY_INFO ACCOUNT_ID', '', 0), xFldInfAcctID, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '12/31/' + (sCurrYear - 1), xFldInfPeriod, '', 0);

                var ReqXML = parent.$g.xmlBPTlf_2014;
                $.ajax({
                    type: 'POST',
                    url: '../../Returns/Log',
                    data: '{ "OriginationFom" : "BPTLF-2014","ServiceName" : "RTTIE030","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
                ...
                ispCallXMLForm(parent.$g.xmlBPTlf_2014, parent.$g.xmlBPTlf_2014, "BPT_LF/BPTlfReturn_2014", "");

                var ResXML = parent.$g.xmlBPTlf_2014;
                $.ajax({
                    type: 'POST',
                    url: '../../Returns/Log',
                    data: '{ "OriginationFom" : "BPTLF-2014","ServiceName" : "RTTIE030","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldErrError, '', 0) != 0) {
                    ...
                    //--------------------------------------------
                    FieldLock(true);
                    $('#AppError').text(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldErrMessage, "", 0));
                    $('#btnBPTSubmit').attr('disabled', true);
                    $('#chkAmended_08').attr('disabled', true);
                    return;
                }
             
                //if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfRetStat, '', 0) == 'EZ') {
                //    parent.setFrameUrl('Returns/BPTez?y=' + 2015);
        ...
        function CheckBPTXML() {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfPeriod, '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfPeriod, '', 0)) < new Date(firstOfYear)) {

                bPeriodExist = false;

            }

            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfPeriod, '', 0) == '') {
                bPeriodExist = false;
            }

            if (bPeriodExist == false) {
                //error_info
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldErrProgram, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldErrError, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldErrLine, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldErrMessage, '', 0);
                //BPT_info	
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '12/31/' + (sCurrYear - 1), xFldInfPeriod, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfVer, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfRetStat, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfLastUpdDate, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfRecDate, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfExtDate, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfSeq, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfAdjRef, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfUserId, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfABtaxRate, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfDtaxRate, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfEmanTaxRate, '', 0);;
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfEwhoTaxRate, '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfEretTaxRate, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', xFldInfLossCarry, '', 0);
                //BPT_pg1
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li1, '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li2, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li3, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li4, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li5, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li6, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li7, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li8, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li9, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li10, '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li11, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li12, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li13, '', 0);
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, 0, xFldPg1Li14, '', 0);
                ...
                //
                ClearPreparerXML(parent.$g.xmlBPTlf_2014, xSecInfo);
            } //if
        } //CheckBPTXML
        ...
        function SetBPTFields() {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfVer, '', 0) == '') {
                FieldLock(false);
                $('#chkAmended').attr('disabled', true);
                chkTaxpayer.checked = false;
                
            }
            else if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfVer, '', 0) != '' && parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, 'BPT_INFO PREPARER_NAME', '', 0) == '') {
                ...
                if (PrepForMath(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScALi1, '', 0)) != 0) {
                    ...
                    if (PrepForMath(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi1, '', 0)) != 0) {
        ...
        function PopulateBPTData() {
            ...
            dBPTNetRate = parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfABtaxRate, '', 0);
            dBPTGrossRate = parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfDtaxRate, '', 0);
            dBPTManufacturerRate = parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfEmanTaxRate, '', 0);
            dBPTWholesaleRate = parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfEwhoTaxRate, '', 0);
            dBPTRetailerRate = parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfEretTaxRate, '', 0);
            //BPT_Pg1
            txtTermDate.value = "";
            $('#lblBPT1_1').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li1, '', 0), 0));
            $('#lblBPT1_2').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li2, '', 0), 0));
            $('#lblBPT1_3').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li3, '', 0), 0));

            txtBPT1_4.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li4, '', 0), 0);
            $('#lblBPT1_5').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li5, '', 0), 0));;
            txtBPT1_6a.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li6, '', 0), 0)
            txtBPT1_6b.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li7, '', 0), 0);
            $('#lblBPT1_6c').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li8, '', 0), 0));
            //EGOVWEB-60 Changed xFldPg1Li8 to xFldPg1Li9
            $('#lblBPT1_7').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li9, '', 0), 0));
            $('#txtBPT1_8').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li10, '', 0), 0));
            $('#lblBPT1_9').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li11, '', 0), 0));
            txtBPT1_10a.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li12, '', 0), 0);
            txtBPT1_10b.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li13, '', 0), 0);
            txtBPT1_10c.value = ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldPg1Li14, '', 0), 0);
            ...
            PopulatePreparer(parent.$g.xmlBPTlf_2014, xSecInfo);
        ...
        function btnBPTSubmit_onclick() {
            ...
            if ($('#AppError').text() == '') {
                ...
                setTimeout(function () { }, 3000);
                ispCallXMLForm(parent.$g.xmlBPTlf_2014, tempXML, "BPT_LF/BPTlfReturn_2014", "");

                

                //alert(parent.$g.xmlBPTlf_2014);
                //return;
                if (parent.$x.ispXmlGetFieldVal(tempXML, xFldErrProgram, '', 0) == '') {

                    parent.$g.xmlBPTlf_2014.loadXML(tempXML.xml);
                    var ResXML = tempXML;
                    $.ajax({
                        type: 'POST',
                        url: '../../Returns/Log',
        ...
        function DisplayBPTlfThankYou() {
            ...
            $('#lblAcctNo').text(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, 'BPT_INFO ACCOUNT_ID', '', 0));
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfAdjRef, '', 0) != '') {
                $('#lblConfirmNo').text(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfAdjRef, '', 0));
            } else {
                $('#lblConfirmNo').text("");
                ...
                $.ajax({
                    type: 'POST',
                    url: '../../Returns/Log',
                    data: '{ "OriginationFom" : "BPTLF-2014","ServiceName" : "RTTIE030"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg) {
        ...
        function chkAmended_08_onclick() {
            ...
            if ($('#chkAmended_08').is(':checked')) {
                ...
                //parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, "A1", "xFldInfRetStat", '', 0); //temporarily
                $('#btnNo').removeAttr('checked');
                $('#btnYes').removeAttr('checked');
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfRetStat, '', 0) == 'A1' || parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfRetStat, '', 0) == 'A2') {
            ...
            switch (iSch) {
                ...
                case "SchdC1":
                    ...
                    if (sPrevWrkSht == 'SCHDA') {
                        ...
                        $('#btnC1GoTo').click(Function('ShowPage("SchdA");'));
                        
                    } else {
                        $('#btnC1GoTo').val('Return to Schedule B');
                        $('#btnC1GoTo').click(Function('ShowPage("SchdB");'));
        ...
        function LoadError() {
            ...
            //BPT_Pg1	
            // arrPage1Err[i++] = [txtTermDate, '$(\'#txtTermDate\').val() != "" & ispValidateDate($(\'#txtTermDate\').val()) == false', 'Invalid termination date'];
        ...
        function PopulateXmlBPTlf() {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '12/31/' + (sCurrYear - 1), xFldInfPeriod, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT1_1').text()), xFldPg1Li1, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT1_2').text()), xFldPg1Li2, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT1_3').text()), xFldPg1Li3, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT1_4.value), xFldPg1Li4, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT1_5').text()), xFldPg1Li5, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT1_6a.value), xFldPg1Li6, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT1_6b.value), xFldPg1Li7, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT1_6c').text()), xFldPg1Li8, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT1_7').text()), xFldPg1Li9, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#txtBPT1_8').val()), xFldPg1Li10, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT1_9').text()), xFldPg1Li11, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT1_10a.value), xFldPg1Li12, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT1_10b.value), xFldPg1Li13, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency(txtBPT1_10c.value), xFldPg1Li14, '', 0);
            ...
            PopulatePreparerXML(parent.$g.xmlBPTlf_2014, xSecInfo);
          
          
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, '', 'DEBUG', '', 0);
        } //PopulateXmlBPTlf
            ...
            switch (formId) {
                ...
                case "BPT_SchdD":
                    ...
                    if (ObjSelected.id == "txtBPT_SchD_8" && PrepForMath(ObjSelected.value) > 0) {
                        alert('You have entered or changed an amount greater then 0 on line 8. \n' + 'You will have to fill out Schedule E');
                    } //if
                    break;
                case "BPT_SchdE":
        ...
        function CalcBPTlfPg1Line5() {
            ...
            if (txtBPT1_4.value != '') {
                ...
                $('#lblBPT1_5').text(ispFormatMoney(PrepForMath(val3) + PrepForMath(txtBPT1_4.value), 0));
            } //if
        } //CalcBPTlfPg1Line5
				                    ...
				                    <script>document.write(sCurrYear - 1)</script>
					                    ...
					                    enter the termination date here <u>AND</u> file a <a href="https://beta.phila.gov/media/20170207132309/Change-Form.pdf">CHANGE FORM</a>.</span></label>
                                                                ...
                                                                <div class="col-lg-2 new-margin-top-form wage-form-date no-padding-left" style="padding-right:0 !important;">
                                                                    <label>
                                                                        <span class="wage-from-date business-income-date-2014-from">
                                                                    <input class="inpNormal_custom date-input date-field-design business-income-date-2014" id="txtTermDate" onfocus="SetFocus()" placeholder="MM/DD/YYYY"
                                                ...
                                                <label class="lblLink label_NoLeft" style="width: 100%" onclick="ShowPage('SchdD')">Schedule D, Line 12</label>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">4.</td>
                                                                        <td width="70%" class="text-left"><b><u>MANDATORY</u> 2015 BIRT Estimated Payment <u>(See Instructions)</u> </b></td>
                                                                        <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">5.</td>
                                                                        <td width="70%" class="text-left">Total Due by <b>4/18/2015</b>[Calculated - add lines 3 and 4]</td>
                                                                        <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">6a.</td>
                                                                        <td width="70%" class="text-left">Credit from overpayment of 2013 or 2014 Net Profit Tax.</label> </td>
                                                                        <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">6b.</td>
                                                                        <td width="70%" class="text-left">Include any estimated and/or extension payments of 2014 BIRT previously made,
and any credit from overpayment of the 2013 BPT return</td>
                                                                        <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">8.</td>
                                                                         <td width="70%" class="text-left">Interest and Penalty <a href="https://beta.phila.gov/services/payments-assistance-taxes/paying-city-taxes/interest-penalties-and-fees/" target="_blank" style="color:red">(see Instruction)</a></td>                                                                       <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">

                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                                        <input id="txtBPT1_8" class="form-control input-sm pull-right" style="width: 100%;" />
                                                                                       <%-- <label id="lblBPT1_8" class="form-control input-sm pull-right" style="width: 70%;" />--%>
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">10b.</td>
                                                                        <td width="70%" class="text-left">Applied,to the 2014 Net Profits Tax Return</td>
                                                                        <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">
				...
				your account.</label>
                                        ...
                                        <% 
                                            ...
                                            Html.RenderAction("_14SchdA", "BPT_LF");//Changed by SumanG
                                            Html.RenderAction("_14SchdB", "BPT_LF");
                                            Html.RenderAction("_14SchdC1", "BPT_LF");
                                            Html.RenderAction("_14SchdD", "BPT_LF");
