                                	...
                                	<table class="table table-condensed table-striped custom_table03">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                     		...
                                     		<tr class="odd">
                                            	<td width="5%">4.</td>
                                                <td width="70%" class="text-left"> <B><U>MANDATORY</U> 2012 BIRT Estimated Payment <u>(repeat line 3)</u> </B></td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                            ...
                                            <tr>
                                            	<td width="5%">5.</td>
                                                <td width="70%" class="text-left">Total Due by <B>4/15/2012</B>[Calculated - add lines 3 and 4]</td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
			  ...
			  made,<br>and any credit from overpayment of the 2010 BPT return</td>
				...
				your account.</label>
                      ...
                      <% 
                          ...
                          Html.RenderAction("_11BIRT_19_3800Message", "BPT_LF");
