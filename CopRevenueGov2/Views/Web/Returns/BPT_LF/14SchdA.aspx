...
<head>
    ...
    <script language='javascript' type="text/javascript">
        ...
        function PopulateXmlBPTlfSchdA() {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchA_11').text()), xFldScALi11, '', 0);
        ...
        function RightAlignText_A() {//Added 
            ...
            $('#lblBPT_SchA_13').parent().css("text-align", "right");
        ...
        function PopulateBPTlfSchdA() {
            ...
            $('#lblBPT_SchA_6').text(parseFloat(ispRemoveMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScALi6, '', 0)) / 10000).toFixed(6));//updated by SumanG
            ...
            $('#lblBPT_SchA_11').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfLossCarry, '', 0), 0));
        ...
        function ResetBPTlfSchdA() {
            ...
            $('#lblBPT_SchA_11').text(ispFormatMoney(0, 0)); //txtBPT_SchA_11.value = ispFormatMoney(0, 0);
        ...
        function CalcBPTlfSchdALine12() {
            ...
            if ($('#lblBPT_SchA_9').text() != '' && $('#lblBPT_SchA_11').text() != '') {
                $('#lblBPT_SchA_12').text(ispFormatMoney(PrepForMath($('#lblBPT_SchA_9').text()) -
                        PrepForMath($('#lblBPT_SchA_10').text()) - PrepForMath($('#lblBPT_SchA_11').text()), 0));
                //
            ...
            <div class="col-lg-12 templateclass">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-condensed table-striped custom_table03 wage-table-print">
                        ...
                        <thead>
                            <tr>
                                <th colspan="3" width="100%" class="slim-headings"><u>2014 BIRT Schedule A: Computation of Tax On Net Income(Method I)</u></th>
				...
				deducted in arriving at Net Income, less total nonbusiness income</td>
                            ...
                            <tr>
                                ...
                                <td width="25%" class="text-left">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group no-margin">
                                            <div class="">
                                                <%--<input class="form-control input-sm" id="txtBPT_SchA_11" type="text" style="width: 100%" onfocus="SetFocus()" maxlength="10" onchange="ValidateWorksheet('BPT_SchdA')">--%>
                            ...
                            <tr>
                                ...
                                <td width="70%" class="text-left">
                                    <label id="msgBPT_SchA_13" class=""><b>TAX DUE</b> (Multiply Line 12 by ###) If Line 14 is a loss, enter zero</label></td>
                                <td width="25%" class="text-left">
                                    <form class="form-horizontal">
