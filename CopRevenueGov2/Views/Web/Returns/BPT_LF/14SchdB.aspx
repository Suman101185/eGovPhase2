...
<head>   
    ...
    <script language='javascript' type="text/javascript">
        ...
        function PopulateXmlBPTlfSchdB() {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#lblBPT_SchB_11').text()), xFldScBLi11, '', 0);
        ...
        function PopulateBPTlfSchdB() {
            ...
            //
            $('#lblBPT_SchB_6').text(parseFloat(ispRemoveMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScBLi6, '', 0)) / 10000).toFixed(6));//Updated by SumanG
            ...
            $('#lblBPT_SchB_11').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldInfLossCarry, '', 0), 0));
        ...
        function CalcSchdBLine12() {
            ...
            if ($('#lblBPT_SchB_9').text() != '' && $('#lblBPT_SchB_10').text() != '') {
                $('#lblBPT_SchB_12').text(ispFormatMoney(PrepForMath($('#lblBPT_SchB_9').text()) - PrepForMath($('#lblBPT_SchB_10').text())
                    - PrepForMath($('#lblBPT_SchB_11').text()), 0));
    ...
    <div id="BPT_SchdB" style="DISPLAY: none;">
     <div class="col-lg-12 col-md-12">   
                	...
                	<div class="col-lg-12 templateclass">
                                ...
                                <div class="table-responsive">
                                	...
                                	<table class="table table-condensed table-striped custom_table03 wage-table-print">
                                    	...
                                    	<thead>
                                        	<tr>
                                            	<th colspan="3" width="100%" class="slim-headings"><B>2014 BIRT Schedule B: Computation of Tax On Net Income(Method II)</B></th>
				...
				onfocus=SetFocus() maxLength=10 onchange=ValidateWorksheet("BPT_SchdB")>
                                            ...
                                            <tr>
                                            	<td widh="5%">10.</td>
                                               <%-- <td style="width:70%" class="text-left">Statutory Net Income Deduction  (from 
                                        <label id="lblLnkBWRKS" class="lblLink" style="width:100%" onclick="ShowPage('WRKSB')">Worksheet S, Line S5</label>
                                        
			                                ).</td>--%>
                                                <td widh="70%" class="text-left">Statutory Net Income Deduction </td>
                                                <td widh="25%" class="text-left">
                                               		<form class="form-horizontal">
