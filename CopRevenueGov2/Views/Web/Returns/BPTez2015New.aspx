...
<script id="clientEventHandlersJS" language="javascript" type="text/javascript">
    ...
    function DisplayBPTezReturn() {
        ...
        if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('24')")) {          
            ...
            $('#AppHeader').html('Business Income & Receipts Tax-EZ for 2015');
           
            parent.gsInstructionItem = '#BIR';
            $('#AppMessage').html('The Business Income & Receipts Tax for 2015 is due April 18, 2016.');           
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "EZ-2015","ServiceName" : "RTTIE037","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "EZ-2015","ServiceName" : "RTTIE037","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
    ...
    function btnBPTezSubmit_onclick() {
        ...
        if (cCur($('#txt_BPT_WSEZ1').val()) > cCur($("#lblBPTez2_8").text())) {
            if (cCur($('#txt_BPT_WSEZ1').val()) != 75000) {
                $("#AppError").text('S1 value must be lower of Line 8 of Page 2 or $75,000');
                resolvedIframeheight();
                parent.ScrollTop(1);
            }
    ...
    function CalcPage2Line8() {      
        if ($('#txtBPTez2_7a').val() != "" && $('#txtBPTez2_7b').val() != "" && $('#txtBPTez2_7c').val() != "" &&
            ...
            if (cCur($('#lblBPTez2_9').text()) > 75000) {
                $('#lblBPTez2_9').text(ispFormatMoney(75000, 0));
    ...
    function CalcPage2Line9() {
        ...
        if (cCur($('#lbBPTez2_9').text()) > cCur($("#lblBPTez2_8").text())) {
            if (cCur($('#lblBPTez2_9').text()) != 75000) {
                $("#AppError").text('Line 9 value must be lower of Line 8 or $75,000');
                resolvedIframeheight();
                parent.ScrollTop(1);
            }
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-sm-12" style="display:none">
                            <label class="control-label text-custom-left2 no-padding" for="inputEmail3">
                                <span class="custom_padding_span"> If your business terminated in 2015, enter the termination date AND file a CHANGE FORM. 
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                             <td width="5%">3.</td>
                                            <td width="70%" class="text-left"> Tax Due for the 2015 Business Income & Receipts Tax [Calculated -  add lines 1 and 2] </td>
                                            <td  width="25%" class="text-left">
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                             <td width="5%">4.</td>
                                            <td width="70%" class="text-left"> <B><U>MANDATORY</U> 2016 BIRT Estimated Payment (repeat line 3)</B></td>
                                            <td width="25%" class="text-left">                                               
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                             <td width="5%">5.</td>
                                            <td width="70%" class="text-left"> Total Due by 4/18/2016 [Calculated - add lines 3 and 4] </td>
                                            <td width="25%" class="text-left">                                             
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                       ...
                                       <thead>
                                        ...
                                        <tr>
                                             <td width="5%">6a.</td>
                                            <td width="70%" class="text-left"> <B>Include any estimated and/or extension payments of 2015 BIRT previously made, <br/>and any credit from overpayment of the 2014 BIRT and/or 2015 NPT return</B>  </td>
                                            <td width="25%" class="text-left">                                             
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                             <td width="5%">10b.</td>
                                            <td width="70%" class="text-left"> Applied, up to the tax due, to the 2015 Net Profits Tax Return</td>
                                            <td width="25%" class="text-left">                                               
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                             <td width="5%">10c.</td>
                                            <td width="70%" class="text-left"> Applied to the 2016 Business Income & Receipts Tax</td>
                                            <td width="25%" class="text-left">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                ...
                                <input type="button" value="Submit" class="btn btn-default submit_button" id="btnBPTezSubmit" onclick="return btnBPTezSubmit_onclick()" />
                                                 ...
                                                 <div class="col-md-12">
                                                    <div style="margin-left: 5px; font-size: 12px;" class="here_input_table sit_here_input_table">
                                                        <label>
                                                            DO NOT FILE THIS RETURN if you have no taxable activity. If you registered for 
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print wage-table-print-for-ez">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                             <td width="5%">6.</td>
                                            <td width="70%" class="text-left"> TAX DUE [Calculated - line 5 * 0.0641].</td>
                                            <td width="25%" class="text-left">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                       ...
                                       <thead>
                                        ...
                                        <tr >
                                         ...
                                         <tr >
                                              <td width="5%">9.</td>
                                            <td width="70%" class="text-left"> <b>Statutory Exclusion (Lower of Line 8 or $75,000.00)</b></td>
                                            <td width="25%" class="text-left">                                
                                                
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                                      <label id="lblBPTez2_9" style="WIDTH: 90%;" class="form-control input-sm pull-right" />
