...
<head runat="server">
    ...
    <script ID="clientEventHandlersJS" LANGUAGE="javascript" type="text/javascript">
        ...
        function DisplayWageThankYou() {
            ...
            var container = $('#divWageThankYou').css("height");
        ...
        function DoPrintCoupon() {
            ...
            generate('204' + strScanLine);            
            tempParameters = 'a=' + strAcctID + '&b=' + strAccountName + '&c=' + strAccountAddr + '&d=' + strScanLine + '&e=' + strPeriod + '&f=' + strAcctType + '&h=' + '../Uploads/Wage' + "_" + strAcctID + '.png' + '&i=' + 'ThankYou' + '&g=' + strAccountAddr + '|' + strAccountAddr2 + '|' + strAccountAddr3 + '|' + strAccountCity + '|' + strAccountState + '|' + strAccountZip
        ...
        function generate(data) {
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Upload',
                data: '{ "imageData" : "' + link + '","AccountId":"' + strAcctID + '","Form":"Wage" }',
        ...
        function DoPrint() {
            ...
            $('#btnWageThankYou').css('visibility', 'hidden');
            window.print();
            $('#btnPrint').css('visibility', 'visible');
            $('#btnWageThankYou').css('visibility', 'visible');
        }
