...
<script id="clientEventHandlersJS" language="javascript">
    ...
    function DisplayWage08Return() {
        ...
        resolvedIframeheight();
        $('#AppHeader').html('wage tax reconciliation return for 2010');
        parent.gsInstructionItem = '#WageReturn';

        $('#AppMessage').html('<BR>The Reconciliation of Wage Tax for 2010 is due February 28, 2011.');
...
<body>
            ...
            <div class="container-fluid">
                                                    ...
                                                    <div class="row table-responsive">
                                                        ...
                                                        <table class="table table-condensed table-striped custom_table03">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                     <td width="5%">A.</td>
                                                                    <td width="70%" class="text-left">Enter the number of Philadelphia Residents for whom wage tax was remitted for the pay period including March 12, 2010. </td>
				...
				Philadelphia (1/1/2010 to 06/30/2010)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr>
                                                                     <td width="5%">5.</td>
                                                                    <td width="70%" class="text-left">Tax Due [Calculated - line 4 X .039296] </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
				...
				Philadelphia (7/1/2010 to 12/31/2010)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr>
                                                                     <td width="5%">7.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line 6 X .039280]&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">                                                                                
      ...
      <U>non-residents</U>      of 
				Philadelphia (1/1/2010 to 06/30/2010)&nbsp;</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr>
                                                                     <td width="5%">9.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line&nbsp;8 X .034997]</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
      ...
      <U>non-residents</U>      of 
				Philadelphia (7/1/2010 to 12/31/2010)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr>
                                                                     <td width="5%">11.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line 10 X .034985]&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr>
                                                                     <td width="5%">13.</td>
                                                                    <td width="70%" class="text-left">Tax previously paid for 2010  <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
    ...
    ispDisplayProgress('btnWage08Submit_onclick()', 'Submitting 2010 wage tax information')" />                  
