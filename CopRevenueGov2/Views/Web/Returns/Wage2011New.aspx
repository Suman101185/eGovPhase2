...
<head>
   ...
   <script id="clientEventHandlersJS" language="javascript">
    ...
    function DisplayWage08Return() {
        ...
        resolvedIframeheight();
        $('#AppHeader').html('wage tax reconciliation return for 2011');
        parent.gsInstructionItem = '#WageReturn';

        $('#AppMessage').html('<BR>The Reconciliation of Wage Tax for 2011 is due February 28, 2012.');
    ...
    function CalcGrossComp() {
        if (parseCurrency($('#txtWageNo1_08').val()) != (parseCurrency($('#txtWageNo2_08').val()) + parseCurrency($('#txtWageNo4_08').val()) + parseCurrency($('#txtWageNo6_08').val()) + parseCurrency($('#txtWageNo8_08').val()) + parseCurrency($('#txtWageNo10_08').val()))) {
    ...
    <div class="container-fluid no-padding" id="WageReturn_08">
        <div class="block3">
            <div class="container-fluid">
                                                    ...
                                                    <div class="row table-responsive">
                                                        ...
                                                        <table class="table table-condensed table-striped custom_table03">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                     <td width="5%">A.</td>
                                                                    <td width="70%" class="text-left">Enter the number of Philadelphia Residents for whom wage tax was remitted for the pay period including March 12, 2011. </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input class="form-control input-sm pull-right" id="txtWageNo1_08" onchange="ValidateWage08Prelim()" 
				...
				Philadelphia (1/1/2011 to 06/30/2011)</td>--%>
				...
				Philadelphia in 2011</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr class="odd" style="display:none">
                                                                     <td width="5%">6.</td>
                                                                    <td width="70%" class="text-left">Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (7/1/2011 to 12/31/2011)</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
      ...
      <U>non-residents</U>      of 
				Philadelphia (7/1/2011 to 12/31/2011)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr>
                                                                     <td width="5%">9.</td>
                                                                    <td width="70%" class="text-left">Tax previously paid for 2011  <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
						...
						<br>Click on link for more information.</label></td>
                                                                ...
                                                                <tr class="odd">
                                                                     <td width="5%">10.</td>
                                                                    <td width="70%" class="text-left">ADDITIONAL TAX DUE If line 8 is greater than line 9,
				...
				enter the amount here. See instructions for filing a Refund Petition.</td>
                                                 ...
                                                 <div class="col-lg-12">
                                                  ...
                                                  <div class="col-sm-offset-3 col-sm-9  text-right">
                                                      <input id="btnWage08Print" type="button" value="Print" class="btn btn-default submit_button_light" onclick="btnWage08Print_onclick()" />
                                               <input type="button" value="Submit" class="btn btn-default submit_button" id="btnWage08Submit" onclick="btnWageValidate();
    ispDisplayProgress('btnWage08Submit_onclick()', 'Submitting 2011 wage tax information')" />                  
