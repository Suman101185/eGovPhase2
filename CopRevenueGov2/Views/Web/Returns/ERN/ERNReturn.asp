...
inAcctNo = parent.$x.ispXmlGetFieldVal(xmlReqDoc, "ERN_INFO/ACCOUNT_ID", "", 0)
lsFunction = parent.$x.ispXmlGetFieldVal(xmlReqDoc, "ERN_INFO/RETURN_STATUS", "", 0)

set objERNReturn = CreateObject("EOL.ERNForm")
if objERNReturn is nothing then
	DoError "ERNReturn.asp", "5030001", "", _
...
if parent.$x.ispXmlGetFieldVal(xmlOut, "ERN_INFO/ACCOUNT_ID", "", 0) = "" then
	parent.$x.ispXmlSetFieldVal xmlOut, inAcctNo, "ERN_INFO/ACCOUNT_ID", "", 0
end if

parent.$x.ispXmlSetFieldVal xmlOut, lsFunction, "ERN_INFO/RETURN_STATUS", "", 0

LogInformation xmlOut, msApp, "Response"
parent.$x.ispXmlSetFieldVal xmlReqDoc, gsDebugUp, "DEBUG", "", 0
...
Sub CallRTTIE028()
	...
	'
		...
		elseif objERNReturn.ErrorNumber <> 0 then
			DoError "ERNReturn.asp", "5030003:" & objERNReturn.ErrorNumber, _
...
'Err.Description
	if iTry = 5 then
		DoError "ERNReturn.asp", "5030004", "", _
	...
	parent.$x.ispXmlSetFieldVal xmlOut, sma & eERN & page1, "DEBUG", "", 0	
