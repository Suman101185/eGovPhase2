...
<script runat="server">
    ...
    void CallRttie037()
    {
        xmlOut = RTTIE037_2015.CallService(xmlReqDoc);
...
<%
    ...
    rev_func_srv.CreateXmlBufferObj(xmlOut, util.GetXMLString(Server.MapPath(@"~/views/web/xml/BPTezReturn_2015.xml")), false);
