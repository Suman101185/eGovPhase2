...
<script runat="server">
    ...
    void CallRttie037()
    {
        xmlOut = RTTIE037_2016.CallService(xmlReqDoc);
...
<%
    ...
    rev_func_srv.CreateXmlBufferObj(xmlOut, util.GetXMLString(Server.MapPath(@"~/views/web/xml/BPTezReturn_2016.xml")), false);
