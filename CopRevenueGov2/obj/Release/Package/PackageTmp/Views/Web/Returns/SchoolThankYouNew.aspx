...
<script id="clientEventHandlersJS" language="javascript">
    ...
    function DisplaySchoolThankYou() {
        ...
        var container = $('#divSchoolThankYou').css("height");
    ...
    function DoPrintCoupon() {
        ...
        if (strAcctType == '11') {
            ...
            strScanLine = '333' + strAcctType + HoldDate + '00' + '00000' + strScanID + '000000000000000000' + strPayPeriod + twoyear + '0000000000000000'//Newly added for change request 
        ...
        generate('210' + strScanLine);        
        tempParameters = 'a=' + strAcctID + '&b=' + strAccountName + '&c=' + strAccountAddr + '&d=' + strScanLine + '&e=' + strPeriod + '&f=' + strAcctType + '&h=' + '../Uploads/School Income Tax' + "_" + strAcctID + '.png' + '&i=' + 'ThankYou' + '&g=' + strAccountAddr + '|' + strAccountAddr2 + '|' + strAccountAddr3 + '|' + strAccountCity + '|' + strAccountState + '|' + strAccountZip
    ...
    function generate(data) {
        ...
        $.ajax({
            type: 'POST',
            url: '../Returns/Upload',
            data: '{ "imageData" : "' + link + '","AccountId":"' + strAcctID + '","Form":"School Income Tax" }',
    ...
    function DoPrint() {        
        ...
        $('#btnSchoolThankYou').css('visibility', 'hidden');
        window.print();
        $('#btnPrint').css('visibility', 'visible');
        $('#btnSchoolThankYou').css('visibility', 'visible');
    }
                    ...
                    <div class="row">
                       ...
                       <div class="well" style="padding-bottom:2px !important; padding-top:2px !important; margin-bottom:5px !important;">
                            <div class="row">
                             ...
                             <p>Coupon: <a class="btn btn-default submit_button" id="btnPrintCoupon" style="margin-top:0 !important;" onclick="DoPrintCoupon()">Print Coupon </a>
                            ...
                            <form class="form-horizontal school_form">
                                ...
                                <div class="form-group submit-button-for-print">
                                    <div class="col-sm-offset-3 col-sm-9  text-right">
                                         <input type="button" class="btn btn-default submit_button" value="Print" id="btnPrint" name="btnSchoolThankYou" onclick="DoPrint()" />
