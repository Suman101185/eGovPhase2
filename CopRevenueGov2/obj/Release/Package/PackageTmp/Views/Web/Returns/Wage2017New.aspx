  ...
  */
    ...
    function DisplayWage08Return() {
        ...
        if (parent.$x.ispXmlSetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT[ACCOUNT = "1"]', '', 0)) {           
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlWage, '12/31/2017', 'WAGE_INFO PERIOD', '', 0);
            ...
            $.ajax({
                type: 'POST',
                url:'../Returns/Log',
                data: '{ "OriginationFom" : "Wage-2017","ServiceName" : "RTTIE027","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "Wage-2017","ServiceName" : "RTTIE027","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
        ...
        $('#WageReturn_08').css('display', 'block');
        resolvedIframeheight();
        $('#AppHeader').html('wage tax reconciliation return for 2017');
        parent.gsInstructionItem = '#WageReturn';       
        $('#AppMessage').html('The Reconciliation of Wage Tax for 2017 is due February 28, 2018.');
    ...
    function CheckWage08XML() {
        ...
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'WAGE_INFO PERIOD', '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'WAGE_INFO PERIOD', '', 0)) < new Date('01/01/2017')) {
            bPeriodExist = false
        }
    ...
    <div class="container-fluid no-padding" id="WageReturn_08">
        ...
        <div class="block3">
            ...
            <div class="container-fluid">
                                                        ...
                                                        <div class="form-group topsmallform" style="margin-bottom:0px;">
                                                            ...
                                                            <div class="col-sm-9 newtop_padding" style="display:none"">
                                                                ...
                                                                <label  class="text-custom-left2" for="inputEmail3" >
                                                                    <span class="custom_padding_span">If you were a partial year resident in 2017, enter dates of residency :</span></label></div><div class="col-sm-5 new-margin-top-form wage-form-date"><label><span class="wage-from-date"> From: 
                                                                   </span>
                                                   ...
                                                   <div class="row table-responsive">
                                                        ...
                                                        <table class="table table-condensed table-striped custom_table03 wage-table-print">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td width="5%">A.</td>
                                                                    <td width="70%" class="text-left">Enter the number of Philadelphia Residents for whom wage tax was remitted for the pay period including March 12, 2017. </td>
				...
				quarter of 2017 (for the pay period including March 12, 2017). </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
				...
				Philadelphia city limits</strong>, for the pay period including March 12, 2017.</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
...
was not withheld</td>
				...
				Philadelphia (1/1/2017 to 06/30/2017)</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr class="">
                                                                    <td width="5%">6.</td>
                                                                    <td width="70%" class="text-left">Tax Due [Calculated - line 5 X .039004] </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr class="odd">
                                                                    <td width="5%">7.</td>
                                                                    <td width="70%" class="text-left">Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (7/1/2017 to 12/31/2017)</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr>
                                                                    <td width="5%">8.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line 7 X .038907]&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
      ...
      <U>non-residents</U>      of 
				Philadelphia (1/1/2017 to 06/30/2017)&nbsp;</td>
                                                                ...
                                                                <tr>
                                                                    <td width="5%">10.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line&nbsp;9 X .034741]</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
      ...
      <U>non-residents</U>      of 
				Philadelphia (7/1/2017 to 12/31/2017)</td>
                                                                ...
                                                                <tr>
                                                                    <td width="5%">12.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line 11 X .034654]&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr>
                                                                    <td width="5%">14.</td>
                                                                    <td width="70%" class="text-left">Tax previously paid for 2017  <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
    ...
    ispDisplayProgress('btnWage08Submit_onclick()', 'Submitting 2017 wage tax information')" />                  
