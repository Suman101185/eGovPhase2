   ...
   <script id="clientEventHandlersJS" language="javascript">
    ...
    function DisplayWage08Return() {
        ...
        if (parent.$x.ispXmlSetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT[ACCOUNT = "1"]', '', 0)) {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlWage, '12/31/2012', 'WAGE_INFO PERIOD', '', 0);
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "Wage-2012","ServiceName" : "RTTIE027","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "Wage-2012","ServiceName" : "RTTIE027","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
        ...
        resolvedIframeheight();
        $('#AppHeader').html('wage tax reconciliation return for 2012');
        parent.gsInstructionItem = '#WageReturn';

        $('#AppMessage').html('<BR>The Reconciliation of Wage Tax for 2012 is due February 28, 2013.');
    ...
    function CheckWage08XML() {
        ...
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'WAGE_INFO PERIOD', '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'WAGE_INFO PERIOD', '', 0)) < new Date('01/01/2012')) {
            bPeriodExist = false
        }
    ...
    function PopulateWage08Data() {
        ...
        $('#txtWageNo6_08').val(ispFormatMoney(0, 0), 0);
        ...
        $('#txtWageNo10_08').val(ispFormatMoney(0, 0), 0);
        ...
        if ((parseCurrency($('#lblWageNo5_08').text()) != 0) || (parseCurrency($('#lblWageNo7_08').text()) != 0) || (parseCurrency($('#lblWageNo9_08').text()) != 0) || (parseCurrency($('#lblWageNo11_08').text()) != 0) || (parseCurrency($('#lblWageNo12_08').text()) != 0) || (parseCurrency($('#lblWageNo13_08').text()) != 0)) {
            ...
            if ($("#AppError").text() == '') {
                ...
                if (parseCurrency($('#txtWageNo4_08').val()) == 0 && parseCurrency($('#txtWageNo6_08').val()) == 0 && parseCurrency($('#txtWageNo8_08').val()) == 0 && parseCurrency($('#txtWageNo10_08').val()) == 0) {
                    ...
                    $("#AppError").text('Lines 4 & 6 can not all equal 0');
                    $('#txtWageNo4_08').attr('class', 'inpNormal form-control input-sm pull-right');
    ...
    function CalcGrossComp() {
        if (parseCurrency($('#lblWageNo3_08').text()) != (parseCurrency($('#txtWageNo4_08').val())+parseCurrency($('#txtWageNo8_08').val()))) {
            //$('#txtWageNo1_08').attr('class', 'inpError form-control input-sm pull-right');
            $("#AppError").text('Line 3 is not equal to the sum of lines 4,6');
    ...
    <div class="container-fluid no-padding" id="WageReturn_08">
        <div class="block3">
            <div class="container-fluid">
                                        ...
                                        <div class="col-lg-12">                                        
                                            ...
                                            <div class="row">
                                                        ...
                                                        Check if amended return.</label>
                                                            ...
                                                            <div class="col-sm-8"> <label class="" style="color: Red; width: 100%">All decimals will be rounded to the nearest whole number</label></div>
                                                    ...
                                                    <div class="row table-responsive">
                                                        ...
                                                        <table class="table table-condensed table-striped custom_table03 wage-table-print">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                     <td width="5%">A.</td>
                                                                    <td width="70%" class="text-left">Enter the number of Philadelphia Residents for whom wage tax was remitted for the pay period including March 12, 2012. </td>
				...
				quarter of 2012 (for the pay period including March 12, 2012). </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
				...
				Philadelphia city limits</strong>, for the pay period including March 12, 2012.</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
				...
				Philadelphia (1/1/2012 to 06/30/2012)</td>--%>
                                                                    <td width="70%" class="text-left">Total Taxable Compensation paid to residents of 
				Philadelphia in 2012</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr>
                                                                     <td width="5%">5.</td>
                                                                    <td width="70%" class="text-left">Tax Due [Calculated - line 4 X .039280] </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr class="odd" style="display:none">
                                                                     <td width="5%">6.</td>
                                                                    <td width="70%" class="text-left">Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (7/1/2012 to 12/31/2012)</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr style="display:none">
                                                                     <td width="5%">7.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line 6 X .039240]&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">                                                                                
      ...
      <U>non-residents</U>      of 
				Philadelphia (1/1/2012 to 06/30/2012)&nbsp;</td>--%>
                                                                     <td width="70%" class="text-left">Total Taxable Compensation paid to non-residents of 
				Philadelphia in 2012</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr>
                                                                     <td width="5%">7.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line&nbsp;8 X .034985]</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
      ...
      <U>non-residents</U>      of 
				Philadelphia (7/1/2012 to 12/31/2012)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr style="display:none">
                                                                     <td width="5%">11.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line 10 X .034950]&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr class="odd">
                                                                     <td width="5%">8.</td>
                                                                    <td width="70%" class="text-left">Total Tax Due[Calculated - lines 5 and 7]</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr>
                                                                     <td width="5%">9.</td>
                                                                    <td width="70%" class="text-left">Tax previously paid for 2012  <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
					...
					Click on link for more information.</label></td>
                                                                ...
                                                                <tr class="odd">
                                                                     <td width="5%">10.</td>
                                                                    <td width="70%" class="text-left">ADDITIONAL TAX DUE If line 8 greater than line 9,
				enter the amount here.</td>
                                                                ...
                                                                <tr>
                                                                     <td width="5%">11.</td>
                                                                    <td width="70%" class="text-left">TAX OVERPAID If line 8 is less than line 9,
				enter the amount here. See instructions for filing a Refund Petition.</td>
                                               ...
                                               <input type="button" value="Submit" class="btn btn-default submit_button" style="margin-top:3px !important;" id="btnWage08Submit" onclick="btnWageValidate();
    ispDisplayProgress('btnWage08Submit_onclick()', 'Submitting 2012 wage tax information')" />                  
