...
<head>
    ...
    <script language='javascript' type="text/javascript">
        ...
        function CalcSchdDLine6() {
            ...
            if (PrepForMath($('#lblBPT_SchD_6').text()) < 75000) {
                $('#lblBPT_SchD_7').text($('#lblBPT_SchD_6').text());
            } else {
                $('#lblBPT_SchD_7').text(ispFormatMoney(75000, 0));
            } 	//if
...
<body>
   <div id="BPT_SchdD" style="display: none;">
                        ...
                        <div class="col-lg-12 templateclass">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-condensed table-striped custom_table03 wage-table-print bptlf-sched-page-table bptlf-inner-page-print">
                                    ...
                                    <thead>
                                        <tr>
                                            <th colspan="3" width="100%" class="slim-headings"><b>2015 BIRT Schedule D: Computation Of Tax On Gross Receipts</b></th>
    ...
    business capital assests</td>
                                        ...
                                        <tr class="odd">
                                            <td width="5%">7.</td>
                                            <td width="70%" class="text-left">Statutory Exclusion 	[Calculated - Lower of Line 6 or $75,000.00]
                                        </td>
                                            <td width="25%" class="text-left">
                                                <form class="form-horizontal">
