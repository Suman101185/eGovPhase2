...
<head>
    ...
    <body>
<div class="container-fluid no-padding" id="NPT_2014" style="DISPLAY: none;" >
<div class="block3">
     ...
     <div class="inner_white-panel">
            ...
            <%--  Adress End--%>    
               ...
               <div class="col-lg-12 templateclass">     
                    <div id="NPT_BPT_msg" style="DISPLAY: none;" VISIBILTY: visible" name="NPT_BPT_msg" align="center">
                                ...
                                <br>
                                <br>
                                Your 2014 BIRT return must be filed prior to filing your 2014 NPT Return.<br>
        To fill out your 2014 BIRT form, Please select BIRT from the side menu.
                    ...
                    <form class="form-horizontal ">                     
                        ...
                        <div class="col-sm-7 col-md-7 col-xs-7 newtop_padding">
                                <label class="control-label text-custom-left2" for="inputEmail3">
                                    <span class="pull-right">If your business terminated in 2014, enter the termination date here:</span>
                                                                   
                                </label>
                            </div>
                            <div class="col-sm-2 col-md-2 col-xs-2 newtop_padding custom-margin-npt" style="padding-left:0;">
                                 <input  class="inpNormal_custom date-input  date-field-design pull-right" id="txtTermDate" placeholder="MM/DD/YYYY" <%--onchange='ValidateWorksheet("Page1")'--%> maxlength="10" style="WIDTH: 100%;"
               ...
               <div class="col-lg-12 templateclass">
                ...
                <%Html.RenderAction("_14WrkA", "NPT"); %>
                <%Html.RenderAction("_14WrkB", "NPT"); %>
                <%Html.RenderAction("_14WrkC", "NPT"); %> 
                <%Html.RenderAction("_14WrkD", "NPT");%>
                <%Html.RenderAction("_14WrkE", "NPT"); %>
                <%Html.RenderAction("_14WrkK", "NPT");%>
                <%Html.RenderAction("_14Page4", "NPT");%>
                <%Html.RenderAction("_14WrkExtension", "NPT");%>
