       ...
       <div class="col-lg-12" >
        ...
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
            ...
            <tbody>
                ...
                <tr>
                     <td width="5%">1.</td>
                    <td width="70%">2010 Estimated Net Profits Tax Payments</td>
                    <td style="width:25%">                       
                ...
                <tr class="odd">
                   ...
                   <td style="width:70%">Payments of 2010 Net Profits Tax made with  Application for Extension  of Time to File
               ...
               <%--<label class="form-control input-sm pull-right" style="WIDTH: 70%;" id="lblNPT_WrkE_2" />--%>
                ...
                <tr>
                     <td width="5%">3.</td>
                    <td width="70%">Overpayment of 2010 Business Privilege Tax or 2009 Net Profits Tax to be applied to this tax returnOverpayment of 2010 Business Privilege Tax or 2009 Net Profits Tax to be applied to this tax return</td>
                    <td style="width:25%">                       
                         <div class="form-horizontal">
                      <div class="form-group no-margin">
                        <div class="">
                   <input type="text" class="form-control input-sm pull-right" style="WIDTH: 70%;" id="txtNPT_WrkE_3" onfocus="SetFocus()" maxlength="10" onchange='ValidateWorksheet("WrkE")'>
                    ...
                    <tr class="odd">
                         <td width="5%">4.</td>
                    <td width="70%">Total of lines 1 through 3. Enter here and on Page 1, Line 6b [Calculated - Add lines 1 through 3]
