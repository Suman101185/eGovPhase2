    ...
    <script id="clientEventHandlersJS" language="javascript" type="text/javascript">
        ...
        function DisplaySchool08Return() {
            ...
            if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('29')")) {             
                ...
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlSchool, '12/31/2017', 'SCHOOL_INFO PERIOD', '', 0)

                var ReqXML = parent.$g.xmlSchool;
                $.ajax({
                    type: 'POST',
                    url: '../Returns/Log',
                    data: '{ "OriginationFom" : "SIT-2017","ServiceName" : "RTTIE036","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
                ...
                var ResXML = parent.$g.xmlSchool;
                $.ajax({
                    type: 'POST',
                    url: '../Returns/Log',
                    data: '{ "OriginationFom" : "SIT-2017","ServiceName" : "RTTIE036","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'ERROR_INFO ERROR', "", 0) != 0) {
                    ...
                    $('#AppHeader').html('school income tax return for 2017');
            ...
            $('#AppMessage').html('The School Income Tax for 2017 is due April 17, 2018.');           
            LoadSchool08Error();
            RightAlignText();
            CheckSchool08XML();
            SetSchool08Fields();
        ...
        function CheckSchool08XML() {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'SCHOOL_INFO PERIOD', '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'SCHOOL_INFO PERIOD', '', 0)) < new Date('01/01/2017')) {
                bPeriodExist = false
            } //if
        ...
        function PopulateSchool08Data() {
            ...
            $('#lblSchoolNo13_08').text(ispFormatMoney(
        ...
        function PopulateSchool08XML() {          
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlSchool, stripCurrency($('#lblSchoolNo13_08').text()), 'AMT_INFO CREDITS', '', 0)
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlSchool, stripCurrency($('#lblSchoolNo14_08').text()), 'AMT_INFO TAX_DUE', '', 0);//Changed by SumanG
        ...
        function RightAlignText() {
            ...
            var lblSchoolNo13_08 = document.getElementById('lblSchoolNo13_08');
            ...
            ispAlignRight(lblSchoolNo13_08);
        ...
        function LoadSchool08Error() {
            ...
            arrSchool08DateErr[i++] = [txtTerminationDate, '$(\'#txtTerminationDate\').val() != "" & ispValidateDate($(\'#txtTerminationDate\').val()) == false', 'Invalid Termination date.'];
        ...
        function btnSchool08Submit_onclick() {           
            if ($("#AppError").text() == '') {
                ...
                if ($("#AppError").text() == '') {
                    ...
                    ispCallXMLForm(parent.$g.xmlSchool, tempXML, "SchoolReturn", "")
                    parent.$g.xmlSchool = tempXML;
                    var ResXML = parent.$g.xmlSchool;
                    $.ajax({
                        type: 'POST',
                        url: '../Returns/Log',
        ...
        function txtTerminationDate_onblur() {           
            if ($("#AppError").text() == "" && $('#txtTerminationDate').val() != '') {
                var strBD = ispValidateDate($('#txtTerminationDate').val());

                if (strBD == false) {
                    $("#AppError").text('Invalid Termination date');                  
                    blnErr = true
                } else {                  
                    $('#txtTerminationDate').val(strBD);
                } //if
            }           
        } //txtTerminationDate
        ...
        function CalcLine14() {          
            if ($('#lblSchoolNo13_08').text() == '') {
                $('#lblSchoolNo13_08').text(ispFormatMoney(0, 0));
            }
            var val_12 = ispRemoveMoney($('#lblSchoolNo12_08').text());
            var val_13 = ispRemoveMoney($('#lblSchoolNo13_08').text());
        ...
        function CalcLine14_15_old() {
            ...
            if ($('#lblSchoolNo13_08').text() == '') {
                ...
                $('#lblSchoolNo14_08').text(ispFormatMoney(ispRemoveMoney($('#lblSchoolNo12_08').text()) - ispRemoveMoney($('#lblSchoolNo13_08').text()), 0));
                $('#txtSchoolNo15a_08').text(ispFormatMoney(0, 0));
                $('#txtSchoolNo15b_08').text(ispFormatMoney(0, 0));
            } else {
                $('#lblSchoolNo14_08').text(ispFormatMoney(0, 0));
                $('#lblSchoolNo15a_08').text(ispFormatMoney((ispRemoveMoney($('#lblSchoolNo13_08').text()) - ispRemoveMoney($('#lblSchoolNo12_08').value)), 0))
                $('#lblSchoolNo15b_08').text(ispFormatMoney((ispRemoveMoney($('#lblSchoolNo13_08').text()) - ispRemoveMoney($('#lblSchoolNo12_08').value)), 0))
            }
        }
          ...
          <div class="blue_base_box">           
            ...
            <div class="inner_white-panel">
              <div class="col-lg-12 col-lg-offset-0 no-padding-left">
                <div id="AppError" class="errormsg no-padding" style="display:block; margin-bottom:0 !important;"> </div>
              </div>
                      ...
                      <div class="row">
                        <form>
                          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
                            <p style="margin-bottom:0 !important;"> <span>Name:</span> <span id="lblName_08" class=""></span> </p>
                          </div>
                          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4">
                            <p style="margin-bottom:0 !important;"> <span id="lblEntityType_08">EIN:</span> <span id="lblEntityId_08" class=""></span> </p>
                          </div>
                        </form>
                      </div>
                      <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
                          <p style="margin-bottom:0 !important;"> <span>Address:</span> <span id="lblAddress_08" class=""></span> </p>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4">
                            <p style="margin-bottom:0 !important;"> <span id="lblSpouse">Spouse's SSN:</span> <span id="lblSpouseSSN" class=""></span> </p>
                        </div>
                      </div>
                      <div class="clearfix"></div>
                    </div>
                      ...
                      <div class="col-lg-12 templateclass">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 col-xs-12 newtop_padding after-amended-sit"style="padding-left:0;">
                              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <label  class="text-custom-left2" for="inputEmail3"> <span class="custom_padding_span">If you were a partial year resident in 2017, enter dates of residency :</span></label>
                              </div>
                        ...
                        <div class="row ">
                          <div class="col-lg-12 templateclass">
                            <div class="row">
                              <div class="col-lg-12" >
                                <table class="table table-condensed table-striped custom_table03 sit-print-table wage-table-print">
                                  <tbody>
                                  
                                    <tr>
                                      <td width="5%">1.</td>
                                      <td width="70%" class="text-left">Net taxable dividends (School Income Tax Regulation 203(a)) </td>
                                      <td width="25%" class="text-left"><Div class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right"  id="txtSchoolNo1_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" style="WIDTH: 100%;" />
                                            </div>
                                          </div>
                                        </Div></td>
                                    </tr>
                                    <tr class="odd">
                                      <td width="5%">2.</td>
                                      <td width="70%" class="text-left">Taxable interest (Reg. 203(b)) </td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right"  id="txtSchoolNo2_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" style="WIDTH: 100%;"/>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr>
                                      <td width="5%">3.</td>
                                      <td width="70%" class="text-left">"Subchapter S" Corporation Income Distribution (Regs. 202 and 203)</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right" style="WIDTH: 100%;" id="txtSchoolNo3_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" />
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr class="odd">
                                      <td width="5%">4.</td>
                                      <td width="70%" class="text-left">Limited Partnership Income (Reg. 203(i)). If loss, enter "0" (zero)</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right" id="txtSchoolNo4_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" style="WIDTH: 100%;"/>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr>
                                      <td width="5%">5.</td>
                                      <td width="70%" class="text-left">Taxable Income received by a Beneficiary of an Estate or Trust (Reg. 205) </td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right" id="txtSchoolNo5_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" style="WIDTH: 100%;"/>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr class="odd">
                                      <td width="5%">6.</td>
                                      <td width="70%" class="text-left">Net Short Term Capital Gains (<strong><u>Held 6 months or less</u></strong>) (Reg. 203(d) and 204(b)).&nbsp;(if loss, enter "0")</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right" id="txtSchoolNo6_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" style="WIDTH: 100%;"/>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr>
                                      <td width="5%">7.</td>
                                      <td width="70%" class="text-left">Net Rental Income (Reg. 203(c)). If loss, enter "0" (zero) </td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right" id="txtSchoolNo7_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" style="WIDTH: 100%;"/>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr class="odd">
                                      <td width="5%">8.</td>
                                      <td width="70%" class="text-left">Other Taxable Income (Reg. 203(e, f, g and h))</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right" id="txtSchoolNo8_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" style="WIDTH: 100%;"/>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr>
                                      <td width="5%">9.</td>
                                      <td width="70%" class="text-left">Total Taxable Income (Add lines 1 through 8)&nbsp; </td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <label class="form-control input-sm pull-right" id="lblSchoolNo9_08" style="WIDTH: 100%;"></label>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr class="odd">
                                      <td width="5%">10.</td>
                                      <td width="70%" class="text-left">Deductible Expenses (cannot exceed line 9) (Reg. 204(a))</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right" id="txtSchoolNo10_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" style="WIDTH: 100%;"/>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr>
                                      <td width="5%">11.</td>
                                      <td width="70%" class="text-left">Net Taxable Income (Subtract line 10 from line 9)&nbsp;</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <label class="form-control input-sm pull-right" id="lblSchoolNo11_08" style="WIDTH: 100%;"></label>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr class="odd">
                                      <td width="5%">12.</td>
                                      <td width="70%" class="text-left">Gross Tax Due <span class="" id="lblSchoolRate" style="float:none;">[Multiply line 11 by ###]</span>&nbsp;</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <label class="form-control input-sm pull-right" id="lblSchoolNo12_08" style="WIDTH: 100%;"></label>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <label class="form-control input-sm pull-right" id="lblSchoolNo13_08" style="WIDTH: 100%;"/>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr class="odd">
                                      <td width="5%">14.</td>
                                      <td width="70%" class="text-left"><u>TAX DUE</u> if line 12 greater than line 13, enter the difference here and on the <u>PAYMENT COUPON</u></td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <label class="form-control input-sm pull-right" id="lblSchoolNo14_08" style="WIDTH: 100%;"></label>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr>
                                      <td width="5%">15.</td>
                                      <td width="70%" class="text-left"><u>OVERPAYMENT OPTIONS</u> If line 12 less than line 13, enter the amount to be &nbsp;</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class=""> </div>
                                          </div>
                                    ...
                                    <tr class="odd">
                                      ...
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right" id="txtSchoolNo15a_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" style="WIDTH: 100%;"/>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                                    <tr>
                                      <td width="5%">15B.</td>
                                      <td width="70%" class="text-left"><strong><u>APPLIED</u></strong> to the 2018 School Income Tax &nbsp;</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                                              <input type="text" class="form-control input-sm pull-right" id="txtSchoolNo15b_08" onchange="ValidateSchool08Return()" onfocus="SetFocus()" maxlength="10" style="WIDTH: 100%;"/>
                                            </div>
                                          </div>
                                        </form></td>
                                    </tr>
                            ...
                            <form class="form-horizontal form-year-background school-filler-email-break" style="padding:5px !important;">
                              <div>
                                <%
                              ...
                              <div class="form-group submit-button-for-print">
                                <div class="col-sm-offset-3 col-sm-9  text-right">
                                  ...
                                  <input type="button" value="Submit" class="btn btn-default submit_button" id="btnSchool08Submit"  onclick="btnSchoolValidate(); ispDisplayProgress('btnSchool08Submit_onclick()', 'Submitting 2017 school tax information')" />
                                </div>
                              </div>
                              <div class="clearfix"></div>
                              <div class="col-md-12">
                                <div style="margin-left: 5px; font-size: 12px;" class="here_input_table sit_here_input_table">
                                  ...
                                  <div class="clearfix"></div>
                                  <label style="margin-top:0;"><a href="https://beta.phila.gov/media/20170207132309/Change-Form.pdf" target="_blank">Change Form</a> complete a  to cancel your account.</label>
                                </div>
                              </div>
                            </form>
