...
<script language="javascript" type="text/javascript">
    ...
    function DisplayNPTReturn() {
        ...
        if (parent.GetNodeCount(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '3') == 1) {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, '12/31/2012', 'NPT_INFO PERIOD', '', 0);
            ...
            $.ajax({
                type: 'POST',
                url: '../../Returns/Log',
                data: '{ "OriginationFom" : "NPT-2012","ServiceName" : "RTTIE039","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../../Returns/Log',
                data: '{ "OriginationFom" : "NPT-2012","ServiceName" : "RTTIE039","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
    ...
    function DisplayNPTThankYou() {
        ...
        $('#NPT_Page4').css("display", "none");
        $('#NPT_2012').css("display", "none");
        $('#NPT_2012').css("visibility", "hidden");
        ...
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT, 'NPT_INFO ADJUSTMENT_REF_NO', '', 0) != '') {
            ...
            $.ajax({
                type: 'POST',
                url: '../../Returns/Log',
                data: '{ "OriginationFom" : "NPT-2012","ServiceName" : "RTTIE030"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
