    ...
    <script type="text/javascript" id="clientEventHandlersJS" language="javascript">
        ...
        function DisplayTobaccoReturn() {
            ...
            if ($(parent.$g.xmlAccount.xml).find('TAX_ACCT[ACCOUNT = "27"]').eq(0)) {            
                ...
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlTobacco, '12/31/2014', 'TOBACCO_INFO PERIOD', '', 0);

                var ReqXML = parent.$g.xmlTobacco;
                $.ajax({
                    type: 'POST',
                    url: '../Returns/Log',
                    data: '{ "OriginationFom" : "Tobacco-2014","ServiceName" : "RTTIE028","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
                ...
                $.ajax({
                    type: 'POST',
                    url: '../Returns/Log',
                    data: '{ "OriginationFom" : "Tobacco-2014","ServiceName" : "RTTIE028","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'ERROR_INFO ERROR', "", 0) != 0) {
                    ...
                    $('#AppHeader').html('tobacco tax return for 2014');
            ...
            $('#AppMessage').html('The Tobacco Tax for 2014 is due January 31, 2015.');
        ...
        function CheckTobaccoXML() {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'TOBACCO_INFO PERIOD', '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'TOBACCO_INFO PERIOD', '', 0)) < new Date('01/01/2014')) {
                bPeriodExist = false;
            }
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print" style="margin-bottom:2px !important;">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">2a.</td>
                                                                        <td style="width: 75%;">Total number of ounces of all tobacco and tobacco-related items sold January 1 through December 31, 2014. </td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">3a.</td>
                                                                        <td style="width: 75%;"> Total number of packs sold January 1 through December 31, 2014.&nbsp;</td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">4.</td>
                                                                        <td style="width: 75%;"> Tax due by January 31, 2015[Calculated - add lines 1d, 2d and 3d]</td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">5.</td>
                                                                        <td> Tax previously paid for tax year 2014 and other credits</td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <label class="" style="font-weight:normal; display:inline;">Amount of overpayment to be applied to the 2015 Tobacco and Tobacco-Related Products Tax.</label></td>
                                                                        <td>
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
