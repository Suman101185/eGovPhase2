      ...
      <div class="col-lg-12" >
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
            <tbody>
                ...
                <tr>
                     <td width="5%">1.</td>
                    <td width="70%">Enter the amount from Page 1, Line 1 of the 2013 BIRT-EZ return or
the Summary Page, Line 1 of the 2013 Business Income & Receipts Tax return</td>
                ...
                <tr>
                    ...
                    <tr class="odd" id="CorpMembers_1"  style="DISPLAY: block; VISIBILTY: visible">
                         <td width="5%">3.</td>
                    <td width="70%">Enter the amount from Page 1, Line 5 of the 2013 Net Profits Tax Return
