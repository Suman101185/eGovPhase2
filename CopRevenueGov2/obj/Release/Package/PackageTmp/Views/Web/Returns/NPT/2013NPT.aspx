...
<body onload="DisplayNPTReturn()">
    ...
    <div id="NPT_Page1" style="DISPLAY: none; VISIBILTY: visible" name="NPT_Page1">
            ...
            <tr>
                ...
                <td colspan="6">
					...
					Worksheet D, Line 3:</label><br>
                     <label id="lnkWrkD" class="lblLink" style="FONT-SIZE: 7pt" onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkD')}">Click here for Worksheet D</label>
                </td>
                <td colspan="2" style="VERTICAL-ALIGN: bottom">
                    <input class="inpNormal"
        ...
        <table class="tblShowBorder" cellspacing="0" cellpadding="0" border="0" style="MARGIN-LEFT: 4%" id="TABLE2" width="90%">
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="16">
                    ...
                    <label id="lnkWrkA" class="lblLink" style="FONT-SIZE: 7pt" onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkA')}">Click here for Worksheet A</label></td>
                </TD>
		<td colspan="3">
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="3" class="inpReadOnlyRt" style="text-align: right;">
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="16">
                    <label class="lblInstrNormal">Non-Residents Taxable Income or Loss from Page 2, Worksheet B, Line 4</label>
                    <label id="lnkWrkB" class="lblLink" style="FONT-SIZE: 7pt" onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkB')}">Click here for Worksheet B</label></td>
                <td colspan="3">
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="8" align="left">
                    <label class="lblInstrNormal">Tax Due</label>
                </td>
                <td colspan="8" align="right">
                    <label class="lblInstrNormal">(Line 2 plus Line 4)</label></td>
                <td colspan="3" class="inpReadOnlyRt" style="text-align: right;">
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="16">
                    ...
                    <label id="lnkWrkE" class="lblLink" style="FONT-SIZE: 7pt" onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkE')}">Click here for Worksheet E</label></td>
                <td colspan="3">
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="8" align="left">
                    <label class="lblInstrNormal">Total payments and credits</label>
                </td>
                <td colspan="8" align="right">
                    <label class="lblInstrNormal">(Line 6a plus Line 6b)</label>
                </td>
                <td colspan="3" class="inpReadOnlyRt" style="text-align: right;">
            ...
            <tr class="rowDataEven">
                ...
                <td colspan="8" align="right">
                    <label class="lblInstrNormal">(Line 5 minus Line 6c)</label></td>
                <td colspan="3" class="inpReadOnlyRt" style="text-align: right;">
            ...
            <tr class="rowDataOdd" valign="top">
                ...
                <td colspan="8" align="left">
                    <label class="lblInstrNormal">Interest and Penalty</label>
                </td>
                <td colspan="8" align="right">
                    <label class="lblInstrNormal">
		...
		<td colspan="3">
            <label class="inpNormal" id="lblNPT8" 
                style="WIDTH: auto"/></td>
            </tr>
            <tr class="rowDataEven">
                <td style="text-align: left;">
                ...
                <td colspan="8" align="left">
                    <label class="lblInstrNormal"><u>TOTAL DUE</u> including Interest and Penalty</label>
                </td>
                <td colspan="8" align="right">
                    <label class="lblInstrNormal">
            ...
            <tr class="rowDataOdd">
                ...
                <td colspan="8" align="left">
                    <label class="lblInstrNormal">Tax Overpaid</label>
                </td>
                <td colspan="8" align="right">
                    <label class="lblInstrNormal">(Line 6c is greater than Line 5)</label></td>
                <td colspan="3" class="inpReadOnlyRt" style="text-align: right;">
            ...
            <tr class="rowDataEven" valign="top">
                ...
                <td colspan="16">
                    ...
                    <label id="lnkWrkC" class="lblLink" style="FONT-SIZE: 7pt" onclick="if($(this).attr('disabled')!='disabled'){ShowPage('WrkC')}">Click here for Worksheet C</label></td>
                <td colspan="3">
