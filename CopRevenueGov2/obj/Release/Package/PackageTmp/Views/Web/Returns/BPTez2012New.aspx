...
<!-- Bootstrap Core CSS -->
    ...
    function DisplayBPTezReturn() {
        ...
        if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('24')")) {          
            ...
            $('#AppHeader').html('Business Income & Receipts Tax-EZ for 2012');
            
            parent.gsInstructionItem = '#BIR';
            $('#AppMessage').html('The Business Income & Receipts Tax for 2012 is due April 17, 2013.');

            var ReqXML = parent.$g.xmlBPTez;
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "EZ-2012","ServiceName" : "RTTIE037","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "EZ-2012","ServiceName" : "RTTIE037","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
    ...
    function LoadBPTezError() {
        ...
        var txtBPTez1_8 = document.getElementById("txtlBPTez1_8");
    ...
    function ShowPage(iPage) {
        ...
        if (iPage == 2) {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez, 'BPT_INFO RETURN_STATUS', '', 0) == 'A1' || parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez, 'BPT_INFO RETURN_STATUS', '', 0) == 'A2') {
                //SUMAN : AS PER REQUIREMENT DICUSSED ON 29TH JAN 2013, CLIENT DONT WANT SCHEDULE N LINK IF USER CHOSE YES OPTION
            ...
            // Added to solve Schedule N issue by chayan on 19/03/2012		
            CalcPage1Line3();
            CalcPage1Line5();
            CalcPage1Line6c();
            CalcPage1Line7();
