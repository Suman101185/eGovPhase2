    ...
    <div id="BPT_SchdB" style="DISPLAY: none;">
            <div class="col-lg-12 col-md-12">   
                       ...
                       <%-- <div class="well">    --%>                                      
                                <div class="table-responsive">
                                	...
                                	<table class="table table-condensed table-striped custom_table03 wage-table-print">
                                    	...
                                    	<thead>
                                        	<tr>
                                            	<th colspan="3" width="100%" class="slim-headings"><B>2012 BIRT Schedule B: Computation of Tax On Net Income(Method II)</B></th>
				...
				onfocus=SetFocus() maxLength=10 onchange="ValidateWorksheet('BPT_SchdB')"/>
                                            ...
                                            <tr>
                                            	<td widh="5%">10.</td>
                                                <td widh="70%" class="text-left">Loss carry foward, if any (<u><font>see LCF on side menu bar</font></u>)</td>
                                                <td widh="25%" class="text-left">
                                               		<form class="form-horizontal">
