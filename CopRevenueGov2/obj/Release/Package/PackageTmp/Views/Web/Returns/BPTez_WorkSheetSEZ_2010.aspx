        ...
        function GetS2byS3() {
            ...
            if ($('#lbl_BPT_WSEZ3').text() != '' && $('#lbl_BPT_WSEZ2').text() != '') {
                ...
                if (isNaN((cCur($('#lbl_BPT_WSEZ2').text()) / cCur($('#lbl_BPT_WSEZ3').text())) ) || calculationvar1 == 'Infinity' || calculationvar1 == 'NAN') {
                    ...
                    calculationvar1 = calculationvar1.toFixed(10);
    ...
    <tbody>
            ...
            <td colspan="2" align="center" width="25%">                
                <div class="form-horizontal">
                    <div class="form-group no-margin">
                        <div class="">
                            <INPUT type="text" class="form-control input-sm pull-right" style="WIDTH:70%" id="txt_BPT_WSEZ1"  onfocus="SetFocus()" maxLength="10" onchange="ValidateBPTezReturn()"/>
                        </div>
                   </div>
                </div>
                </td>
        ...
        <tr  class="odd">
            ...
            <td colspan="2" align="center" width="25%">               
                <div class="form-horizontal">
                    <div class="form-group no-margin">
                        <div class="">
                             <label class="form-control input-sm pull-right" id="lbl_BPT_WSEZ2" style="WIDTH:70%" ></label>
                        </div>
                   </div>
                </div>
                </td>
        ...
        <tr >
            ...
            <td colspan="2" align="center" width="25%">               
                <div class="form-horizontal">
                    <div class="form-group no-margin">
                        <div class="">
                             <label class="form-control input-sm pull-right" id="lbl_BPT_WSEZ3" style="WIDTH:70%"></label>
                        </div>
                   </div>
                </div>
            </td>
        ...
        <tr class="odd">
            ...
            <td style="width:25%" class="text-left">               
                 <div class="form-horizontal">
                    <div class="form-group no-margin">
                        <div class="">                    
                             <label class="form-control input-sm pull-right" id="lbl_BPT_WSEZ4" style="WIDTH:70%"></label>
                        </div>
                   </div>
                </div>
            </td>
        ...
        <tr >
            ...
            <td colspan="2" align="center" style="width:25%">               
                    ...
                    <div class="form-group no-margin">
                        <div class="">
                              <label class="form-control input-sm pull-right" id="lbl_BPT_WSEZ5" style="WIDTH:70%"></label>
                        </div>
                   </div>
                </div>                       
                </td>
