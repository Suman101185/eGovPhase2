       ...
       <div class="col-lg-12" >
        ...
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
            ...
            <tbody>
                ...
                <tr>
                      <td width="5%">1.</td>
                    <td> 2017 Estimated Net Profits Tax Payments</td>
                    <td style="width:25%">                       
                ...
                <tr class="odd">
                      <td width="5%">2.</td>
                      <td width="70%">Payments of 2017 Net Profits Tax made with Application for Extension of Time to File                                               
                    </td>
                    <td style="width:25%">                           
                          <div class="form-horizontal">
                      <div class="form-group no-margin">
                ...
                <tr>
                      <td width="5%">3.</td>
                    <td>  Overpayment of 2017 Business Income & Receipts Tax or 2016 Net Profits Tax to be applied to this tax return</td>
                    <td style="width:25%">                       
                         <div class="form-horizontal">
                      <div class="form-group no-margin">
                        <div class="">
