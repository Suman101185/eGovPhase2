...
<!-- Bootstrap Core CSS -->
    ...
    function DisplayBPTezReturn() {
        ...
        if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('24')")) {          
            ...
            $('#AppHeader').html('Business Income & Receipts Tax-EZ for 2013');
            
            parent.gsInstructionItem = '#BIR';
            $('#AppMessage').html('The Business Income & Receipts Tax for 2013 is due April 17, 2014.');
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "EZ-2013","ServiceName" : "RTTIE037","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "EZ-2013","ServiceName" : "RTTIE037","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
    ...
    function btnBPTezSubmit_onclick() {
        ...
        if ($("#AppError").text() == "") {
            ...
            setTimeout(function () { }, 3000);
            ispCallXMLForm(parent.$g.xmlBPTez, tempXML, "BPTezReturn", "");
        ...
        if ($('#txtBPTez2_3').val() != ispFormatMoney(0, 0).toString()) {
            for (i = 0; i < iCount; i++) {
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '', i) == '24') {
                    ...
                    if (new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT START_DATE', '', i)) >= new Date("01/01/2013")) {
                        $('#txtBPTez2_3').val(ispFormatMoney(0, 0));//'$0';
                        alert('This return is not eligible for Loss Carry Forward, because your BPT Start Date '
                             + BPTStartDate
                             + ' is on or after 01/01/2013. Loss Carry Forward (Page 2, question #3) has been set to zero.');
                    }
                }
            }
        }
                            ...
                            <div class="row">
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td  width="25%" class="text-left">                                               
                                                <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	<input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez1_4" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>
                                        ...
                                        <tr class="odd">
                                             <td width="5%">6a.</td>
                                            <td width="70%" class="text-left"> Credit from overpayment of 2012 or 2013 Net Profit Tax </td>
                                            <td width="25%" class="text-left">                                             
                                                <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
			  ...
			  made,<br>and any credit from overpayment of the 2012 BPT return</td>
                                            <td width="25%" class="text-left">                                               	
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	 <input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez1_6b" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
					...
					the Federal Government</td>
                                            ...
                                            <td width="25%" class="text-left">                                            
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	 <input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_1" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%" class="text-left">                                               	
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	<input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_3" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td width="25%" class="text-left">                                            
                                                <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	<label id="lblBPTez2_4" class="form-control input-sm pull-right" style="WIDTH: 90%"></label>
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td width="25%" class="text-left">                                            
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	 <input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_6a" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%" class="text-left">                                               
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	<input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_6b" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td width="25%" class="text-left">                                           
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	 <input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_6c" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                         ...
                                         <tr>
                                            ...
                                            <td width="25%" class="text-left">                                              	
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	<input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_6d" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td width="25%" class="text-left">                                          
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	 <input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_6e" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%" class="text-left">                                          	
                                                <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	<input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_6f" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                           ...
                                           <tr class="odd">
                                            ...
                                            <td width="25%" class="text-left">                                          
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	 <input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_6g" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%" class="text-left">                                            	
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	<input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_6h" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td width="25%" class="text-left">                                           
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	 <input type="text" class="form-control input-sm pull-right" style="WIDTH: 90%" id="txtBPTez2_6i" onchange="ValidateBPTezReturn()" onfocus="SetFocus()" maxlength="10" />
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
                                         ...
                                         <tr >
                                            ...
                                            <td width="25%" class="text-left">                                             
                                                 <div class="form-horizontal">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            	 <label id="lblBPTez2_7" class="form-control input-sm pull-right" style="WIDTH: 90%"></label>
                                                            </div>
                                                          </div>                                            
                                            		</div>
                                            </td>
