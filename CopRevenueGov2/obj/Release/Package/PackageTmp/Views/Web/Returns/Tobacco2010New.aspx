        ...
        function DisplayTobaccoReturn() {
            ...
            if (parent.GetNodeCount(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '27') == 1) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'ERROR_INFO ERROR', "", 0) != 0) {
                    ...
                    $('#AppHeader').html('tobacco tax return for 2010');
            ...
            $('#AppMessage').html('<BR>The Tobacco Tax for 2010 is due January 31, 2011.');
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">2a.</td>
                                                                        <td style="width: 75%;">Total number of ounces of all tobacco and tobacco-related items sold January 1 through December 31, 2010. </td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">3a.</td>
                                                                        <td style="width: 75%;"> Total number of packs sold January 1 through December 31, 2010.&nbsp;</td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">4.</td>
                                                                        <td style="width: 75%;"> Tax due by January 31, 2011[Calculated - add lines 1d, 2d and 3d]</td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">5.</td>
                                                                        <td> Tax previously paid for tax year 2010 and other credits</td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
