        ...
        function DisplayBPTlfReturn() {
            ...
            if ($(parent.$g.xmlAccount.xml).find('TAX_ACCT[ACCOUNT = "24"]').eq(0)) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../../Returns/Log',
                    data: '{ "OriginationFom" : "BPTLF-2016","ServiceName" : "RTTIE030","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
                ...
                $.ajax({
                    type: 'POST',
                    url: '../../Returns/Log',
                    data: '{ "OriginationFom" : "BPTLF-2016","ServiceName" : "RTTIE030","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg) {
        ...
        function DisplayBPTlfThankYou() {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldInfAdjRef, '', 0) != '') {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../../Returns/Log',
                    data: '{ "OriginationFom" : "BPTLF-2016","ServiceName" : "RTTIE030"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg) {
				                    ...
				                    <script>document.write(sCurrYear - 1)</script>
					                    ...
					                    enter the termination date here <u>AND</u> file a <a href="https://beta.phila.gov/media/20170207132309/Change-Form.pdf">CHANGE FORM</a>.</span></label>
                                                ...
                                                <label class="lblLink label_NoLeft" style="width: 100%" onclick="ShowPage('SchdD')">Schedule D, Line 13</label>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">4.</td>
                                                                        <td width="70%" class="text-left"><b><u>MANDATORY</u> 2017 BIRT Estimated Payment <u>(repeat line 3)</u> </b></td>
                                                                        <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">5.</td>
                                                                        <td width="70%" class="text-left">Total Due by <b>4/18/2017</b>[Calculated - add lines 3 and 4]</td>
                                                                        <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">6a.</td>
                                                                        <td width="70%" class="text-left">Include any estimated and/or extension payments of 2016 BIRT previously made,
and any credit from overpayment of the 2015 BIRT and/or 2016 NPT return.</label> </td>
                                                                        <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">
				...
				your account.</label>
                                        ...
                                        <% 
                                            ...
                                            Html.RenderAction("_16SchdA", "BPT_LF");//Changed by SumanG
                                            Html.RenderAction("_16SchdB", "BPT_LF");
                                            Html.RenderAction("_16SchdC1", "BPT_LF");
                                            Html.RenderAction("_16SchdD", "BPT_LF");
                                            Html.RenderAction("_16SchdE", "BPT_LF");
                                            Html.RenderAction("_16WorkSheet5", "BPT_LF");
