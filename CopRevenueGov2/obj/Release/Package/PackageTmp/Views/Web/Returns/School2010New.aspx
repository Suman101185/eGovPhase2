        ...
        function DisplaySchool08Return() {
            ...
            if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('29')")) {
                ...
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlSchool, 'ERROR_INFO ERROR', "", 0) != 0) {
                    ...
                    $('#AppHeader').html('school income tax return for 2010');
            ...
            $('#AppMessage').html('<BR>The School Income Tax for 2010 is due April 17, 2011.');
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 col-xs-12 newtop_padding after-amended-sit"style="padding-left:0;">
                              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <label  class="text-custom-left2" for="inputEmail3"> <span class="custom_padding_span">If you were a partial year resident in 2010, enter dates of residency :</span></label>
                              </div>
                              ...
                              <div class="col-lg-12" >
                                <table class="table table-condensed table-striped custom_table03">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td width="5%">15B.</td>
                                      <td width="70%" class="text-left"><strong><u>Applied</u></strong> to the 2011 School Income Tax &nbsp;</td>
                                      <td width="25%" class="text-left"><form class="form-horizontal">
                                          <div class="form-group no-margin">
                                            <div class="">
                            ...
                            <form class="form-horizontal form-year-background">
                              ...
                              <div class="form-group submit-button-for-print">
                                <div class="col-sm-offset-3 col-sm-9  text-right">
                                  ...
                                  <input type="button" value="Submit" class="btn btn-default submit_button" id="btnSchool08Submit"  onclick="btnSchoolValidate(); ispDisplayProgress('btnSchool08Submit_onclick()', 'Submitting 2010 school tax information')" />
                                </div>
                              </div>
                              <div class="clearfix"></div>
                              <div class="col-md-12">
