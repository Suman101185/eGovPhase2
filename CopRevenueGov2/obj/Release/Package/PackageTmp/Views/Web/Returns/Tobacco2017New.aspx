...
<head>
    ...
    <script type="text/javascript" id="clientEventHandlersJS" language="javascript">
       ...
       function DisplayTobaccoReturn() {
           ...
           if ($(parent.$g.xmlAccount.xml).find('TAX_ACCT[ACCOUNT = "27"]').eq(0)) {             
               ...
               parent.$x.ispXmlSetFieldVal(parent.$g.xmlTobacco, '12/31/2017', 'TOBACCO_INFO PERIOD', '', 0);

               var ReqXML = parent.$g.xmlTobacco;
               $.ajax({
                   type: 'POST',
                   url: '../Returns/Log',
                   data: '{ "OriginationFom" : "Tobacco-2017","ServiceName" : "RTTIE028","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
               ...
               var ResXML = parent.$g.xmlTobacco;
               $.ajax({
                   type: 'POST',
                   url: '../Returns/Log',
                   data: '{ "OriginationFom" : "Tobacco-2017","ServiceName" : "RTTIE028","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                   contentType: 'application/json; charset=utf-8',
                   dataType: 'json',
                   success: function (msg) {
               ...
               if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'ERROR_INFO ERROR', "", 0) != 0) {
                   ...
                   $('#AppHeader').html('tobacco tax return for 2017');
           ...
           $('#AppMessage').html('The Tobacco Tax for 2017 is due January 31, 2018.');
       ...
       function FieldLock(bDisabled) {
           if (bDisabled == true) {
               ...
               $('#lblTobaccoNo5').attr("disabled", "disabled");
               ...
               $('#lblTobaccoNo5').removeAttr("disabled");
       ...
       function CheckTobaccoXML() {
           ...
           if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'TOBACCO_INFO PERIOD', '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'TOBACCO_INFO PERIOD', '', 0)) < new Date('01/01/2017')) {
               bPeriodExist = false;
           }
       ...
       function PopulateTobaccoData() {
           ...
           $('#lblTobaccoNo5').text(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlTobacco, 'AMT_INFO CREDITS', '', 0), 0));
       ...
       function PopulateTobaccoXML() {
           ...
           parent.$x.ispXmlSetFieldVal(parent.$g.xmlTobacco, stripCurrency($('lblTobaccoNo5').text()), 'AMT_INFO CREDITS', '', 0);
       ...
       function RightAlignText() {
           ...
           $('#lblTobaccoNo5').parent().css("text-align", "right");
       ...
       function CalcLine6() {
           if ($('#lblTobaccoNo4').text() != '' && $('#lblTobaccoNo5').text() != '') {
               $('#lblTobaccoNo6').text(ispFormatMoney((parseCurrency($('#lblTobaccoNo4').text()) - parseCurrency($('#lblTobaccoNo5').text())), 0));
           }
       }
                ...
                <div class="row">
                    <div style="display: block;" id="tab1" class="col-lg-12 col-md-12">
                        <div class="blue_base_box">                         
                            ...
                            <div class="inner_white-panel" style="padding-top:0 !important;">
                                <div class="col-lg-12 col-lg-offset-0 no-padding-left">
                                                  <div id="AppError" class="errormsg no-padding" style="display:block; margin-bottom:0;">
                                                   </div>
                                                     </div>      
                                ...
                                <div class="contentsection tobacco-print">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                           ...
                                           <div class="well" style="padding:5px !important; margin-bottom:2px !important;">
                                                <div class="row">
                                                    <form>
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-8">
                                                            <p class="name-top-print" style="margin-bottom:0 !important;">
                                                                <span>Name:</span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 templateclass">
                                                    ...
                                                    <form class="form-horizontal school_form">
                                                        ...
                                                        <div class="row form-group topsmallform" style="margin-bottom:0 !important;">

                                                            <div class="col-sm-4 col-xs-4 newtop_padding">
                                                            ...
                                                            <div>
                                                                <label class="col-sm-8 col-xs-8 control-label text-custom-left2" style="color: Red;" for="inputEmail3">
                                                    ...
                                                    <div class="row table-responsive">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print" style="margin-bottom:2px !important;">

                                                                <tbody>

                                                                    <tr class="odd">
                                                                         <td width="5%">1.</td>
                                                                        <td style="width: 75%;">Tobacco and tobacco-related products that consists of individual items rolled for smoking (e.g., cigars) </td>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">1d.</td>
                                                                        <td style="width: 75%;">
                                                                            <label class="" id="msgTobaccoNo1d" style="width: 100%; font-weight:normal;"> TAX DUE [Calculated - line 1c * ### per item]&nbsp;</label></td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">2.</td>
                                                                        <td> All other tobacco and tobacco-related products (e.g., smokeless tobacco, pipe tobacco, loose tobacco)</td>
                                                                        <td style="width: 25%;"></td>
                                                                    </tr>
                                                                    <tr class="odd">
                                                                        <td width="5%">2a.</td>
                                                                        <td style="width: 75%;">Total number of ounces of all tobacco and tobacco-related items sold January 1 through December 31, 2017. </td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">2d.</td>
                                                                        <td>
                                                                            <label class="" id="msgTobaccoNo2d" style="width: 100%; font-weight:normal;"> Deductible ExpenseTAX DUE[Calculated - line 2c * ### per ounce]&nbsp;</label></td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">3.</td>
                                                                        <td style="width: 75%;"> Rolling Papers</td>
                                                                        <td style="width: 25%;"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="5%">3a.</td>
                                                                        <td style="width: 75%;"> Total number of packs sold January 1 through December 31, 2017.&nbsp;</td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">3d.</td>
                                                                        <td>
                                                                            <label class="" id="msgTobaccoNo3d" style="width: 100%; font-weight:normal;"> TAX DUE[Calculated - line 3c * ### per pack]&nbsp;</label></td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">4.</td>
                                                                        <td style="width: 75%;"> Tax due by January 31, 2018[Calculated - add lines 1d, 2d and 3d]</td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">5.</td>
                                                                        <td> Tax previously paid for tax year 2017 and other credits</td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                                        <label class="form-control input-sm pull-right" style="WIDTH: 70%;" " id="lblTobaccoNo5" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                                        <label class="form-control input-sm pull-right" style="WIDTH: 70%; font-weight:normal;" id="lblTobaccoNo6"></label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">7.</td>
                                                                        <td> Interest and Penalty <a href="https://beta.phila.gov/services/payments-assistance-taxes/paying-city-taxes/interest-penalties-and-fees/" target="_blank" style="color:red">(see Instruction)</a></td>
                                                                        <td style="width: 25%;">
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">9a.</td>
                                                                        <td>
                                                                            <input id="chkTobaccoNo9a" type="checkbox" style="display:inline;" onclick="chkRefund_onclick()" />
                                                                            <label class="" style="font-weight:normal; display:inline;">If Line 5 is greater than Line 8, enter the amount to be <b><i>refunded</i></b> or  skip to Line 9b.</label></td>
                                                                        <td>
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                    ...
                                                                    <tr>
                                                                        <td width="5%">9b.</td>
                                                                        <td>
                                                                            <input id="chkTobaccoNo9b" type="checkbox"  style="display:inline;" onclick="chkRefund_onclick()" />
                                                                            <label class="" style="font-weight:normal; display:inline;">Amount of overpayment to be applied to the 2018 Tobacco and Tobacco-Related Products Tax.</label></td>
                                                                        <td>
                                                                            <div class="form-horizontal">
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                ...
                                                <div class="col-lg-12">
                                                        <form class="form-horizontal form-year-background" style="padding:2px 10px !important;">
                                                            <div>
                                                                <%
                                                            ...
                                                            <div class="form-group page-print-wage-section">
                                                                <div class="col-sm-offset-3 col-sm-9 text-right">
                                                                    ...
                                                                    <input type="button" value="Submit" class="btn btn-default submit_button" id="btnTobaccoSubmit" onclick="btnTobaccoValidate(); ispDisplayProgress('btnTobaccoSubmit_onclick()', 'Submitting 2017 tobacco tax information')" />
                                                                </div>
                                                            </div>

                              <div class="clearfix"></div>
                              <div class="col-md-12" style="padding:0;">
                                <div style="font-size: 12px;" class="here_input_table sit_here_input_table">
                                  <label style="margin-top:0px !important;"> Note: DO NOT FILE THIS RETURN if you have no taxable activity. If you registered for 
                                    this tax and you no longer have taxable activity, complete a <a href="https://beta.phila.gov/media/20170207132309/Change-Form.pdf" target="_blank">Change Form</a> complete a  to cancel your account.</label>
                                </div>
                              </div>
