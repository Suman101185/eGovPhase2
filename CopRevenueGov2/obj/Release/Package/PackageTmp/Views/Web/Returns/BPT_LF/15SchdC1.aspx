...
<head>
    ...
    <script language='javascript' type="text/javascript"> 
        ...
        function RightAlignText_C1() {//Added 
            $('#txtBPT_SchC1_1').css('text-align', 'right');
            $('#txtBPT_SchC1_2').css('text-align', 'right');
            $('#lblBPT_SchC1_3').css('text-align', 'right');         

        }
        function PopulateXmlBPTlfSchdC1() {
            // 
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#txtBPT_SchC1_1').val()), xFldScCLi10a, '', 0);
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2015, stripCurrency($('#txtBPT_SchC1_2').val()), xFldScCLi10b, '', 0);
        ...
        function PopulateBPTlfSchdC1() {
            // 
            $('#txtBPT_SchC1_1').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScCLi10a, '', 0), 0));
            $('#txtBPT_SchC1_2').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldScCLi10b, '', 0), 0));
        ...
        function FieldLockBPTlfSchdC1(bDisabled) {
            ...
            $('#txtBPT_SchC1_2').attr('disabled', bDisabled);
        ...
        function CalcSchdC1Line3() {
            ...
            if ($('#txtBPT_SchC1_1').val() != '' && $('#txtBPT_SchC1_2').val() != '') {
                if (PrepForMath($('#txtBPT_SchC1_1').val()) == 0 && PrepForMath($('#txtBPT_SchC1_2').val()) == 0) {		
                    $('#lblBPT_SchC1_3').text(parseFloat(1).toFixed(6));
                }
                else if (PrepForMath($('#txtBPT_SchC1_2').val()) >= PrepForMath($('#txtBPT_SchC1_1').val())) {
                    $('#lblBPT_SchC1_3').text(parseFloat(PrepForMath($('#txtBPT_SchC1_1').val()) /
                            PrepForMath($('#txtBPT_SchC1_2').val())).toFixed(6));
...
<body>
    ...
    <div id="BPT_SchdC1" style="DISPLAY: none;">
     <div class="col-lg-12 col-md-12 bptlf-sched-for-print">
                ...
                <div class="row">
                	<h3 class="slim-headings">2015 BIRT SCHEDULE C-1: For business conducted in and out of Philadelphia</h3>
                                                ...
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                                        ...
                                                        <div class="form-group no-margin">
                                                            <div class="">                                                            
                                                                 <INPUT class="form-control input-sm pull-right" id="txtBPT_SchC1_1" type="text" style="WIDTH: 100%" 
				                                                onfocus="SetFocus()" maxLength="10" onchange="ValidateWorksheet('BPT_SchdC1')"/>  
                                                          	</div>
                                                          </div>
                                     		 ...
                                     		 <tr class="odd">
                                                ...
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                                        ...
                                                        <div class="form-group no-margin">
                                                            <div class="">                                                          
                                                                 <INPUT class="form-control input-sm pull-right" id="txtBPT_SchC1_2" type="text" style="WIDTH: 100%" 
				                                                onfocus="SetFocus()" maxLength="10" onchange="ValidateWorksheet('BPT_SchdC1')"/>
                                                          	</div>
                                                          </div>
