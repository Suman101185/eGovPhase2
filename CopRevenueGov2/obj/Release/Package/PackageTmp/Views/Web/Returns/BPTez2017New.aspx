...
<script id="clientEventHandlersJS" language="javascript" type="text/javascript">
    ...
    function DisplayBPTezReturn() {
        ...
        if ($(parent.$g.xmlAccount).find("TAX_ACCT").find("ACCOUNT:contains('24')")) {        
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTez_2015, '12/31/2017', 'BPT_INFO PERIOD', '', 0);

            $('#AppHeader').html('Business Income & Receipts Tax-EZ for 2017');
           
            parent.gsInstructionItem = '#BIR';
            $('#AppMessage').html('The Business Income & Receipts Tax for 2017 is due April 18, 2018.');          
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "EZ-2017","ServiceName" : "RTTIE037","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "EZ-2017","ServiceName" : "RTTIE037","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
        ...
        if ($('#txtBPTez2_4').val() != ispFormatMoney(0, 0).toString()) {
            for (i = 0; i < iCount; i++) {
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '', i) == '24') {
                    ...
                    if (new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT START_DATE', '', i)) >= new Date("01/01/2017")) {
                        $('#txtBPTez2_4').val(ispFormatMoney(0, 0));//'$0';
                        alert('This return is not eligible for Loss Carry Forward, because your BPT Start Date '
                             + BPTStartDate
                             + ' is on or after 01/01/2017. Loss Carry Forward (Page 2, question #4) has been set to zero.');
                    }
                }
            }
        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-sm-12" style="display:none">
                            <label class="control-label text-custom-left2 no-padding" for="inputEmail3">
                                <span class="custom_padding_span"> If your business terminated in 2017, enter the termination date AND file a CHANGE FORM. 
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                             <td width="5%">4.</td>
                                            <td width="70%" class="text-left"> <B><U>MANDATORY</U> 2018 BIRT Estimated Payment (repeat line 3)</B></td>
                                            <td width="25%" class="text-left">                                               
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                        ...
                                        <tr>
                                             <td width="5%">5.</td>
                                            <td width="70%" class="text-left"> Total Due by 4/18/2018 [Calculated - add lines 3 and 4]  </td>
                                            <td width="25%" class="text-left">                                             
                                                 <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                       ...
                                       <thead>
                                        ...
                                        <tr>
                                             <td width="5%">6a.</td>
                                            <td width="70%" class="text-left"> <B>Include any estimated and/or extension payments of 2017 BIRT previously made, and any credit from overpayment of the 2016 BIRT and/or 2017 NPT return</B>  </td>
                                            <td width="25%" class="text-left">                                             
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                        ...
                        <div class="clearfix"></div>
                         ...
                         <div style="DISPLAY:none" Id="BPTez_pg2" Name="BPTez_pg2">
                             ...
                             <div class="col-lg-12" >
                                ...
                                <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print wage-table-print-for-ez">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                             <td width="5%">6.</td>
                                            <td width="70%" class="text-left">TAX DUE [Calculated - line 5 * 0.0635]. If Line 5 is a loss, enter zero here and on Page 1, Line 1 </td>
                                            <td width="25%" class="text-left">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                                       ...
                                       <thead>
                                        ...
                                        <tr >
                                             <td width="5%">11.</td>
                                            <td width="70%" class="text-left"> TAX DUE. [Calculated - line 10 * 0.001415]. Enter here and on Page 1, Line 2</td>
                                            <td width="25%" class="text-left">                                              
                                                <div class="form-horizontal">
                                                <div class="form-group no-margin">
                                                    <div class="">
                            ...
                            <div>
                            <% Html.RenderAction("BPTez_WorkSheetSEZ_2017", "Returns"); %>
                            </div>
