...
<script language="javascript" type="text/javascript">
    ...
    function DisplayNPTReturn() {
        ...
        if (parent.GetNodeCount(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '3') == 1) {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlNPT, '12/31/2010', 'NPT_INFO PERIOD', '', 0);
    ...
    function DisplayNPTThankYou() {
        ...
        $('#NPT_2010').css("display", "none");
        $('#NPT_2010').css("visibility", "hidden");
