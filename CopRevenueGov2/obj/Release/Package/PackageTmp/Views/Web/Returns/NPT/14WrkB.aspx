      ...
      <div class="col-lg-12" >
        <table summary="Employee Pay Sheet" class="table table-condensed table-striped custom_table03 wage-table-print">
            ...
            <tbody>
                ...
                <tr class="odd">
                    <td width="5%"></td>
                    <td width="70%"><b><U>Worksheet B: Business Income (Loss) for Non-Residents</U></b>
                            <br />Non-residents of Philadelphia that need to apportion their income on Worksheet NR-3 cannot file electronically
                ...
                <tr>
                    ...
                    <td style="width:25%">                      
                     ...
                     <div class="form-group no-margin">
                        <div class="">
                              <LABEL  id=lblNPT_WrkB_4 class="form-control input-sm pull-right" style="WIDTH: 70%;"></LABEL>
                        </div>
                   </div>
                </div>
                  </td>
