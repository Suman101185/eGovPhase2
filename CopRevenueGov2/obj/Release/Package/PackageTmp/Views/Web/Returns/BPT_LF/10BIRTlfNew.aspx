...
<head>
    ...
    <script id="bptIF" language="javascript" type="text/javascript">
        ...
        function DisplayBPTlfReturn() {
            ...
            var lblBPT1_8 = document.getElementById('lblBPT1_8');
        ...
        function RightAlignText() {
            ...
            $('#lblBPT1_8').css('text-align', 'right');
...
<body>
    <div style="display:none; color:#fff !important;"><%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage" %></div>
                    ...
                    <div class="col-lg-12 templateclass">
                			<form class="form-horizontal">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9 newtop_padding">
                                                                            ...
                                                                            <td width="25%" class="text-left">
                                                                                <form class="form-horizontal">
                                                                                    ...
                                                                                    <div class="form-group no-margin">
                                                                                        <div class="">
                                                                                            <label id="lblBPT1_1" style="width: 70%;" class="form-control input-sm pull-right"></label>
                                                                                        </div>
                                                                                    </div>
                                                ...
                                                <label class="lblLink label_NoLeft" style="width: 100%" onclick="ShowPage('SchdD')">Schedule D, Line 11</label>
                                                                            ...
                                                                            <td width="25%" class="text-left">
                                                                                <form class="form-horizontal">
                                                                                    ...
                                                                                    <div class="form-group no-margin">
                                                                                        <div class="">
                                                                                            <label id="lblBPT1_2" style="width: 70%;" class="form-control input-sm pull-right"></label>
                                                                                        </div>
                                                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                                        ...
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                             <label id=lblBPT1_3 style="width: 70%" class="form-control input-sm pull-right"></label>
                                                          </div>
                                                ...
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                                            <input class="form-control input-sm" id=txtBPT1_4 type="text" onchange="ValidateWorksheet('BPT_Pg1')" onkeyup="Pg1L4Keyup()"
			                                                 style="width: 70%;"  onfocus="SetFocus()" maxlength="10">
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                                        ...
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                             <label id=lblBPT1_5 style="width: 70%" class="form-control input-sm pull-right"></label></div>
                                                          </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%" class="text-left">
			                                       ...
			                                       style="width: 70%;" onfocus="SetFocus()">
                                                             </div>
                                                          </div>
                                     		...
                                     		<tr class="odd">
                                            	<td width="5%">6b.</td>
                                                <td width="70%" class="text-left">Include any estimated and/or extension payments of 2010 BIRT previously
			  made,<br>and any credit from overpayment of the 2009 BPT return</td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                            ...
                                            <td width="70%" class="text-left">Total Payments and Credits[Calculated - add lines 6a and 6b]</td>
                                              <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">
                                                                                ...
                                                                                <div class="form-group no-margin">
                                                                                    <div class="">
                                                                                        <label id="lblBPT1_6c" class="form-control input-sm pull-right" style="width: 70%;"></label>
                                                                                    </div>
                                                                                </div>
                                     		...
                                     		<tr class="odd">
                                                ...
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                                        ...
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                            <label id=lblBPT1_7 style="width: 70%" class="form-control input-sm pull-right"></label></div>
                                                          </div>
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                                        ...
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                             <label id=lblBPT1_9 style="width: 70%" class="form-control input-sm pull-right"></label></div>
                                                          </div>
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                                        ...
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                              <input id=txtBPT1_10a type="text" class="form-control input-sm pull-right" style="width: 70%;" onchange="ValidateWorksheet('BPT_Pg1')"
                                     		...
                                     		<tr class="odd">
                                                ...
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">
                                                        ...
                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                             <input id=txtBPT1_10b type="text" class="form-control input-sm pull-right"style="width: 70%;" onchange="ValidateWorksheet('BPT_Pg1')"
					onfocus="SetFocus()"> </div>
                                                          </div>
                                            ...
                                            <tr> 
                                            	<td width="5%">10c.</td>
                                                <td width="70%" class="text-left">Applied to the 2010 Business Income & Receipts Tax</td>
                                                <td width="25%" class="text-left">
                                               		<form class="form-horizontal">

                                                        <div class="form-group no-margin">
                                                            <div class="">
                                                             <input id=txtBPT1_10c type="text" class="form-control input-sm pull-right" onchange style="width: 70%;"="ValidateWorksheet('BPT_Pg1')"
					onfocus="SetFocus()" ></div>
                                                          </div>
				...
				your account.</label>
                      ...
                      <% 
                          ...
                          Html.RenderAction("_10BIRT_19_3800Message", "BPT_LF");
