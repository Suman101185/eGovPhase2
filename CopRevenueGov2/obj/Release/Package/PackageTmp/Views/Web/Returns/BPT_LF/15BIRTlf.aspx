        ...
        function DisplayBPTlfReturn() {
            ...
            if ($(parent.$g.xmlAccount.xml).find('TAX_ACCT[ACCOUNT = "24"]').eq(0)) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../../Returns/Log',
                    data: '{ "OriginationFom" : "BPTLF-2015","ServiceName" : "RTTIE030","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
                ...
                $.ajax({
                    type: 'POST',
                    url: '../../Returns/Log',
                    data: '{ "OriginationFom" : "BPTLF-2015","ServiceName" : "RTTIE030","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg) {
        ...
        function DisplayBPTlfThankYou() {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, xFldInfAdjRef, '', 0) != '') {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../../Returns/Log',
                    data: '{ "OriginationFom" : "BPTLF-2015","ServiceName" : "RTTIE030"}',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    success: function (msg) {
				                    ...
				                    <script>document.write(sCurrYear - 1)</script>
					                    ...
					                    enter the termination date here <u>AND</u> file a <a href="https://beta.phila.gov/media/20170207132309/Change-Form.pdf">CHANGE FORM</a>.</span></label>
                                                ...
                                                <label class="lblLink label_NoLeft" style="width: 100%" onclick="ShowPage('SchdD')">Schedule D, Line 13</label>
                                                                    ...
                                                                    <tr class="odd">
                                                                        <td width="5%">4.</td>
                                                                        <td width="70%" class="text-left"><b><u>MANDATORY</u> 2016 BIRT Estimated Payment <u>(repeat line 3)</u> </b></td>
                                                                        <td width="25%" class="text-left">
                                                                            <form class="form-horizontal">
...
and any credit from overpayment of the 2014 BIRT and/or 2015 NPT return.</label> </td>
                                                    ...
                                                    <form class="form-horizontal form-year-background" style="padding:5px !important;">
                                                        ...
                                                        <div style="margin-left: 5px; font-size: 12px; margin-top:0px !important; margin-bottom:5px;" class="here_input_table">
                                                            <label>
				...
				your account.</label>
                                        ...
                                        <% 
                                            ...
                                            Html.RenderAction("_15SchdA", "BPT_LF");//Changed by SumanG
