    ...
    <title></title>
     <script language='javascript' type="text/javascript">
         ...
         function PopulateBPTlfSchdE() {
             ...
             $('#txtBPT_SchE_1').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScELi1, '', 0), 0)); //binoy
             $('#txtBPT_SchE_2').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScELi2, '', 0), 0));
             ...
             $('#txtBPT_SchE_5').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScELi5, '', 0), 0));
             $('#txtBPT_SchE_6A').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScELi6a, '', 0), 0));
             $('#txtBPT_SchE_6B').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScELi6b, '', 0), 0));
             ...
             $('#txtBPT_SchE_10').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScELi10, '', 0), 0));
             $('#txtBPT_SchE_11A').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScELi11a, '', 0), 0));
             $('#txtBPT_SchE_11B').val(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, xFldScELi11b, '', 0), 0));
         ...
         function PopulateXmlBPTlfSchdE() {
             ...
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#txtBPT_SchE_1').val()), xFldScELi1, '', 0) //binoy
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#txtBPT_SchE_2').val()), xFldScELi2, '', 0)
             ...
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#txtBPT_SchE_5').val()), xFldScELi5, '', 0)
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#txtBPT_SchE_6A').val()), xFldScELi6a, '', 0)
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#txtBPT_SchE_6B').val()), xFldScELi6b, '', 0)
             ...
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#txtBPT_SchE_10').val()), xFldScELi10, '', 0)
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#txtBPT_SchE_11A').val()), xFldScELi11a, '', 0)
             parent.$x.ispXmlSetFieldVal(parent.$g.xmlBPTlf_2014, stripCurrency($('#txtBPT_SchE_11B').val()), xFldScELi11b, '', 0)
                 ...
                 if (s1 != s5) {
                     if ($(parent.AppError).text() == '') {
                         ...
                         if (sSchd == '') {
                             ...
                             $(AppError).text('Schedule E is either incorrect because of a change to Line 8 or ' +
                                     'needs to filled out');
                         }		//if
                     }		//if
                 }		//if
...
<body>
                	...
                	<div class="col-lg-12 templateclass">
                                ...
                                <div class="table-responsive">
                                	...
                                	<table class="table table-condensed table-striped custom_table03 wage-table-print">
                                    	...
                                    	<thead>
                                        	<tr>
                                            	<th colspan="3" width="100%" class="slim-headings"><B>2014 BIRT Schedule E: Computation Of Tax On 
    ...
    Manufacturers, Wholesalers and Retailers electing to use the Alternate Method of computation</th>
                                        ...
                                        <tbody>
                                            <tr class="odd">
                                            	<td width="5%">A.</td>
                                                <td width="70%" class="text-left">Total Tax Basis (from Schedule D, Line 8)</td>
