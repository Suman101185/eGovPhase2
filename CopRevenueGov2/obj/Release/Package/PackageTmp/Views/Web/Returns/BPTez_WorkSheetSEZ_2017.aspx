    ...
    <script>
        ...
        function GetPage2Line8() {
            if (cCur($('#lblBPTez2_8').text()) != 0) {                
                if (cCur($('#lblBPTez2_8').text(), 0) > 100000) {
                    $('#txt_BPT_WSEZ1').val(ispFormatMoney(100000,0));
                }
                else
   ...
   <div class="form-group" id="BPTez_WrkShtNE" style="DISPLAY: none;">
    ...
    <tbody>
        ...
        <tr>  
            ...
            <tr>   
                 <td width="5%">S1.</td>            
            <td width="70%" class="text-left"> Enter the lower of <label id="Label2" class="lblLink label_NoLeft"  onclick=ShowPage(2) > Line 8 of Page 2 </label> or $100,000.00 </td>
        ...
        <tr >
             <td width="5%">S5.</td>
            <td style="width:70%" class="text-left"> Statutory Net Income Deduction (Line S1 times Line S4, Cannot exceed $100,000) Enter here and on Line 3, above</td>
