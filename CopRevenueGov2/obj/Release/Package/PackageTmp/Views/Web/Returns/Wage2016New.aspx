...
<script id="clientEventHandlersJS" language="javascript">
    ...
    var arrWageDate08Err = new Array();
    ...
    $(document).ready(function () {
        ...
        $('#txtWageNo3_08').val(ispFormatMoney(0, 0));
        DisplayWage08Return();
    ...
    /** 
  * @desc this function will remove the *'s if the string contains this  
  * @author SumanG  
  */
    ...
    function DisplayWage08Return() {
        ...
        if (parent.$x.ispXmlSetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT[ACCOUNT = "1"]', '', 0)) {           
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlWage, '12/31/2016', 'WAGE_INFO PERIOD', '', 0);
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "Wage-2016","ServiceName" : "RTTIE027","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "Wage-2016","ServiceName" : "RTTIE027","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
            ...
            if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'ERROR_INFO ERROR', "", 0) != 0) {
                ...
                $('#btnWage08Submit').attr('disabled', true);
        ...
        $('#WageReturn_08').css('display', 'block');
        resolvedIframeheight();
        $('#AppHeader').html('wage tax reconciliation return for 2016');
        parent.gsInstructionItem = '#WageReturn';       
        $('#AppMessage').html('The Reconciliation of Wage Tax for 2016 is due February 28, 2017.');
    ...
    function SetWage08Fields() {
        ...
        var chkTaxpayer = document.getElementById('chkAmended_08');
    ...
    function RightAlignText() {
        ...
        $('#txtWageNo3_08').css('textAlign', 'right');//Added
    ...
    function FieldLock_08(bDisabled) {
        if (bDisabled == true) {
            ...
            $('#txtWageNo3_08').attr('disabled', 'disable');
            ...
            $('#txtWageNo3_08').removeAttr('disabled');
    ...
    function CheckWage08XML() {
        ...
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'WAGE_INFO PERIOD', '', 0) != '' && new Date(parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'WAGE_INFO PERIOD', '', 0)) < new Date('01/01/2016')) {
            bPeriodExist = false
        }
        ...
        if (bPeriodExist == false) {
            ...
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlWage, 0, 'AMT_INFO TIPS_WAGES', '', 0)
    ...
    function PopulateWage08Data() {
        ...
        $('#txtWageNo3_08').val(ispFormatMoney(
        parent.$x.ispXmlGetFieldVal(parent.$g.xmlWage, 'AMT_INFO TIPS_WAGES', '', 0), 0));
    ...
    function PopulateWage08XML() {
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlWage, stripCurrency($('#txtWageNo3_08').val()), 'AMT_INFO TIPS_WAGES', '', 0)
    ...
    function LoadWage08Error() {
        ...
        //added
        arrWage08Err[i++] = [txtWageNo3_08, '$(\'#txtWageNo3_08\').val() == ""', 'Answer question 3.']
        arrWage08Err[i++] = [txtWageNo3_08, 'ispValue($(\'#txtWageNo3_08\').val()) == false', 'Value for question 3 must be numeric.']
        arrWage08Err[i++] = [txtWageNo3_08, 'ispNegativeNumber($(\'#txtWageNo3_08\').val()) == false', 'Value for question 3 must not be negative.']

        arrWage08Err[i++] = [txtWageNo4_08, '$(\'#txtWageNo4_08\').val() == ""', 'Answer question 5.']
        arrWage08Err[i++] = [txtWageNo4_08, 'ispValue($(\'#txtWageNo4_08\').val()) == false', 'Value for question 5 must be numeric.']
        arrWage08Err[i++] = [txtWageNo4_08, 'ispNegativeNumber($(\'#txtWageNo4_08\').val()) == false', 'Value for question 5 must not be negative.']

        arrWage08Err[i++] = [txtWageNo6_08, '$(\'#txtWageNo6_08\').val() == ""', 'Answer question 7.']
        arrWage08Err[i++] = [txtWageNo6_08, 'ispValue($(\'#txtWageNo6_08\').val()) == false', 'Value for question 7 must be numeric.']
        arrWage08Err[i++] = [txtWageNo6_08, 'ispNegativeNumber($(\'#txtWageNo6_08\').val()) == false', 'Value for question 7 must not be negative.']

        arrWage08Err[i++] = [txtWageNo8_08, '$(\'#txtWageNo8_08\').val() == ""', 'Answer question 9.']
        arrWage08Err[i++] = [txtWageNo8_08, 'ispValue($(\'#txtWageNo8_08\').val()) == false', 'Value for question 9 must be numeric.']
        arrWage08Err[i++] = [txtWageNo8_08, 'ispNegativeNumber($(\'#txtWageNo8_08\').val()) == false', 'Value for question 9 must not be negative.']

        arrWage08Err[i++] = [txtWageNo10_08, '$(\'#txtWageNo10_08\').val() == ""', 'Answer question 11.']
        arrWage08Err[i++] = [txtWageNo10_08, 'ispValue($(\'#txtWageNo10_08\').val()) == false', 'Value for question 11 must be numeric.']
        arrWage08Err[i++] = [txtWageNo10_08, 'ispNegativeNumber($(\'#txtWageNo10_08\').val()) == false', 'Value for question 11 must not be negative.']
    ...
    function ValidateWageDate() {

        $("#AppError").text('');
        $("#AppError").text(ispSetInputErr1(arrWageDate08Err));
        if ($("#AppError").text() != '') {
            resolvedIframeheight();
            parent.ScrollTop(arrWageDate08Err);
        }
    }
    ...
    function PreviousPaid() {
        showModalDialog(window.location.host+'/'+'HelpPreviousPaidTax.htm', 0, 'dialogWidth:420px;dialogHeight:325px;dialogLeft:550px;')
    }
    ...
    function Calc1Minus2() {
        //1-(2+3) manoranjan
        if ($('#txtWageNo1_08').val() != "" && $('#txtWageNo2_08').val() != "" && $('#txtWageNo3_08').val() != "") {


            $('#lblWageNo3_08').text(ispFormatMoney(parseCurrency($('#txtWageNo1_08').val()) - (parseCurrency($('#txtWageNo2_08').val()) + parseCurrency($('#txtWageNo3_08').val())), 0));
    ...
    function CalcGrossComp() {
        ...
        if (parseCurrency($('#lblWageNo3_08').text()) != (parseCurrency($('#txtWageNo4_08').val()) + parseCurrency($('#txtWageNo6_08').val()) + parseCurrency($('#txtWageNo8_08').val()) + parseCurrency($('#txtWageNo10_08').val()))) {
            ...
            $("#AppError").text('Line 4 is not equal to the sum of lines 5, 7, 9 & 11');
            parent.ScrollTop(1);
        } else {
    ...
    <div class="container-fluid no-padding" id="WageReturn_08">
        ...
        <div class="block3">
            ...
            <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                           ...
                                           <div class="well" style="padding:6px 10px !important; margin-bottom:0px !important;">
                                              ...
                                              <!--Gereral info Section End -->                                                          
                                           <div class="row">
                                               <!--Gereral Form Section  -->
                                                <div class="col-lg-12 templateclass">
                                                     ...
                                                     <form class="form-horizontal"><%--school_form--%>
                                                        ...
                                                        <div class="form-group topsmallform" style="margin-bottom:0px;">

                                                            <div class="col-md-5 col-sm-8 col-xs-12 newtop_padding">
                                                            ...
                                                            <div class="col-sm-9 newtop_padding" style="display:none"">
                                                                <div class="col-sm-7" style="padding-left:0;display:none"">
                                                                <label  class="text-custom-left2" for="inputEmail3" >
                                                                    <span class="custom_padding_span">If you were a partial year resident in 2016, enter dates of residency :</span></label></div><div class="col-sm-5 new-margin-top-form wage-form-date"><label><span class="wage-from-date"> From: 
                                                                   </span>
                                                   ...
                                                   <div class="row table-responsive">
                                                        ...
                                                        <table class="table table-condensed table-striped custom_table03 wage-table-print">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td width="5%">A.</td>
                                                                    <td width="70%" class="text-left">Enter the number of Philadelphia Residents for whom wage tax was remitted for the pay period including March 12, 2016. </td>
                                                                ...
                                                                <tr class="odd">
                                                                      <td width="5%">B.</td>
                                                                    <td width="70%" class="text-left">Enter the number of <strong>nonresidents</strong> (employees living 
				outside Philadelphia city limits) for whom wage tax was remitted for the pay period
				including March 12, 2016. </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                     <input type="text" class="form-control input-sm pull-right" id="txtWageNoB_08" onchange="ValidateWage08Number()" onfocus="ReadOnlySetFocus()" maxlength="10" style="WIDTH: 100%;" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
				...
				quarter of 2016 (for the pay period including March 12, 2016). </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input class="form-control input-sm pull-right" id="txtWageNoC_08" onchange="ValidateWage08Number()" onfocus="ReadOnlySetFocus()" maxlength="10"  style="WIDTH: 100%;" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
				...
				Philadelphia city limits</strong>, for the pay period including March 12, 2016.</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                   <input class="form-control input-sm pull-right" id="txtWageNoD_08" onchange="ValidateWage08Number()" onfocus="ReadOnlySetFocus()" maxlength="10"  style="WIDTH: 100%;"  />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input onfocus="this.select();" class="form-control input-sm pull-right" id="txtWageNo1_08" onchange="ValidateWage08Prelim()" onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
				...
				(Paid to non-residents working outside of Philadelphia)</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input class="form-control input-sm pull-right" id="txtWageNo2_08" onchange="ValidateWage08Prelim()" onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH:100%;" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                     <td width="5%">3.</td>
                                                                    <td width="70%" class="text-left">Taxable income paid to employees earning tips on which City Wage Tax
was not withheld</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                    <input class="form-control input-sm pull-right" id="txtWageNo3_08" onchange="ValidateWage08Prelim()" onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
				...
				which Philadelphia Wage Tax was withheld or due[Calculated - Line 1 minus (Line 2 plus Line 3)] </td>
				...
				Philadelphia (1/1/2016 to 06/30/2016)</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                     <input class="form-control input-sm pull-right" id="txtWageNo4_08" onchange="ValidateWage08Prelim()" onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;" />
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="">
                                                                    <td width="5%">6.</td>
                                                                    <td width="70%" class="text-left">Tax Due [Calculated - line 5 X .039102] </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr class="odd">
                                                                    <td width="5%">7.</td>
                                                                    <td width="70%" class="text-left">Taxable Gross Compensation paid to <U>residents</U>      of 
				Philadelphia (7/1/2016 to 12/31/2016)</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                     <input class="form-control input-sm pull-right" id="txtWageNo6_08" onchange="ValidateWage08Prelim()" onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td width="5%">8.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line 7 X .039004]&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
				...
				Philadelphia (1/1/2016 to 06/30/2016)&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                     <input class="form-control input-sm pull-right" id="txtWageNo8_08" onchange="ValidateWage08Prelim()" onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td width="5%">10.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line&nbsp;9 X .034828]</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
      ...
      <U>non-residents</U>      of 
				Philadelphia (7/1/2016 to 12/31/2016)</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                   	<input class="form-control input-sm pull-right" id="txtWageNo10_08" onchange="ValidateWage08Prelim()" onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td width="5%">12.</td>
                                                                    <td width="70%" class="text-left">Tax Due[Calculated - line 11 X .034741]&nbsp;</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                                     <label id="lblWageNo11_08" style="WIDTH: %;" class="form-control input-sm pull-right" ></label> 
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </td>
                                                                ...
                                                                <tr class="odd">
                                                                    <td width="5%">13.</td>
                                                                    <td width="70%" class="text-left">Total Tax Due[Calculated - lines 6, 8, 10 and 12]</td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
                                                                ...
                                                                <tr>
                                                                    <td width="5%">14.</td>
                                                                    <td width="70%" class="text-left">Tax previously paid for 2016  <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
						...
						Click on link for more information.</label></td>
                                                                ...
                                                                <tr class="odd">
                                                                    <td width="5%">15.</td>
                                                                    <td width="70%" class="text-left">ADDITIONAL TAX DUE If line 13 is greater than line 14,
				enter the amount here.</td>
                                                                ...
                                                                <tr>
                                                                    <td width="5%">16.</td>
                                                                    <td width="70%" class="text-left">TAX OVERPAID If Line 14 is greater than Line 13,
                                               ...
                                               <!-- Preperar Section Form -->
                                                ...
                                                <div class="form-group page-print-wage-section">
                                                  <div class="col-sm-offset-3 col-sm-9 text-right">
                                                      <input id="btnWage08Print" type="button" value="Print" class="btn btn-default submit_button_light" onclick="btnWage08Print_onclick()" style="margin-top:3px !important;" />
                                               <input type="button" value="Submit" class="btn btn-default submit_button" id="btnWage08Submit" style="margin-top:3px !important;" onclick="btnWageValidate();
    ispDisplayProgress('btnWage08Submit_onclick()', 'Submitting 2016 wage tax information')" />                  
                                               
                                                </div>
                                              </div>  
                                                
                                                    <div style="margin-left: 5px; font-size: 12px;" class="wage-filer-print">
                                                        <label style="font-size: 10px !important; font-weight:normal !important;">
				...
				<a href="https://beta.phila.gov/media/20170207132309/Change-Form.pdff" target="_blank">Change Form</a> to cancel
				your account.</label>
                                                        </div>
                                                    </form>
                                                      <div class="clearfix"></div>                                      
                                               </div>
                                               <!-- Preperar Section End -->
                                               <div class="clearfix"></div>
                                          </div>
                                        </div>
                                      </div>
