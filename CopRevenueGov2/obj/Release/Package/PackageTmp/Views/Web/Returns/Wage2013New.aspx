    ...
    function DisplayWage08Return() {
        ...
        if (parent.$x.ispXmlSetFieldVal(parent.$g.xmlAccount, 'TAX_ACCT[ACCOUNT = "1"]', '', 0)) {         
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "Wage-2013","ServiceName" : "RTTIE027","RequestXML" : "' + btoa(ReqXML.toString()) + '"}',
            ...
            $.ajax({
                type: 'POST',
                url: '../Returns/Log',
                data: '{ "OriginationFom" : "Wage-2013","ServiceName" : "RTTIE027","ResponseXML" : "' + btoa(ResXML.toString()) + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
        ...
        resolvedIframeheight();       
        $('#AppHeader').html('wage tax reconciliation return for 2013');
        parent.gsInstructionItem = '#WageReturn';      

        $('#AppMessage').html('<BR>The Reconciliation of Wage Tax for 2013 is due February 28, 2014.');
...
<body>
    <div class="container-fluid no-padding" id="WageReturn_08">
        <div class="block3">
            <div class="container-fluid">
                                                    ...
                                                    <div class="row table-responsive">
                                                        ...
                                                        <table class="table table-condensed table-striped custom_table03 wage-table-print">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                     <td width="5%">A.</td>
                                                                    <td width="70%" class="text-left">Enter the number of Philadelphia Residents for whom wage tax was remitted for the pay period including March 12, 2013. </td>
				...
				quarter of 2013 (for the pay period including March 12, 2013). </td>
                                                                    <td width="25%" class="text-left">
                                                                        <form class="form-horizontal">
                                                                            <div class="form-group no-margin">
                                                                                <div class="">
      ...
      <U>non-residents</U>      of 
				Philadelphia (7/1/2013 to 12/31/2013)</td>
				 ...
				 onfocus="ReadOnlySetFocus()" maxlength="20" style="WIDTH: 100%;"/>
                                                                ...
                                                                <tr>
                                                                     <td width="5%">13.</td>
                                                                    <td width="70%" class="text-left">Tax previously paid for 2013  <label style="FONT-WEIGHT: normal; COLOR: red;width:100%">
    ...
    ispDisplayProgress('btnWage08Submit_onclick()', 'Submitting 2013 wage tax information')" />                  
