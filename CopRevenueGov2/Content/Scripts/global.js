...
function global() {
    ...
    this.xmlPayCouponTemplate = null;
    this.xmlBPTlf = null;
    ...
    global.prototype.loadXmls = function () {
        ...
        try {
            ...
            me.loadXmlSync("XML/PayCoupon", parseXml_xmlPayCouponTemplate);
    ...
    function parseXml_xmlPayCouponTemplate(xml) {
        if (me.xmlPayCouponTemplate == null) {
            me.xmlPayCouponTemplate = me.getXmlDocObj();
        }
        me.xmlPayCouponTemplate.loadXML(xml);
    }
