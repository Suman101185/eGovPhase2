...
namespace COPXmlFactory
{
    public partial class RevenueGovXMLFactory : XMLFactory
    {
        ...
        /// <returns></returns>
        /// 
        public static RTTIE039.NPTRETURN GetNPTReturn()
        {
            RTTIE039.NPTRETURN npt = new RTTIE039.NPTRETURN();
            ...
            //NPT_PG1
            npt.NPT_INFO = new RTTIE039.NPT_INFO();
            ...
            npt.NPT_INFO.BASE_RESIDENT_RATE = new XmlNodeEntity();
            npt.NPT_INFO.BASE_RESIDENT_RATE = "";
            npt.NPT_INFO.BASE_RESIDENT_RATE.Attr_TYPE = "N";
            npt.NPT_INFO.BASE_RESIDENT_RATE.LENGTH = "9";
            npt.NPT_INFO.BASE_RESIDENT_RATE.PERCISION = "6";
            ...
            npt.NPT_INFO.BASE_NON_RES_RATE = new XmlNodeEntity();
            npt.NPT_INFO.BASE_NON_RES_RATE = "";
            npt.NPT_INFO.BASE_NON_RES_RATE.Attr_TYPE = "N";
            npt.NPT_INFO.BASE_NON_RES_RATE.LENGTH = "25";
            npt.NPT_INFO.BASE_NON_RES_RATE.PERCISION = "6";

            npt.NPT_INFO.CORP_PARTNER_IND = new XmlNodeEntity();
            npt.NPT_INFO.CORP_PARTNER_IND = "";
            npt.NPT_INFO.CORP_PARTNER_IND.Attr_TYPE = "A";
            npt.NPT_INFO.CORP_PARTNER_IND.LENGTH = "1";
            ...
            //NPT_PG1
            npt.NPT_PG1 = new RTTIE039.NPT_PG1();
            ...
            npt.NPT_PG1.RESIDENT_INCOME = new XmlNodeEntity();
            npt.NPT_PG1.RESIDENT_INCOME = "";
            npt.NPT_PG1.RESIDENT_INCOME.Attr_TYPE = "A";
            npt.NPT_PG1.RESIDENT_INCOME.LENGTH = "12";

            npt.NPT_PG1.RESIDENT_INCOME_TAX = new XmlNodeEntity();
            npt.NPT_PG1.RESIDENT_INCOME_TAX = "";
            npt.NPT_PG1.RESIDENT_INCOME_TAX.Attr_TYPE = "C";
            npt.NPT_PG1.RESIDENT_INCOME_TAX.LENGTH = "15";

            npt.NPT_PG1.RESIDENT_BASE_INCOME_TAXABLE = new XmlNodeEntity();
            npt.NPT_PG1.RESIDENT_BASE_INCOME_TAXABLE = "";
            npt.NPT_PG1.RESIDENT_BASE_INCOME_TAXABLE.Attr_TYPE = "C";
            npt.NPT_PG1.RESIDENT_BASE_INCOME_TAXABLE.LENGTH = "15";

            npt.NPT_PG1.RESIDENT_BASE_INCOME_TAX = new XmlNodeEntity();
            npt.NPT_PG1.RESIDENT_BASE_INCOME_TAX = "";
            npt.NPT_PG1.RESIDENT_BASE_INCOME_TAX.Attr_TYPE = "C";
            npt.NPT_PG1.RESIDENT_BASE_INCOME_TAX.LENGTH = "15";
            ...
            npt.NPT_PG1.NON_RES_INCOME = new XmlNodeEntity();
            npt.NPT_PG1.NON_RES_INCOME = "";
            npt.NPT_PG1.NON_RES_INCOME.Attr_TYPE = "A";
            npt.NPT_PG1.NON_RES_INCOME.LENGTH = "3";

            npt.NPT_PG1.NON_RES_INCOME_TAX = new XmlNodeEntity();
            npt.NPT_PG1.NON_RES_INCOME_TAX = "";
            npt.NPT_PG1.NON_RES_INCOME_TAX.Attr_TYPE = "C";
            npt.NPT_PG1.NON_RES_INCOME_TAX.LENGTH = "15";

            npt.NPT_PG1.NON_RES_BASE_INCOME_TAXABLE = new XmlNodeEntity();
            npt.NPT_PG1.NON_RES_BASE_INCOME_TAXABLE = "";
            npt.NPT_PG1.NON_RES_BASE_INCOME_TAXABLE.Attr_TYPE = "C";
            npt.NPT_PG1.NON_RES_BASE_INCOME_TAXABLE.LENGTH = "15";

            npt.NPT_PG1.NON_RES_BASE_INCOME_TAX = new XmlNodeEntity();
            npt.NPT_PG1.NON_RES_BASE_INCOME_TAX = "";
            npt.NPT_PG1.NON_RES_BASE_INCOME_TAX.Attr_TYPE = "C";
            npt.NPT_PG1.NON_RES_BASE_INCOME_TAX.LENGTH = "15";
            ...
            npt.NPT_PG1.LINE11 = new XmlNodeEntity();
            npt.NPT_PG1.LINE11 = "";
            npt.NPT_PG1.LINE11.Attr_TYPE = "C";
            npt.NPT_PG1.LINE11.LENGTH = "15";

            npt.NPT_PG1.OVERPAY_AVAILABLE = new XmlNodeEntity();
            npt.NPT_PG1.OVERPAY_AVAILABLE = "";
            npt.NPT_PG1.OVERPAY_AVAILABLE.Attr_TYPE = "C";
            npt.NPT_PG1.OVERPAY_AVAILABLE.LENGTH = "15";
            ...
            npt.NPT_PG1.CORP_PARTNER_PERCENT = new XmlNodeEntity();
            npt.NPT_PG1.CORP_PARTNER_PERCENT = "";
            npt.NPT_PG1.CORP_PARTNER_PERCENT.Attr_TYPE = "C";
            npt.NPT_PG1.CORP_PARTNER_PERCENT.LENGTH = "15";
