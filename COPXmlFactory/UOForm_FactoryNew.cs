...
namespace COPXmlFactory
{
    public partial class RevenueGovXMLFactory : XMLFactory
    {
        ...
        /// <returns></returns>
        /// 
        public static RTTIE035new.UOFORM GetUOFORMNewReturn()
        {
            RTTIE035new.UOFORM uo = new RTTIE035new.UOFORM();
            ...
            //UO_ACCT
            uo.UO_ACCT = new RTTIE035new.UO_ACCT();
            ...
            //UO_AMTS
            uo.UO_AMTS = new RTTIE035new.UO_AMTS();
        ...
        public static RTTIE035new.UO3_PAGE GetUOFORMReturn_UO3_PAGENew()
        {
            RTTIE035new.UO3_PAGE ua = new RTTIE035new.UO3_PAGE();
