...
namespace COPXmlFactory
{
    namespace RTTIE030_2015
    {
        ...
        public class BPT_SCH_A : XmlNodeEntityBase
        {
            ...
            public XmlNodeEntity TAX_DUE { set; get; }
            [XmlElement]
            public XmlNodeEntity ADJUSTED_NET_INCOME { set; get; }
            [XmlElement]
            public XmlNodeEntity TOTAL_NONBUS_INCOMES { set; get; }
            [XmlElement]
        ...
        public class BPT_SCH_D : XmlNodeEntityBase
        {
            ...
            [XmlElement]
            public XmlNodeEntity NET_TAXABLE_RECEIPTS_BEFORE { set; get; }
            [XmlElement]
            public XmlNodeEntity STAT_EXCLUSION_D_X { set; get; }
            [XmlElement]
            public XmlNodeEntity NET_TAXABLE_RECEIPTS_AFTER { set; get; } // 8
            [XmlElement]
            public XmlNodeEntity RECEIPTS_ALTERNATIVE_METHOD { set; get; }  //?? 9 
            [XmlElement]
            public XmlNodeEntity RECEIPTS_REGULAR_RATE { set; get; }  //?? 9 
            [XmlElement]
            public XmlNodeEntity TAX_DUE { set; get; }
            [XmlElement]
            ...
            [XmlElement]
            public XmlNodeEntity RegularRateReceipts { set; get; } //10 D
