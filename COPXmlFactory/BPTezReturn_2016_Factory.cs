...
namespace COPXmlFactory
{
    public partial class RevenueGovXMLFactory : XMLFactory
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static RTTIE037_2016.BPTezReturn GetBPTez_2016Return()
        {
            RTTIE037_2016.BPTezReturn bpt = new RTTIE037_2016.BPTezReturn();
            ...
            //UO_ACCT
            bpt.BPT_INFO = new RTTIE037_2016.BPT_INFO();
            ...
            bpt.BPT_INFO.TERMINATION_DATE = new XmlNodeEntity();
            bpt.BPT_INFO.TERMINATION_DATE = "";
            bpt.BPT_INFO.TERMINATION_DATE.Attr_TYPE = "D";
            bpt.BPT_INFO.TERMINATION_DATE.LENGTH = "8";
            ...
            //BPT_PG1
            bpt.BPT_PG1 = new RTTIE037_2016.BPT_PG1();
            ...
            //BPT_PG2
            bpt.BPT_PG2 = new RTTIE037_2016.BPT_PG2();
