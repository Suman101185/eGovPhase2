...
namespace COPXmlFactory
{
    ...
    public partial class RevenueGovXMLFactory : XMLFactory
    {
        public static RTTIE030_2015.BPTlfReturn GetBPTlf_2015Return()
        {
            ...
            bpl.BPT_SCH_D.NET_TAXABLE_RECEIPTS_BEFORE = new XmlNodeEntity();
            bpl.BPT_SCH_D.NET_TAXABLE_RECEIPTS_BEFORE = "";
            bpl.BPT_SCH_D.NET_TAXABLE_RECEIPTS_BEFORE.Attr_TYPE = "C";
            bpl.BPT_SCH_D.NET_TAXABLE_RECEIPTS_BEFORE.LENGTH = "15";
            ...
            bpl.BPT_SCH_D.NET_TAXABLE_RECEIPTS_AFTER = new XmlNodeEntity();
            bpl.BPT_SCH_D.NET_TAXABLE_RECEIPTS_AFTER = "";
            bpl.BPT_SCH_D.NET_TAXABLE_RECEIPTS_AFTER.Attr_TYPE = "C";
            bpl.BPT_SCH_D.NET_TAXABLE_RECEIPTS_AFTER.LENGTH = "15";

            bpl.BPT_SCH_D.RECEIPTS_ALTERNATIVE_METHOD = new XmlNodeEntity();
            bpl.BPT_SCH_D.RECEIPTS_ALTERNATIVE_METHOD = "";
            bpl.BPT_SCH_D.RECEIPTS_ALTERNATIVE_METHOD.Attr_TYPE = "C";
            bpl.BPT_SCH_D.RECEIPTS_ALTERNATIVE_METHOD.LENGTH = "15";

            bpl.BPT_SCH_D.RECEIPTS_REGULAR_RATE = new XmlNodeEntity();
            bpl.BPT_SCH_D.RECEIPTS_REGULAR_RATE = "";
            bpl.BPT_SCH_D.RECEIPTS_REGULAR_RATE.Attr_TYPE = "C";
            bpl.BPT_SCH_D.RECEIPTS_REGULAR_RATE.LENGTH = "15";
