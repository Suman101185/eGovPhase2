...
namespace COPXmlFactory
{
    public partial class RevenueGovXMLFactory : XMLFactory
    {
        ...
        public static RTTIE016.PAYCOUPON GetPAYCOUPON()
        {
            ...
            tb.LOGIN_FROM = new RTTIE016.LOGIN_FROM();

            tb.LOGIN_FROM.NTL_ONLY = new XmlNodeEntity();
            tb.LOGIN_FROM.NTL_ONLY = "";
            tb.LOGIN_FROM.NTL_ONLY.Attr_TYPE = "A";
            tb.LOGIN_FROM.NTL_ONLY.LENGTH = "20";
