...
namespace COPXmlFactory
{
    ...
    {
        public static RTTIE030_2014.BPTlfReturn GetBPTlf_2014Return()
        {
            RTTIE030_2014.BPTlfReturn bpl = new RTTIE030_2014.BPTlfReturn();
            ...
            //BPT_INFO
            bpl.BPT_INFO = new RTTIE030_2014.BPT_INFO();
            ...
            //BPT_PG1
            bpl.BPT_PG1 = new RTTIE030_2014.BPT_PG1();
            ...
            //BPT_SCH_A
            bpl.BPT_SCH_A = new RTTIE030_2014.BPT_SCH_A();
            ...
            //added 3 fields for new service 02 11 2016
            //bpl.BPT_SCH_A.ADJUSTED_NET_INCOME = new XmlNodeEntity();
            //bpl.BPT_SCH_A.ADJUSTED_NET_INCOME = "";
            //bpl.BPT_SCH_A.ADJUSTED_NET_INCOME.Attr_TYPE = "C";
            //bpl.BPT_SCH_A.ADJUSTED_NET_INCOME.LENGTH = "15";

            //bpl.BPT_SCH_A.TOTAL_NONBUS_INCOMES = new XmlNodeEntity();
            //bpl.BPT_SCH_A.TOTAL_NONBUS_INCOMES = "";
            //bpl.BPT_SCH_A.TOTAL_NONBUS_INCOMES.Attr_TYPE = "C";
            //bpl.BPT_SCH_A.TOTAL_NONBUS_INCOMES.LENGTH = "15";

            bpl.BPT_SCH_A.STAT_NET_DEDUCTION_A_X = new XmlNodeEntity();
            bpl.BPT_SCH_A.STAT_NET_DEDUCTION_A_X = "";
            bpl.BPT_SCH_A.STAT_NET_DEDUCTION_A_X.Attr_TYPE = "C";
            bpl.BPT_SCH_A.STAT_NET_DEDUCTION_A_X.LENGTH = "15"; //binoy

            //BPT_SCH_B
            bpl.BPT_SCH_B = new RTTIE030_2014.BPT_SCH_B();
            ...
            //BPT_SCH_D
            bpl.BPT_SCH_D = new RTTIE030_2014.BPT_SCH_D();
            ...
            //added 2 field s for service 02 11 2016
            bpl.BPT_SCH_D.STAT_EXCLUSION_D_X = new XmlNodeEntity();
            bpl.BPT_SCH_D.STAT_EXCLUSION_D_X = "";
            bpl.BPT_SCH_D.STAT_EXCLUSION_D_X.Attr_TYPE = "C";
            bpl.BPT_SCH_D.STAT_EXCLUSION_D_X.LENGTH = "15";

            //bpl.BPT_SCH_D.RegularRateReceipts = new XmlNodeEntity();
            //bpl.BPT_SCH_D.RegularRateReceipts = "";
            //bpl.BPT_SCH_D.RegularRateReceipts.Attr_TYPE = "C";
            //bpl.BPT_SCH_D.RegularRateReceipts.LENGTH = "15";
            
            //BPT_SCH_E
            bpl.BPT_SCH_E = new RTTIE030_2014.BPT_SCH_E();
            ...
            //BPT_TBL_C1
            bpl.BPT_TBL_C1 = new RTTIE030_2014.BPT_TBL_C1();
            ...
            bpl.BPT_WRKS = new RTTIE030_2014.BPT_WRKS();
            bpl.BPT_SCH_D.Attr_TYPE = "COMPLEX";
            bpl.BPT_SCH_D.OCCURS = "1";
            bpl.BPT_SCH_D.LENGTH = "210";
            bpl.BPT_SCH_D.EXPORT = "Y";
